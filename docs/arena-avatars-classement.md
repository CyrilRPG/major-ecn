...
- **Depuis le 18/09/2026 (cahier des charges complémentaire)** : l’habillage suit la *distinction* cumulée, pas le seul rang. Or / Prestige (cercle lumineux, lauriers, accent bordeaux, blason au serpent médical), Argent (badge 2) et Bronze (badge 3) exigent la 1re, 2e ou 3e place **et** un score cumulé ≥ seuil de distinction (`distinction_pct`, 70 % par défaut). Un 1er à 60 % reste Standard : il est félicité pour sa place, le trophée reste à conquérir. Les autres, ainsi que les participants sans rang, sont Standard.
