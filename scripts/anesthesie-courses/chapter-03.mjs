...
const ISOLATED_QCM_AUTHORED = [
  {
    ...
    items: [
      { lettre: 'A', enonce: 'La combinaison de plusieurs critères de l’examen prédit la difficulté bien mieux qu’un signe pris isolément.', is_correct: true, justification: 'Chaque élément possède une valeur prédictive limitée, alors que leur association identifie plus exactement les patients à risque.' },
      { lettre: 'B', enonce: 'La classification de Mallampati comporte trois grades depuis la description de Samsoon et Young.', is_correct: false, justification: 'Samsoon et Young ont justement ajouté un quatrième grade à la description initiale qui en comptait trois.' },
      ...
      { lettre: 'E', enonce: 'L’âge devient un facteur prédictif de ventilation au masque difficile à partir de 75 ans.', is_correct: false, justification: 'Le seuil retenu parmi les facteurs prédictifs est de 55 ans, bien plus précoce que celui-ci.' },
    ],
  },
  {
    ...
    items: [
      ...
      { lettre: 'B', enonce: 'Une protrusion mandibulaire conservée dispense de préparer une alternative lorsque le Mallampati est classé IV.', is_correct: false, justification: 'Un Mallampati IV garde sa valeur prédictive propre et impose de conserver une solution de rechange.' },
  ...
  },
  {
    ...
    items: [
      { lettre: 'A', enonce: 'Chez l’adulte, le diamètre idéal de sonde est celui qui laisse fuir le gaz au-delà de 20-25 cmH2O.', is_correct: false, justification: 'Ce critère de fuite concerne l’enfant : chez l’adulte, l’étanchéité repose sur un ballonnet de grand volume à basse pression.' },
  ...
  },
  {
    ...
    items: [
      { lettre: 'A', enonce: 'Une SpO2 à 100 % atteste que la dénitrogénation pulmonaire est achevée.', is_correct: false, justification: 'L’hémoglobine est déjà presque saturée en air ambiant, ce qui rend la saturation muette sur l’azote alvéolaire résiduel.' },
  ...
  },
  {
    ...
    items: [
      ...
      { lettre: 'B', enonce: 'Chez l’adulte sain, la période d’apnée sans désaturation atteint environ 15 minutes après oxygène pur.', is_correct: false, justification: 'Après oxygène à 100 %, la durée sécuritaire observée avoisine 6,9 minutes chez l’adulte sain.' },
      ...
      { lettre: 'D', enonce: 'La consommation d’oxygène au repos de l’adulte de poids normal avoisine 30 mL/kg/min.', is_correct: false, justification: 'La valeur de repos est proche de 3 mL/kg/min, soit 200 à 250 mL par minute.' },
  ...
  },
  {
    ...
    items: [
      ...
      { lettre: 'C', enonce: 'La séquence rapide en huit respirations s’accompagne parfois d’une légère hypocapnie.', is_correct: true, justification: 'L’hyperventilation nécessaire à ces grands volumes abaisse transitoirement la pression partielle de gaz carbonique.' },
  ...
  },
  {
    ...
    items: [
      ...
      { lettre: 'D', enonce: 'Un approfondissement de l’anesthésie peut lever une obstruction entretenue par un tonus musculaire résiduel.', is_correct: true, justification: 'Une profondeur insuffisante laisse persister fermeture glottique et contracture qui gênent l’insufflation.' },
  ...
  },
  {
    ...
    items: [
      ...
      { lettre: 'E', enonce: 'Un Mallampati III ou IV constitue un facteur prédictif indépendant de ventilation au masque difficile.', is_correct: true, justification: 'Ce grade traduit une langue volumineuse par rapport à la cavité orale et a été identifié comme prédicteur propre.' },
    ],
  },
  {
    ...
    items: [
      ...
      { lettre: 'E', enonce: 'Une canule oropharyngée bien positionnée abaisse la pression nécessaire pour obtenir un volume courant efficace.', is_correct: true, justification: 'En maintenant la langue en avant, elle réduit la résistance pharyngée et limite le gaz dirigé vers l’œsophage.' },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { lettre: 'E', enonce: 'L’insertion d’un dispositif supraglottique exige moins d’expérience technique que l’intubation endotrachéale.', is_correct: true, justification: 'Cette moindre exigence explique sa place précoce parmi les moyens de sauvetage.' },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      { lettre: 'A', enonce: 'La sonde est poussée de 5 cm au-delà de la disparition du ballonnet sous les cordes vocales.', is_correct: false, justification: 'Le repère décrit est de 2 cm après le passage complet du ballonnet sous la glotte.' },
  ...
  },
  {
    ...
    items: [
      { lettre: 'A', enonce: 'Le raccord proximal de la sonde trachéale possède un diamètre externe normalisé à 22 mm.', is_correct: false, justification: 'La norme est de 15 mm, ce qui permet de brancher tout circuit de ventilation.' },
  ...
  },
  {
    ...
    items: [
      { lettre: 'A', enonce: 'Le repositionnement de la tête corrige une installation défectueuse avant la deuxième laryngoscopie.', is_correct: true, justification: 'Retrouver la position de reniflement rapproche les axes oral, pharyngé et laryngé.' },
      ...
      { lettre: 'C', enonce: 'Un mandrin souple placé dans la sonde accentue la courbure distale du tube.', is_correct: true, justification: 'Cette courbure facilite l’orientation vers la glotte lorsque l’exposition reste partielle.' },
      { lettre: 'D', enonce: 'L’appel à l’aide fait partie des messages clés des algorithmes d’intubation difficile.', is_correct: true, justification: 'Le renfort humain est recommandé au même titre que l’usage précoce d’un dispositif supraglottique.' },
      { lettre: 'E', enonce: 'Le maintien de l’oxygénation constitue le premier objectif entre deux tentatives.', is_correct: true, justification: 'Éviter d’aboutir à un patient impossible à ventiler prime sur l’obtention immédiate de la sonde.' },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      { lettre: 'A', enonce: 'La fibroscopie doit être précédée d’une curarisation profonde pour immobiliser la glotte.', is_correct: false, justification: 'Cette technique est justement choisie lorsque les curares doivent être évités et la respiration spontanée conservée.' },
  ...
  },
  {
    ...
    items: [
      ...
      { lettre: 'B', enonce: 'Le mandrin long de type bougie d’Eschmann mesure environ 20 cm.', is_correct: false, justification: 'Les introducteurs longs mesurent près de 60 cm, ce qui autorise aussi l’échange de sonde.' },
      { lettre: 'C', enonce: 'Le mandrin court d’Oxford est conçu pour servir d’échangeur lors d’une extubation à risque.', is_correct: false, justification: 'Le rôle d’échangeur revient au guide long creux, tandis que le stylet court oriente seulement la sonde.' },
  ...
  },
  {
    ...
    items: [
      ...
      { lettre: 'D', enonce: 'Le délai écoulé sans oxygénation efficace pèse davantage que la préparation d’une technique supplémentaire.', is_correct: true, justification: 'En situation CICO, chaque minute perdue rapproche les lésions cérébrales irréversibles.' },
  ...
  },
  {
    ...
    items: [
      { lettre: 'A', enonce: 'L’oxygénation transtrachéale se fait par un cathéter de calibre 22 G introduit dans la trachée.', is_correct: false, justification: 'Le calibre décrit est de 14 ou 16 G, un dispositif plus fin ne délivrant pas un débit suffisant.' },
  ...
  },
  {
    ...
    items: [
      { lettre: 'A', enonce: 'Une ventilation spontanée efficace suffit à autoriser le retrait de la sonde.', is_correct: false, justification: 'La liste des critères associe conscience normale, stabilité hémodynamique, décurarisation complète et normothermie.' },
  ...
  },
  {
    ...
    items: [
      ...
      { lettre: 'C', enonce: 'Le volume inhalé devient un facteur de gravité au-delà de 4 mL/kg.', is_correct: false, justification: 'Le seuil retenu est dix fois plus bas, à 0,4 mL/kg.' },
  ...
  },
  {
    ...
    items: [
      { lettre: 'A', enonce: 'Trois minutes de respiration courante permettent d’atteindre une fraction télé-expiratoire proche de 60 %.', is_correct: false, justification: 'La cible visée est supérieure à 90 %, valeur qui objective la dénitrogénation.' },
  ...
  },
  {
    ...
    items: [
      { lettre: 'A', enonce: 'La pression cricoïdienne s’applique avec la tête et le cou en flexion pour occlure l’œsophage.', is_correct: false, justification: 'L’occlusion œsophagienne décrite suppose une tête et un cou maintenus en extension.' },
    ...
    questions: [
      {
        ...
        items: [
          ...
          { lettre: 'D', enonce: 'La corrélation entre l’exposition glottique et la difficulté réelle de passage reste imparfaite.', is_correct: true, justification: 'Une laryngoscopie difficile peut s’accompagner d’un passage aisé de la sonde, et inversement.' },
      ...
      },
      {
        ...
        items: [
          ...
          { lettre: 'C', enonce: 'Fléchir le cou de 15° et étendre la tête de 35° avant la reprise.', is_correct: false, justification: 'Les valeurs décrites sont une flexion cervicale de 35° et une extension de 15°.' },
      ...
      },
      {
        ...
        items: [
          { lettre: 'A', enonce: 'Le mandrin long est décrit comme un dispositif coûteux, réservé aux centres spécialisés.', is_correct: false, justification: 'Ces introducteurs sont peu coûteux et doivent figurer dans tout chariot d’intubation difficile.' },
          { lettre: 'B', enonce: 'Le passage de la sonde sur la bougie suit la méthode de Sellick.', is_correct: false, justification: 'La progression sur guide correspond à la méthode de Seldinger, la manœuvre de Sellick désignant la pression cricoïdienne.' },
      ...
      },
      {
        ...
        items: [
          ...
          { lettre: 'D', enonce: 'Une radiographie ou une fibroscopie viennent lever un doute persistant sur la position.', is_correct: true, justification: 'Ces examens tranchent une situation ambiguë après les contrôles clinique et capnographique.' },
      ...
      },
      {
        ...
        items: [
          ...
          { lettre: 'E', enonce: 'Une pression inspiratoire accrue accompagne fréquemment une ventilation limitée à un poumon.', is_correct: true, justification: 'Le même volume délivré dans un seul poumon élève la pression mesurée par le respirateur.' },
        ],
      },
      {
    ...
    questions: [
      {
        ...
        items: [
          { lettre: 'A', enonce: 'La conservation d’une saturation à 88 % autorise encore deux tentatives de laryngoscopie.', is_correct: false, justification: 'Dans une impasse ventilatoire, chaque tentative supplémentaire consomme la réserve sans perspective d’oxygénation.' },
          ...
          { lettre: 'C', enonce: 'Un hématome cervical compressif est une indication classique d’intubation rétrograde.', is_correct: false, justification: 'L’hématome cervical figure parmi les contre-indications de la technique rétrograde.' },
          ...
          { lettre: 'E', enonce: 'L’impossibilité simultanée d’intuber et d’oxygéner définit la situation CICO.', is_correct: true, justification: 'Cette double impasse commande le recours immédiat à une technique trachéale invasive.' },
        ],
      },
      {
        ...
        items: [
          { lettre: 'A', enonce: 'Ouvrir la trachée à mi-chemin entre le cricoïde et le manubrium sternal.', is_correct: false, justification: 'Ce repère correspond à la trachéostomie, alors que l’urgence passe par la membrane cricothyroïdienne.' },
          ...
          { lettre: 'C', enonce: 'Attendre la confirmation d’une capnographie avant d’inciser la membrane.', is_correct: false, justification: 'Aucun signal expiré ne peut être obtenu chez un patient qu’il est impossible de ventiler.' },
      ...
      },
      {
        ...
        items: [
          ...
          { lettre: 'E', enonce: 'La palpation part de l’échancrure du cartilage thyroïde pour descendre vers le cricoïde.', is_correct: true, justification: 'Le doigt suit le bord inférieur du thyroïde jusqu’à la dépression membraneuse.' },
        ],
      },
      {
        ...
        items: [
          ...
          { lettre: 'D', enonce: 'Une source d’oxygène à haut débit est préférable pour ventiler par un cathéter fin.', is_correct: true, justification: 'La jet-ventilation compense la résistance élevée d’un cathéter de petit calibre.' },
          { lettre: 'E', enonce: 'Une canule de Melker autorise oxygénation, ventilation et protection des voies aériennes.', is_correct: true, justification: 'Son architecture offre davantage qu’un simple cathéter de ponction percutanée.' },
        ],
      },
      {
        ...
        items: [
          ...
          { lettre: 'B', enonce: 'L’emphysème sous-cutané résulte d’une lésion des artères thyroïdiennes.', is_correct: false, justification: 'La lésion vasculaire provoque une hémorragie, tandis que l’emphysème traduit une diffusion de gaz hors de la trachée.' },
      ...
      },
      {
        ...
        items: [
          { lettre: 'A', enonce: 'L’intubation rétrograde est habituellement réalisée en première intention devant une intubation difficile.', is_correct: false, justification: 'Elle est rarement choisie d’emblée et intervient surtout après échec de la fibroscopie.' },
          ...
          { lettre: 'C', enonce: 'Le guide en J est introduit vers le thorax après ponction de la membrane.', is_correct: false, justification: 'Le guide est dirigé vers la bouche afin d’être récupéré et de servir de rail à la sonde.' },
      ...
      },
      {
        ...
        items: [
          { lettre: 'A', enonce: 'Remplacer l’entraînement par la lecture annuelle de l’algorithme affiché au bloc.', is_correct: false, justification: 'La maîtrise du geste invasif repose sur une pratique répétée, notamment en simulation.' },
          { lettre: 'B', enonce: 'Réserver le matériel d’oxygénation transtrachéale au chariot d’urgence de l’hôpital.', is_correct: false, justification: 'Ce matériel stérile doit rester à portée de main dans chaque salle d’opération.' },
    ...
    questions: [
      {
        ...
        items: [
          ...
          { lettre: 'E', enonce: 'L’objectif est de raccourcir la période entre la perte des réflexes et l’intubation.', is_correct: true, justification: 'La sonde protège la trachée dès que le ballonnet est gonflé.' },
        ],
      },
      {
        ...
        items: [
          ...
          { lettre: 'B', enonce: 'Une préoxygénation efficace exige une durée fixe de dix minutes de respiration courante.', is_correct: false, justification: 'Viser une fraction expirée supérieure à 90 % vaut mieux qu’une durée imposée d’avance.' },
      ...
      },
      {
        ...
        items: [
          ...
          { lettre: 'B', enonce: 'Administrer l’hypnotique puis attendre la fin d’une ventilation d’essai avant le curare.', is_correct: false, justification: 'Les doses prédéterminées sont injectées rapidement pour raccourcir la phase sans protection.' },
      ...
      },
      {
        ...
        items: [
          ...
          { lettre: 'E', enonce: 'Accepter que la manœuvre soit modifiée puisqu’elle est rarement appliquée de façon optimale.', is_correct: true, justification: 'Son application correcte est inconstante, ce qui justifie de l’adapter aux conditions réelles.' },
        ],
      },
      {
        ...
        items: [
          ...
          { lettre: 'B', enonce: 'Conclure à une intubation œsophagienne devant cette auscultation asymétrique.', is_correct: false, justification: 'Un capnogramme persistant écarte cette hypothèse et oriente vers une sonde trop profonde.' },
      ...
      },
      {
        ...
        items: [
          { lettre: 'A', enonce: 'Extuber dès que la température centrale dépasse 34 °C.', is_correct: false, justification: 'Le critère retenu est une normothermie postopératoire, non un seuil abaissé.' },
          ...
          { lettre: 'E', enonce: 'Attendre une ventilation spontanée efficace sur tube en T avant d’envisager le retrait.', is_correct: true, justification: 'Ce test respiratoire figure parmi les critères d’une extubation sûre.' },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        items: [
          ...
          { lettre: 'E', enonce: 'La normothermie et la levée complète du bloc neuromusculaire.', is_correct: true, justification: 'Ces deux conditions figurent dans la liste des critères précédant un retrait sûr.' },
        ],
      },
      {
      ...
      },
      {
        ...
        items: [
          ...
          { lettre: 'B', enonce: 'Réserver l’échangeur aux patients dont la réintubation serait facile.', is_correct: false, justification: 'Le mandrin long creux est justement recommandé chez le patient difficile à intuber.' },
          ...
          { lettre: 'E', enonce: 'Prévoir une surveillance rapprochée tant que le guide reste en place.', is_correct: true, justification: 'Une obstruction peut apparaître dans les minutes qui suivent le retrait de la sonde.' },
        ],
      },
      {
        ...
        items: [
          { lettre: 'A', enonce: 'Permettre l’administration de médicaments par voie trachéale pendant la surveillance.', is_correct: false, justification: 'Ce guide sert au repérage mécanique du trajet, non à l’instillation de traitements.' },
          ...
          { lettre: 'D', enonce: 'Autoriser l’alimentation entérale précoce par sa lumière creuse.', is_correct: false, justification: 'La lumière creuse est prévue pour l’oxygénation ou la capnographie selon le modèle.' },
          { lettre: 'E', enonce: 'Permettre une oxygénation d’appoint lorsque le modèle dispose d’un raccord adapté.', is_correct: true, justification: 'Certains échangeurs longs autorisent un apport d’oxygène ou un contrôle du CO2.' },
        ],
      },
      {
        ...
        items: [
          ...
          { lettre: 'D', enonce: 'Garder le guide en place tant que l’obstruction reste possible.', is_correct: true, justification: 'Le rail de réintubation garde toute sa valeur pendant la phase instable.' },
          { lettre: 'E', enonce: 'Limiter la pression d’insufflation à moins de 20 cmH2O si une ventilation manuelle devient nécessaire.', is_correct: true, justification: 'Au-delà, le gaz distend l’estomac et majore le risque de régurgitation.' },
        ],
      },
      {
        ...
        items: [
          { lettre: 'A', enonce: 'Choisir une sonde de diamètre nettement supérieur pour compenser l’œdème.', is_correct: false, justification: 'Un calibre trop grand augmente la résistance au passage et le traumatisme laryngé.' },
          ...
          { lettre: 'D', enonce: 'Utiliser le rail déjà en place plutôt que de rechercher à nouveau la glotte.', is_correct: true, justification: 'Le trajet trachéal acquis évite de recommencer une exposition difficile pendant l’hypoxémie.' },
    ...
    questions: [
      {
        ...
        items: [
          ...
          { lettre: 'B', enonce: 'Un âge inférieur à 40 ans écarte les facteurs prédictifs de ventilation difficile.', is_correct: false, justification: 'L’âge reste un critère parmi l’obésité, la barbe, l’édentation, le syndrome d’apnées et le Mallampati élevé.' },
          { lettre: 'C', enonce: 'L’édentation gêne la laryngoscopie autant qu’elle gêne l’application du masque.', is_correct: false, justification: 'L’absence de dents figure parmi les prédicteurs de ventilation difficile, non parmi les critères d’exposition glottique.' },
      ...
      },
      {
        ...
        correction_generale: 'Une FeO2 à 82 % reste sous la cible de 90 %. Il faut en chercher la cause — fuite, débit frais insuffisant ou réinspiration — avant de poursuivre la dénitrogénation.',
        items: [
          { lettre: 'A', enonce: 'Accepter cette valeur puisque le seuil de dénitrogénation efficace est fixé à 80 %.', is_correct: false, justification: 'La cible pratique est une fraction expirée supérieure à 90 %.' },
          { lettre: 'B', enonce: 'Rechercher une fuite, un débit frais insuffisant ou une réinspiration avant de poursuivre.', is_correct: true, justification: 'Ces trois situations expliquent qu’une préoxygénation reste incomplète malgré l’oxygène pur.' },
          { lettre: 'C', enonce: 'Remplacer la mesure de FeO2 par une gazométrie artérielle en salle.', is_correct: false, justification: 'Ce prélèvement invasif est jugé peu praticable et la fraction expirée demeure l’indicateur utile.' },
          ...
          { lettre: 'E', enonce: 'Réduire le débit de gaz frais à 4 L/min pour améliorer l’étanchéité du circuit.', is_correct: false, justification: 'Un débit abaissé favorise la réinspiration des gaz expirés et entretient l’azote alvéolaire.' },
        ],
      },
      {
      ...
      },
      {
        ...
        items: [
          ...
          { lettre: 'D', enonce: 'Appuyer le cinquième doigt derrière la branche montante de la mandibule.', is_correct: true, justification: 'Cet appui provoque la subluxation qui dégage l’espace pharyngé.' },
    ...
    questions: [
      ...
      },
      {
        ...
        items: [
          ...
          { lettre: 'E', enonce: 'Remplir le circuit d’oxygène avant de commencer les inspirations profondes.', is_correct: true, justification: 'Un circuit déjà saturé évite de gaspiller les premiers efforts inspiratoires.' },
        ],
      },
      {
        ...
        items: [
          ...
          { lettre: 'D', enonce: 'L’apnée est maintenue sans ventilation manuelle tant que la tolérance le permet.', is_correct: true, justification: 'Éviter l’insufflation limite la distension gastrique qui favoriserait la régurgitation.' },
      ...
      },
      {
        ...
        items: [
          ...
          { lettre: 'C', enonce: 'Faire tousser le patient pour vérifier l’efficacité de la pression appliquée.', is_correct: false, justification: 'La pression maintenue pendant un effort de toux expose à la rupture de l’œsophage.' },
      ...
      },
      {
        ...
        items: [
          { lettre: 'A', enonce: 'La visualisation du passage des cordes dispense de tout autre contrôle de position.', is_correct: false, justification: 'Le CO2 expiré continu et l’auscultation restent nécessaires pour affirmer la position trachéale.' },
      ...
      },
      {
        ...
        items: [
          ...
          { lettre: 'E', enonce: 'Le retrait doit être précédé d’une oxygénation puis d’une aspiration des sécrétions oropharyngées.', is_correct: true, justification: 'Ces deux gestes préparent une toux passive efficace au moment du dégonflage du ballonnet.' },
        ],
      },
      {
        ...
        items: [
          ...
          { lettre: 'D', enonce: 'Une inspiration profonde est demandée juste avant le dégonflage du ballonnet.', is_correct: true, justification: 'Elle prépare la toux passive qui expulse les sécrétions lors du retrait.' },
    ...
    questions: [
      {
        ...
        items: [
          ...
          { lettre: 'B', enonce: 'La fibroscopie éveillée impose de supprimer toute anesthésie locale des voies aériennes.', is_correct: false, justification: 'L’anesthésie topique est justement ce qui rend la procédure tolérable chez un patient conscient.' },
          ...
          { lettre: 'E', enonce: 'La capacité du patient à coopérer conditionne la faisabilité d’une intubation vigile.', is_correct: true, justification: 'Une intubation éveillée repose sur la coopération pendant l’anesthésie topique et le guidage.' },
        ],
      },
      {
      ...
      },
      {
        ...
        items: [
          { lettre: 'A', enonce: 'La vidéolaryngoscopie se pratique sans mandrin puisque la vision est indirecte.', is_correct: false, justification: 'La vision indirecte impose justement un mandrin préformé pour diriger la sonde vers la glotte.' },
      ...
      },
      {
        ...
        items: [
          { lettre: 'A', enonce: 'Retirer complètement le fibroscope et passer d’emblée à une laryngoscopie directe.', is_correct: false, justification: 'La stabilité permet de nettoyer l’optique et de reprendre, sans exposer le rachis à une exposition en force.' },
      ...
      },
      {
        ...
        correction_generale: 'La vision des anneaux oriente le guidage, mais la profondeur définitive de la sonde doit encore être lue puis fixée, sans mobiliser un rachis instable.',
        items: [
          { lettre: 'A', enonce: 'Demander une radiographie thoracique systématique avant de ventiler le patient.', is_correct: false, justification: 'L’imagerie intervient uniquement lorsque les contrôles habituels laissent un doute.' },
          { lettre: 'B', enonce: 'Considérer que l’absence de mobilisation cervicale garantit une profondeur correcte.', is_correct: false, justification: 'Le repère d’insertion doit être lu, quelle que soit la stabilité du rachis.' },
      ...
      },
      {
        ...
        items: [
          { lettre: 'A', enonce: 'Extuber sous anesthésie profonde afin de supprimer la toux sur la sonde.', is_correct: false, justification: 'Un patient difficile à réintuber doit récupérer ses réflexes avant le retrait.' },
      ...
      },
      {
        ...
        items: [
          ...
          { lettre: 'B', enonce: 'Le guide creux protège la trachée de l’inhalation pendant toute sa mise en place.', is_correct: false, justification: 'Aucun ballonnet n’assure d’étanchéité autour d’un simple échangeur de sonde.' },
          ...
          { lettre: 'D', enonce: 'Le guide doit être enfoncé jusqu’à percevoir un contact ferme avec la carène.', is_correct: false, justification: 'Le contact carénaire provoque toux et lésions : la profondeur reste contrôlée et limitée.' },
    ...
    questions: [
      {
        ...
        items: [
          ...
          { lettre: 'C', enonce: 'La perte de tonus des muscles de la mâchoire chez le sujet âgé améliore l’application du masque.', is_correct: false, justification: 'Cette perte de tonus figure parmi les causes de fuite décrites chez le patient âgé.' },
      ...
      },
      {
        ...
        items: [
          ...
          { lettre: 'D', enonce: 'Appliquer une pression ferme du pouce et de l’index sur le corps du masque.', is_correct: true, justification: 'Ce point d’appui assure l’étanchéité pendant que les autres doigts tractent la mandibule.' },
      ...
      },
      {
        ...
        items: [
          ...
          { lettre: 'D', enonce: 'Une taille de masque différente peut être essayée si la fuite persiste.', is_correct: true, justification: 'Un coussinet correctement dimensionné épouse les reliefs de la face et supprime les espaces résiduels.' },
      ...
      },
      {
        ...
        items: [
          { lettre: 'A', enonce: 'Choisir un dispositif de première génération pour disposer d’un canal de drainage gastrique.', is_correct: false, justification: 'Le canal gastrique séparé caractérise les modèles de deuxième génération.' },
      ...
      },
      {
        ...
        items: [
          { lettre: 'A', enonce: 'Le canal latéral de l’i-Gel sert à mesurer la pression du coussinet.', is_correct: false, justification: 'Ce canal se place en regard de l’entrée de l’œsophage et permet le drainage gastrique.' },
      ...
      },
      {
        ...
        items: [
          ...
          { lettre: 'D', enonce: 'Choisir un dispositif de deuxième génération conçu pour l’intubation à travers le masque.', is_correct: true, justification: 'Certains modèles récents permettent de passer une sonde en laissant le dispositif en place.' },
      ...
      },
      {
        ...
        items: [
          ...
          { lettre: 'D', enonce: 'Le renfort humain a été mobilisé dès le sauvetage extraglottique.', is_correct: true, justification: 'Un appel précoce prépare l’étape suivante avant que l’oxygénation se dégrade.' },
