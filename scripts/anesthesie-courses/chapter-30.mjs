...
const ISOLATED_QCM = [
  {
    ...
    questions: [
      ...
      qcm(
        ...
        [
          F(
            "La fréquence cardiaque à la naissance avoisine 80 à 100 battements par minute.",
            "Les valeurs usuelles à la naissance se situent entre 120 et 160 battements par minute.",
          ),
          T(
          ...
          F(
            "Le volume sanguin rapporté au poids corporel est plus faible que chez l’adulte.",
            "La volémie pondérale est justement plus grande chez le nouveau-né et l’enfant.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Une posologie réduite est requise pour les agents qui se distribuent dans l’eau extracellulaire.",
            "Ce compartiment élargi impose au jeune enfant une dose rapportée au poids plus élevée.",
          ),
          T(
          ...
          F(
            "Un jeûne préopératoire prolongé est bien toléré grâce aux réserves hydriques du nourrisson.",
            "Ce jeûne creuse un déficit aux dépens d’un secteur extracellulaire déjà sollicité.",
          ),
        ],
      ),
      qcm(
    ...
    questions: [
      qcm(
        ...
        [
          ...
          T(
            "Recevoir l’enfant accompagné de ses parents.",
            "La consultation préanesthésique se tient en présence de la famille.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Une bronchite récente autorise l’opération après un délai de deux semaines.",
            "Une atteinte des voies aériennes basses fait repousser le geste de quatre semaines.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          T(
            ...
            "Un volume amygdalien important rétrécit le passage pharyngé.",
          ),
          T(
          ...
          T(
            ...
            "La limitation d’ouverture buccale entrave l’introduction du laryngoscope.",
          ),
        ],
      ),
      qcm(
        ...
        [
          F(
            "Maintenir la bouche fermée pendant l’insufflation.",
            "L’ouverture buccale et le dégagement lingual conditionnent une insufflation efficace.",
          ),
          T(
  ...
  },
  {
    ...
    questions: [
      qcm(
        ...
        [
          ...
          T(
            ...
            "Un brassard proportionné complète le monitorage standard de toute anesthésie pédiatrique.",
          ),
          T(
            "Température.",
      ...
      qcm(
        ...
        [
          F(
            "Largeur de chambre à air égale à 80 % de la circonférence.",
            "Cette proportion correspond à la longueur du brassard, la largeur visant 40 %.",
          ),
          T(
      ...
      qcm(
        ...
        [
          F(
            "L’artère fémorale, formellement proscrite en pédiatrie.",
            "La fémorale figure parmi les sites alternatifs admis lorsque la radiale manque.",
          ),
          F(
          ...
          T(
            "Une mesure invasive requise par la chirurgie ou les comorbidités.",
            "Le contexte opératoire décide du recours à un cathéter artériel.",
          ),
        ],
      ),
      qcm(
        ...
        [
          ...
          T(
            "Tenir compte d’une fiabilité moindre sous dix kilogrammes.",
            "Les petits volumes courants et les fréquences rapides altèrent le signal capnographique.",
          ),
          T(
      ...
      qcm(
        ...
        [
          F(
            "Les pertes thermiques cutanées concernent surtout l’adolescent.",
            "Le nourrisson est le plus exposé, avec un rapport surface/poids deux à trois fois supérieur.",
          ),
          F(
  ...
  },
  {
    ...
    questions: [
      qcm(
        ...
        [
          F(
            "Il partage avec le desflurane un caractère irritant marqué.",
            "Le sévoflurane irrite peu la muqueuse, à la différence du desflurane.",
          ),
          F(
            "Sa CAM est plus basse chez le nouveau-né que chez l’adulte.",
            "Elle atteint 3,3 % à la naissance, valeur supérieure à celle de l’adulte.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Une montée plus rapide du rapport FA/Fi.",
            "L’équilibre entre fraction inspirée et fraction alvéolaire s’établit plus vite chez l’enfant.",
          ),
        ],
      ),
      qcm(
        ...
        [
          F(
            "Un risque accru de sténose sous-glottique sous sévoflurane.",
            "Cette sténose résulte d’une sonde de trop grand diamètre et non de l’agent halogéné.",
          ),
          F(
          ...
          F(
            "Une contre-indication des halogénés dans la trisomie 21.",
            "Ce terrain fait craindre une bradycardie, la contre-indication visant l’hyperthermie maligne.",
          ),
          F(
    ...
    questions: [
      qcm(
        ...
        [
          ...
          F(
            "Une résistance marquée aux curares non dépolarisants.",
            "L’immaturité jonctionnelle rend le nouveau-né plus sensible à ces agents.",
          ),
          F(
      ...
      qcm(
        ...
        [
          F(
            "Une intubation programmée chez l’enfant de moins de 8 ans.",
            "Son emploi de routine reste controversé avant huit ans et se limite aux urgences.",
          ),
          F(
            "Une curarisation d’entretien pendant une chirurgie longue.",
            "Sa très courte durée d’action la rend inadaptée à un entretien prolongé.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Rocuronium d’installation la plus rapide parmi les agents intermédiaires.",
            "Son délai d’action devance celui du vécuronium et du cisatracurium.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Antagoniser un bloc au cisatracurium par le sugammadex.",
            "Cet antagoniste est réservé aux curares stéroïdiens tels que le rocuronium.",
          ),
          T(
      ...
      qcm(
        ...
        [
          F(
            "Rigidité thoracique levée par une augmentation du morphinique.",
            "Cette rigidité cède à l’administration d’un curare.",
          ),
          T(
  ...
  },
  {
    ...
    questions: [
      qcm(
        ...
        [
          F(
            "Obtenir des conditions d’intubation dès la trentième seconde.",
            "Il faut environ quatre à cinq minutes, lorsque les pupilles se recentrent.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Une induction intraveineuse au propofol.",
            "Le propofol sert justement à lever un laryngospasme constitué.",
          ),
          F(
      ...
      qcm(
        ...
        [
          F(
            "Débuter un remplissage vasculaire en priorité.",
            "La réoxygénation prime, l’hypoxémie étant le principal moteur du ralentissement.",
          ),
          F(
    ...
    questions: [
      qcm(
        ...
        [
          ...
          T(
            "Préférer l’albumine 5 % aux colloïdes de synthèse.",
            "C’est le colloïde habituellement employé en pédiatrie lorsqu’un colloïde est retenu.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Calculer les pertes admissibles à partir du seul poids de l’enfant.",
            "L’équation combine volémie totale, hématocrite initial et seuil transfusionnel.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Le recours à une oxygénothérapie nasale.",
            "Elle soutient l’oxygénation en attendant l’effet du traitement entrepris.",
          ),
          T(
...
const DP_QCM = [
  {
    ...
    questions: [
      qcm(
        ...
        [
          F(
            "Une échographie cardiaque avant toute anesthésie du nourrisson.",
            "Cet examen se justifie devant un syndrome polymalformatif, une myopathie ou une mucopolysaccharidose.",
          ),
          F(
            "Un dosage systématique de l’hémoglobine.",
            "Ce dosage se discute surtout avant une chirurgie à fort potentiel hémorragique.",
          ),
          F(
            "Un test de grossesse.",
            "Certains centres le réservent aux adolescentes, situation étrangère à ce nourrisson.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Un risque d’inhalation du contenu gastrique.",
            "Ce risque relève du jeûne et de l’urgence, non de l’atteinte des voies aériennes.",
          ),
          T(
            "Une désaturation.",
      ...
      qcm(
        ...
        [
          ...
          F(
            "Reprogrammer dès le lendemain de la disparition de la toux.",
            "Un report d’environ deux semaines suit une infection aiguë des voies aériennes supérieures.",
          ),
          F(
      ...
      qcm(
        ...
        [
          F(
            "Prévoir six heures de jeûne pour les liquides clairs.",
            "Ces boissons sont autorisées jusqu’à une à deux heures avant l’anesthésie.",
          ),
          F(
            "Choisir une sonde trachéale surdimensionnée afin de limiter les fuites.",
            "Un diamètre trop grand expose à l’œdème et à la sténose sous-glottique.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Réduire la fraction inspirée à 3–4 % si l’abord veineux se prolonge.",
            "Une concentration élevée maintenue longtemps entraîne dépression hémodynamique et anomalies EEG.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Intuber d’emblée avant toute autre manœuvre.",
            "La libération des voies aériennes et l’oxygénation précèdent l’escalade instrumentale.",
          ),
          F(
          ...
          F(
            "Administrer un aérosol d’adrénaline en première intention.",
            "L’adrénaline inhalée traite un œdème laryngé, alors qu’un spasme cède au jaw thrust.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Une absence de rétention urinaire.",
            "La reprise mictionnelle figure parmi les conditions autorisant le retour à domicile.",
          ),
        ],
  ...
  },
  {
    ...
    questions: [
      qcm(
        ...
        [
          F(
            "Un jus de fruits avec pulpe compte comme liquide clair.",
            "Les liquides clairs excluent la pulpe, qui impose un délai de jeûne plus long.",
          ),
          F(
            "Le lait maternel impose un délai de six heures.",
            "Quatre heures suffisent pour le lait maternel, six heures visant le lait artificiel.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Une polyurie abondante depuis la veille.",
            "Un déficit extracellulaire s’accompagne plutôt d’une diurèse réduite.",
          ),
          T(
          ...
          T(
            "Le temps de recoloration allongé à trois secondes.",
            "Un remplissage capillaire retardé traduit une hypoperfusion périphérique.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Rocuronium 0,6 mg/kg pour une paralysie en trente secondes.",
            "Cette dose installe le bloc en une à une minute et demie seulement.",
          ),
          F(
            "Propofol 5 mg/kg en bolus malgré l’hypovolémie.",
            "Son effet sympatho-inhibiteur provoque une chute tensionnelle brusque et profonde.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Discuter la pression cricoïdienne selon la difficulté d’exposition.",
            "La manœuvre de Sellick reste la référence mais peut gêner l’intubation du jeune enfant.",
          ),
        ],
      ...
      qcm(
        ...
        [
          F(
            "Une pression artérielle systolique à 105 mmHg.",
            "Cette valeur est usuelle à six ans et ne traduit aucune défaillance.",
          ),
          T(
          ...
          T(
            "Une chute brutale du CO₂ expiré malgré la ventilation.",
            "Un capnogramme qui s’abaisse traduit un transport pulmonaire insuffisant.",
          ),
          T(
    ...
    questions: [
      ...
      qcm(
        ...
        [
          ...
          T(
            "Préparer une induction préservant la ventilation spontanée.",
            "Maintenir les échanges spontanés laisse le temps d’essayer plusieurs stratégies.",
          ),
          T(
      ...
      qcm(
        ...
        [
          F(
            "Choisir un masque couvrant le menton et le cou.",
            "Le masque descend jusqu’à la mandibule, sans déborder sur la région cervicale.",
          ),
          F(
            "Mesurer la canule oropharyngée de la narine à l’angle mandibulaire.",
            "Cette distance sert à la canule nasopharyngée, l’oropharyngée partant du coin de la bouche.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Approfondir avec du desflurane au masque.",
            "Cet agent irrite fortement la voie aérienne et provoque toux et fermeture glottique.",
          ),
          F(
          ...
          F(
            "Placer un rouleau sous les épaules de cet enfant de quatre ans.",
            "Ce rouleau corrige l’occiput du nourrisson, alors qu’à quatre ans la tête est surélevée.",
          ),
          F(
      ...
      qcm(
        ...
        [
          F(
            "Assurer une ventilation en pression positive élevée sans fuite.",
            "L’étanchéité d’un dispositif supraglottique demeure limitée sous forte pression.",
          ),
          T(
          ...
          F(
            "Être choisi selon l’âge de l’enfant.",
            "La taille du masque laryngé se détermine à partir du poids.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Prolonger la surveillance en salle de réveil.",
            "Le délai d’apparition d’une obstruction impose de garder l’enfant sous observation.",
          ),
        ],
    ...
    questions: [
      qcm(
        ...
        [
          ...
          F(
            "La vasoconstriction cutanée sous anesthésie compense les pertes.",
            "L’anesthésie inhibe cette réponse et laisse le refroidissement progresser.",
          ),
          T(
          ...
          T(
            "Le frisson thermogénique reste inefficace chez le jeune enfant.",
            "Cette compensation manquante pérennise l’hypothermie une fois installée.",
          ),
          T(
      ...
      qcm(
        ...
        [
          F(
            "Un contrôle cutané frontal, plus fiable que la voie œsophagienne.",
            "Les sondes nasopharyngée, œsophagienne, rectale ou axillaire mesurent la température centrale.",
          ),
          F(
            "Attendre 35 °C avant de débuter le réchauffement actif.",
            "Le réchauffement convectif s’installe dès le début de la chirurgie.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Le volume sanguin total estimé selon le poids.",
            "Une fillette de 11 kg dispose d’une volémie faible, où chaque millilitre perdu compte.",
          ),
          T(
      ...
      qcm(
        ...
        [
          F(
            "Environ 11 mL pour obtenir 1 g/dL.",
            "Il faut 4 mL/kg, soit près de 44 mL chez une enfant de onze kilogrammes.",
          ),
          T(
          ...
          F(
            "Un volume fixe de 250 mL quel que soit le poids.",
            "Ce volume approche le tiers de la volémie totale d’une enfant de onze kilogrammes.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Vérifier l’identité et la concordance du produit.",
            "Le contrôle ultime prévient une erreur d’attribution du concentré érythrocytaire.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Orienter l’enfant vers une unité de soins continus.",
            "Chirurgie majeure, transfusion et intubation imposent une structure de surveillance rapprochée.",
          ),
          T(
  ...
  },
  {
    ...
    questions: [
      ...
      qcm(
        ...
        [
          F(
            "Le rocuronium, éliminé indépendamment du foie.",
            "Sa durée s’allonge jusqu’à 90 minutes chez le nouveau-né, contrairement au cisatracurium.",
          ),
          F(
      ...
      qcm(
        ...
        [
          F(
            "Vérifier la fonction rénale avant chaque rappel de cisatracurium.",
            "Les estérases plasmatiques dégradent ce curare sans dépendre du rein ni du foie.",
          ),
          T(
          ...
          F(
            "Doubler la dose d’entretien toutes les trente minutes.",
            "Une escalade systématique provoquerait une accumulation et un réveil retardé.",
          ),
          F(
      ...
      qcm(
        ...
        [
          F(
            "Réinjecter du cisatracurium pour faciliter la fermeture.",
            "Un rappel tardif prolongerait le bloc et retarderait l’extubation du nourrisson.",
          ),
          F(
            "Administrer la néostigmine à 200 µg/kg.",
            "La plage utile va de 20 à 70 µg/kg selon la récupération observée.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Une capnographie de forme normale.",
            "Un capnogramme normal reflète une ventilation efficace plutôt qu’une curarisation persistante.",
          ),
          F(
      ...
      qcm(
        ...
        [
          F(
            "Une injection de morphine juste avant le retrait du tube.",
            "Avant un an, cet opioïde expose à une dépression respiratoire et impose une titration prudente.",
          ),
          T(
    ...
    questions: [
      qcm(
        ...
        [
          ...
          T(
            "L’impossibilité d’accéder rapidement à l’enfant pendant l’acquisition.",
            "L’éloignement durant les séquences impose d’anticiper profondeur et moyens de secours.",
          ),
          T(
      ...
      qcm(
        ...
        [
          F(
            "Une prémédication par voie intramusculaire systématique.",
            "Cette voie douloureuse doit être évitée autant que possible chez l’enfant.",
          ),
          T(
          ...
          T(
            "Un monitorage associant électrocardioscopie, oxymétrie et pression artérielle.",
            "Ce trio constitue la surveillance de base exigée pour toute sédation.",
          ),
          T(
      ...
      qcm(
        ...
        "b00184",
        "La capnographie devient obligatoire et la pression artérielle est mesurée de façon répétée, sans justifier de cathéter artériel ni de moniteur de profondeur.",
        [
          F(
            "Un index bispectral obligatoire en sédation profonde.",
            "Le renfort exigé porte sur la capnographie, obligatoire dès la sédation profonde.",
          ),
          F(
            "Une mesure invasive de pression artérielle.",
            "Un cathéter artériel se discute selon la chirurgie ou les comorbidités, absentes ici.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Il préserve le plus souvent une respiration spontanée.",
            "Une perfusion de 75 à 250 µg/kg/min laisse habituellement persister les mouvements ventilatoires.",
          ),
          T(
      ...
      qcm(
        ...
        [
          F(
            "Administrer du flumazénil pour lever l’obstruction.",
            "Cet antagoniste vise les benzodiazépines et reste sans effet sur le propofol.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Une reprise des boissons sans vomissement.",
            "La tolérance orale figure parmi les conditions de retour à domicile.",
          ),
          T(
    ...
    questions: [
      qcm(
        ...
        [
          ...
          F(
            "Sa fonction rénale immature retarde l’élimination de la morphine.",
            "La maturation rénale s’achève avant la fin de la première année de vie.",
          ),
          F(
          ...
          F(
            "L’administration d’une dose de morphine de 0,5 mg/kg.",
            "La dose initiale intraveineuse se situe entre 0,05 et 0,1 mg/kg.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Attendre l’élimination spontanée de la morphine.",
            "Une fréquence à six par minute impose un soutien ventilatoire immédiat.",
          ),
          T(
      ...
      qcm(
        ...
        [
          F(
            "Injecter 2 mg en dose unique.",
            "Ce montant fixe s’adresse aux enfants de plus de vingt kilogrammes en situation critique.",
          ),
          F(
            "Renouveler l’injection toutes les vingt-quatre heures.",
            "La demi-vie brève impose des bolus rapprochés ou une perfusion continue.",
          ),
          F(
      ...
      qcm(
        ...
        [
          F(
            "Une dose unique couvre toute la durée d’action de la morphine.",
            "L’antagoniste s’élimine avant l’agoniste et laisse réapparaître la bradypnée.",
          ),
          T(
      ...
      qcm(
        ...
        [
          F(
            "Prescrire de la nalbuphine à 2 mg/kg toutes les deux heures.",
            "La posologie retenue est de 0,1 à 0,2 mg/kg toutes les quatre à six heures.",
          ),
          T(
      ...
      qcm(
        ...
        [
          F(
            "Un délai de trente minutes après la dernière naloxone.",
            "Le minimum requis après une antagonisation est de deux heures.",
          ),
          T(
          ...
          T(
            "Une observation d’au moins deux heures après l’antagonisation.",
            "Cette durée couvre la fenêtre de récidive de la dépression ventilatoire.",
          ),
        ],
  ...
  },
  {
    ...
    questions: [
      qcm(
        ...
        [
          F(
            "Un risque d’inhalation imposant une séquence rapide.",
            "Le jeûne est respecté et ce geste électif relève d’une induction ordinaire.",
          ),
          F(
            "Une rétention urinaire fréquente après amygdalectomie.",
            "Ce trouble relève surtout des morphiniques et des blocs périmédullaires.",
          ),
          T(
      ...
      qcm(
        ...
        [
          F(
            "Une amygdalectomie systématiquement compatible avec l’ambulatoire.",
            "Certains récusent cette pratique après amygdalectomie en raison du risque hémorragique.",
          ),
          T(
          ...
          F(
            "Une ordonnance antalgique remise seulement à la demande des parents.",
            "La prescription est systématiquement remise et expliquée avant le retour à domicile.",
          ),
          F(
      ...
      qcm(
        ...
        [
          F(
            "Sous une concentration inférieure à 0,5 CAM d’halogéné.",
            "Une extubation profonde suppose plus d’une CAM d’agent halogéné.",
          ),
          F(
          ...
          T(
            "Sous surveillance continue de la saturation.",
            "Le retrait du tube expose à un événement laryngé qu’il faut détecter sans délai.",
          ),
        ],
      ...
      qcm(
        ...
        [
          ...
          T(
            "Recherche d’un saignement pharyngé.",
            "L’inspection de la gorge dépiste une hémorragie précoce après amygdalectomie.",
          ),
        ],
      ...
      qcm(
        ...
        [
          ...
          F(
            "Reporter toute réévaluation au lendemain.",
            "L’efficacité du schéma doit être vérifiée avant d’envisager un retour à domicile.",
          ),
          F(
          ...
          T(
            "Anticiper une douleur intense et prolongée après amygdalectomie.",
            "Même après un geste courant en ambulatoire, la souffrance peut rester vive plusieurs jours.",
          ),
        ],
      ...
      qcm(
        ...
        [
          ...
          T(
            "Une impossibilité de boire malgré le traitement antalgique.",
            "Sans prise orale, l’hydratation et le relais analgésique à domicile deviennent incertains.",
          ),
          T(
