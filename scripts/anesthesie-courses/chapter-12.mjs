...
const QCM_SERIES = [
  {
    ...
    questions: [
      qcm(
        ...
        [
          F(
            "La division par cent de la mortalité anesthésique entre 1980 et 2000.",
            "L’enquête française de Lienhart documente une réduction d’un facteur dix sur cette période.",
          ),
          F(
            "L’intensification des travaux de sécurité après le tournant des années 2000.",
            "Les efforts consacrés à documenter la réduction du risque ont fléchi après cette charnière.",
          ),
          F(
      ...
      qcm(
        ...
        [
          F(
            "La mortalité globale avoisine 1/1 000 actes ambulatoires.",
            "La mortalité rapportée en ambulatoire avoisine un pour cent mille, soit cent fois moins que la valeur avancée.",
          ),
          T(
          ...
          F(
            "La sleeve gastrectomie ambulatoire chez l’obèse morbide affiche une mortalité constamment nulle.",
            "Une revue récente chiffre ce taux entre zéro et un pour mille chez ces patients.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          F(
            "La chirurgie mini-invasive majore la mortalité postopératoire.",
            "Elle fait évoluer les chiffres dans le sens favorable, comme la récupération améliorée.",
          ),
          F(
      ...
      qcm(
        ...
        [
          F(
            "Une supériorité démontrée des stratégies traditionnelles sur la récupération améliorée.",
            "Les programmes de réhabilitation obtiennent un meilleur devenir postopératoire que ces stratégies.",
          ),
          T(
          ...
          F(
            "Une communication réduite au recueil du consentement écrit.",
            "L’échange vise aussi la satisfaction et l’adhésion du malade à son traitement.",
          ),
          F(
    ...
    questions: [
      qcm(
        ...
        [
          ...
          T(
            "Le mode d’accouchement explique souvent les complications neurologiques obstétricales.",
            "L’acte obstétrical est plus fréquemment en cause que la technique locorégionale employée.",
          ),
          T(
      ...
      qcm(
        ...
        [
          F(
            "Une réduction du risque obtenue quel que soit le volume courant appliqué.",
            "Le bénéfice tient au choix d’un mode protecteur, dont le volume courant limité fait partie.",
          ),
          F(
            "Une action du mode ventilatoire limitée aux patients atteints de BPCO.",
            "Le mode protecteur peranesthésique concerne l’ensemble des malades ventilés au bloc.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Considérer l’harmonisation des ampoules comme une protection suffisante.",
            "Cette harmonisation figure justement parmi les conditions qui exposent à la confusion.",
          ),
          F(
          ...
          F(
            "Programmer la préparation des seringues pendant les transmissions d’équipe.",
            "Les transmissions imparfaites entre professionnels comptent parmi les situations les plus exposées.",
          ),
          F(
      ...
      qcm(
        ...
        [
          F(
            "Elle remplace la détection des événements sentinelles, devenue obsolète.",
            "Les deux approches sont complémentaires dans l’analyse moderne du risque de soins.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Erreur médicamenteuse — recours exclusif à la vigilance individuelle.",
            "Étiquetage, présentation standardisée et contrôle croisé forment les barrières décrites.",
          ),
          F(
    ...
    questions: [
      qcm(
        ...
        [
          ...
          T(
            "Les réactions retardées apparaissent volontiers plusieurs heures après l’exposition.",
            "Elles surviennent parfois des jours plus tard et prennent surtout un masque cutané.",
          ),
        ],
      ),
      qcm(
        ...
        [
          F(
            "Un collapsus cardiovasculaire avec désaturation profonde.",
            "Cette défaillance vitale menaçante appartient au grade III de la classification.",
          ),
          F(
            "Un bronchospasme sévère résistant aux premiers bolus.",
            "Un bronchospasme rebelle correspond au troisième degré de Ring et Messmer.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Une forme grave survient environ une fois sur 100 000 anesthésies générales.",
            "L’incidence des formes graves avoisine une anesthésie générale sur dix mille, soit dix fois plus fréquente.",
          ),
          F(
          ...
          F(
            "La mortalité européenne rapportée dépasse 30 % des accidents anaphylactiques.",
            "Les données européennes chiffrent ce risque de décès à trois ou quatre pour cent.",
          ),
          F(
    ...
    questions: [
      qcm(
        ...
        [
          ...
          T(
            "L’aprotinine, prévalente autrefois, devenue exceptionnelle après son retrait.",
            "Son retrait du marché dans plusieurs pays a fait disparaître ces accidents.",
          ),
          T(
            "Le sugammadex.",
      ...
      qcm(
        ...
        [
          F(
            "L’apogée de l’épidémie de SIDA a fait reculer l’usage des gants.",
            "Cette période s’est accompagnée d’un recours massif aux gants par les soignants.",
          ),
          F(
            "La fabrication modifiée des gants en conserve une teneur résiduelle.",
            "Les gants produits aujourd’hui sont dépourvus de latex depuis cette évolution industrielle.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          F(
            "L’emploi courant de cathéters imprégnés de chlorhexidine est encouragé.",
            "Cet usage courant est découragé malgré l’objectif de prévention infectieuse affiché.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Proposer une alternative antibiotique si un acte urgent s’impose.",
            "L’urgence laisse rarement le temps d’une exploration allergologique préalable complète.",
          ),
        ],
      ),
      qcm(
        ...
        [
          ...
          F(
            "La pholcodine est un antitussif dépourvu de parenté chimique avec les curares.",
            "Sa fonction ammonium quaternaire l’apparente aux curares et explique le risque observé.",
          ),
          F(
          ...
          F(
            "Les opioïdes constituent la première cause d’anaphylaxie IgE-médiée périopératoire.",
            "Curares et antibiotiques dominent, les morphiniques donnant surtout une histaminolibération non allergique.",
          ),
          F(
    ...
    questions: [
      qcm(
        ...
        [
          ...
          T(
            "Appeler de l’aide pour mener les gestes simultanément.",
            "Un opérateur seul conduit difficilement traitement, surveillance et préparation des médicaments.",
          ),
          T(
      ...
      qcm(
        ...
        [
          F(
            "Grade I : adrénaline titrée par voie intraveineuse d’emblée.",
            "Ce niveau relève d’un traitement symptomatique et du retrait de l’agent causal.",
          ),
          T(
      ...
      qcm(
        ...
        [
          F(
            "Retenir le caractère réfractaire dès la troisième minute de traitement.",
            "Ce qualificatif s’applique au-delà de dix minutes de traitement bien conduit.",
          ),
          T(
          ...
          T(
            "Poursuivre un remplissage abondant par cristalloïdes.",
            "Les experts jugent souvent les volumes administrés insuffisants lors de ces chocs.",
          ),
        ],
      ),
      qcm(
        ...
        [
          F(
            "Prélever la tryptase au-delà de la vingt-quatrième heure pour confirmer la crise.",
            "La cinétique impose un prélèvement précoce, la valeur tardive servant seulement de référence.",
          ),
          T(
      ...
      qcm(
        ...
        [
          F(
            "Surveiller trente minutes après récupération avant le retour en chambre.",
            "Plusieurs heures de surveillance restent requises devant le risque de dégradation secondaire.",
          ),
          T(
          ...
          F(
            "Confier au patient la charge d’identifier lui-même l’agent responsable.",
            "Les consignes provisoires sont établies par l’équipe avant le bilan spécialisé.",
          ),
          F(
    ...
    questions: [
      qcm(
        ...
        [
          ...
          F(
            "Le protoxyde d’azote déclenche la libération calcique chez le sujet susceptible.",
            "Seuls les halogénés volatils et la succinylcholine sont reconnus comme agents déclencheurs.",
          ),
          F(
      ...
      qcm(
        ...
        [
          F(
            "Une bradycardie précoce sous ventilation constante.",
            "Le rythme cardiaque s’accélère lorsque le catabolisme musculaire s’emballe.",
          ),
          T(
          ...
          T(
            "Une hyperpnée avec instabilité des paramètres circulatoires.",
            "La crise associe polypnée compensatrice et fluctuations tensionnelles rapides.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Une CK qui reste inférieure à 500 UI après 24 heures.",
            "La rhabdomyolyse porte souvent ce dosage au-delà de vingt mille unités.",
          ),
      ...
      qcm(
        ...
        [
          ...
          T(
            "Une rhabdomyolyse d’origine traumatique.",
            "Hyperkaliémie, myoglobinémie et myoglobinurie y ressemblent à celles de la crise.",
          ),
          T(
    ...
    questions: [
      qcm(
        ...
        [
          ...
          T(
            "Poser sans délai un cathéter de gros calibre.",
            "L’accès vasculaire est installé en même temps que la prise en charge des voies aériennes.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Chaque flacon de 20 mg est reconstitué dans 10 mL d’eau stérile.",
            "La reconstitution demande soixante millilitres pour chaque ampoule de vingt milligrammes.",
          ),
          F(
      ...
      qcm(
        ...
        [
          F(
            "Récuser toute chirurgie ambulatoire chez un sujet susceptible.",
            "L’ambulatoire reste possible avec observation, accompagnement et proximité d’un établissement équipé.",
          ),
          T(
    ...
    questions: [
      qcm(
        ...
        [
          ...
          T(
            "Une variabilité pharmacodynamique d’origine génétique.",
            "Elle peut créer un besoin supranormal en agent hypnotique.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          T(
            ...
            "L’obésité figure parmi les prédispositions reconnues dans les enquêtes épidémiologiques.",
          ),
          T(
      ...
      qcm(
        ...
        [
          F(
            "Le BIS mesure directement la concentration cérébrale d’hypnotique.",
            "Il dérive d’un traitement continu de l’électroencéphalogramme frontal.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Rencontrer le patient en personne après sa convalescence initiale.",
            "L’entretien direct de l’anesthésiste structure la reconnaissance de l’épisode vécu.",
          ),
        ],
      ),
    ],
...
const DP_QCM_SERIES = [
  {
    ...
    questions: [
      qcm(
        ...
        [
          F(
            "Hyperthermie maligne débutante.",
            "Les produits administrés ici ne comptent pas parmi les déclencheurs reconnus de ce syndrome.",
          ),
          F(
      ...
      qcm(
        ...
        [
          F(
            "Injecter d’emblée 1 mg d’adrénaline par voie intraveineuse.",
            "Cette dose d’arrêt circulatoire dépasse largement les microbolus titrés attendus ici.",
          ),
          T(
          ...
          T(
            "Contrôler les produits réellement injectés depuis l’induction.",
            "Une erreur médicamenteuse doit être écartée devant toute crise peranesthésique brutale.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Limiter le remplissage à 500 mL pour éviter un œdème pulmonaire.",
            "La fuite capillaire impose des volumes supérieurs, souvent jugés insuffisants par les experts.",
          ),
          F(
          ...
          T(
            "Maintenir une FiO2 élevée pendant toute l’escalade thérapeutique.",
            "L’hypoxémie menace tant que choc et bronchospasme persistent.",
          ),
        ],
      ...
      qcm(
        ...
        [
          ...
          F(
            "Un inhibiteur de l’enzyme de conversion protège des formes graves.",
            "Ce traitement figure parmi les terrains retrouvés chez les patients qui décèdent.",
          ),
          F(
            "Une adrénaline injectée dans les deux premières minutes.",
            "Un traitement précoce améliore l’évolution plutôt qu’il n’entretient la réfractarité.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Atropine en perfusion continue pour restaurer la pression.",
            "Le blocage vagal ne corrige pas la vasoplégie ni la fuite capillaire anaphylactiques.",
          ),
          F(
          ...
          T(
            "Poursuite du remplissage par cristalloïdes.",
            "La déplétion volémique persiste tant que la perméabilité capillaire reste altérée.",
          ),
        ],
      ...
      qcm(
        ...
        [
          ...
          T(
            ...
            "Cette trace oriente les équipes lors des interventions ultérieures.",
          ),
          T(
    ...
    questions: [
      ...
      qcm(
        ...
        [
          ...
          T(
            "Différer le choix de l’antibioprophylaxie jusqu’à l’avis spécialisé.",
            "Une intervention programmée autorise d’attendre l’évaluation allergologique avant de trancher.",
          ),
          T(
      ...
      qcm(
        ...
        [
          F(
            "Un dosage des IgE spécifiques suffisant à confirmer l’allergie.",
            "L’algorithme repose sur des tests cutanés puis, au besoin, un test de provocation.",
          ),
          F(
            "Un test de contracture à l’halothane et à la caféine.",
            "Cet examen explore la susceptibilité à l’hyperthermie maligne, pas une hypersensibilité médicamenteuse.",
          ),
          F(
      ...
      qcm(
        ...
        [
          F(
            "Des tests négatifs imposent une exploration répétée tous les six mois.",
            "L’algorithme conclut à une allergie éliminée, sans programme de contrôle périodique.",
          ),
          F(
            "Le résultat s’étend à l’ensemble des familles d’antibiotiques.",
            "Seules les molécules réellement explorées sont concernées par cette conclusion.",
          ),
          F(
      ...
      qcm(
        ...
        [
          F(
            "Une dispense d’antibioprophylaxie pour l’intervention prévue.",
            "L’indication chirurgicale de la prophylaxie reste entière après le bilan allergologique.",
          ),
          T(
          ...
          F(
            "Une protection contre l’anaphylaxie à tous les agents anesthésiques.",
            "Seule la classe antibiotique testée a fait l’objet d’une exploration.",
          ),
          F(
      ...
      qcm(
        ...
        [
          F(
            "Administrer la dose une heure après l’incision chirurgicale.",
            "L’antibioprophylaxie précède l’incision pour atteindre sa concentration tissulaire utile.",
          ),
          T(
      ...
      qcm(
        ...
        [
          F(
            "La consigne d’éviter tout antiseptique à la chlorhexidine.",
            "Le bilan portait sur une bêta-lactamine et non sur un antiseptique cutané.",
          ),
          F(
            "Une ordonnance d’adrénaline auto-injectable à conserver en permanence.",
            "Ce dispositif s’adresse aux allergies confirmées, que l’exploration a précisément écartées.",
          ),
          F(
          ...
          T(
            "Le nom des molécules testées et tolérées.",
            "La précision des produits explorés facilite les prescriptions ultérieures.",
          ),
        ],
    ...
    questions: [
      qcm(
        ...
        [
          F(
            ...
            "Seuls les bloqueurs dépolarisants figurent parmi les agents déclencheurs reconnus.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Prélever gaz du sang et ionogramme dès que possible.",
            "Ce premier bilan recherche une acidose mixte et une hyperkaliémie.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Viser 10 mg/kg cumulés si les signes persistent.",
            "Ce seuil borne la première phase du traitement spécifique.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Glycémie et créatinine dans le bilan initial.",
            "Ces dosages guident l’insulinothérapie et surveillent la fonction rénale.",
          ),
        ],
      ...
      qcm(
        ...
        [
          ...
          F(
            "Administrer 10 à 30 mmol/kg de bicarbonate par dose.",
            "La posologie retenue va de une à trois millimoles par kilogramme et par dose.",
          ),
          F(
            "Injecter du chlorure de calcium en première intention.",
            "Le calcium est réservé aux arythmies sévères liées à l’hyperkaliémie.",
          ),
          F(
      ...
      qcm(
        ...
        [
          F(
            "Placer les filtres au charbon activé en dehors du circuit.",
            "Les filtres sont insérés dans le circuit pour adsorber les traces halogénées.",
          ),
          F(
            "Remplacer le circuit uniquement au retour au bloc le lendemain.",
            "Circuit et chaux sodée sont changés dès que le temps le permet.",
          ),
          T(
      ...
      qcm(
        ...
        [
          F(
            "Retour en secteur ambulatoire après six heures d’observation.",
            "Vingt-quatre à quarante-huit heures de soins intensifs sont requises devant le risque de rechute.",
          ),
          T(
    ...
    questions: [
      ...
      qcm(
        ...
        [
          ...
          T(
            "Prévoir un ventilateur de réanimation si la purge reste incertaine.",
            "Certaines équipes réservent alors la machine d’anesthésie au seul monitorage.",
          ),
        ],
      ...
      qcm(
        ...
        [
          ...
          T(
            "Technique anesthésique dépourvue d’agent déclencheur.",
            "L’ambulatoire se discute uniquement après une anesthésie sûre pour l’hyperthermie maligne.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Un test génétique négatif écarte la susceptibilité des apparentés.",
            "Plus de quatre cents mutations sont décrites et l’analyse reste réservée à quelques familles.",
          ),
          T(
  ...
  },
  {
    ...
    questions: [
      qcm(
        ...
        [
          F(
            "L’anesthésie inhalée avec concentration expirée monitorée.",
            "La mesure de la fraction expirée constitue une barrière contre l’allègement involontaire.",
          ),
          T(
            "La TIVA.",
      ...
      qcm(
        ...
        [
          F(
            "L’alarme de concentration expirée du propofol.",
            "Un agent administré par voie veineuse ne produit aucune fraction expirée mesurable.",
          ),
          T(
          ...
          T(
            "Présence effective de l’hypnotique dans la seringue montée.",
            "Une seringue vide ou intervertie interrompt totalement la délivrance prévue.",
          ),
          T(
      ...
      qcm(
        ...
        [
          F(
            "Administrer un morphinique seul pour rétablir l’inconscience.",
            "Les opioïdes contrôlent la nociception sans assurer la composante hypnotique.",
          ),
          F(
            "Reprendre la perfusion au même débit, sans dose de charge.",
            "Un bolus est nécessaire pour rattraper la concentration plasmatique perdue.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          T(
            "La technique de l’avant-bras isolé, étalon-or de détection.",
            "Elle soustrait un membre au curare et reste la référence peropératoire.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Le caractère le plus désagréable de l’expérience.",
            "Le questionnaire de Brice explore aussi le vécu le plus pénible rapporté.",
          ),
        ],
      ...
      qcm(
        ...
        [
          ...
          T(
            "Expliquer qu’une analyse de l’événement est engagée.",
            "Annoncer la démarche d’investigation soutient la relation de soin.",
          ),
          T(
      ...
      qcm(
        ...
        [
          F(
            "Réserver l’avis psychologique aux récits comportant une douleur intense.",
            "La détresse liée à la paralysie vécue justifie à elle seule un soutien spécialisé.",
          ),
          T(
          ...
          T(
            "Assurer un suivi prolongé au-delà du soutien initial.",
            "Ce suivi est primordial car les manifestations peuvent apparaître secondairement.",
          ),
          T(
    ...
    questions: [
      qcm(
        ...
        [
          ...
          T(
            "Envisager une antagonisation si le produit identifié le permet.",
            "La reconnaissance de l’agent ouvre parfois un traitement spécifique comme la naloxone.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          T(
            "L’appel téléphonique survenu pendant la préparation.",
            "Une tâche interrompue est reprise à la mauvaise étape, sans étiquetage.",
          ),
          T(
      ...
      qcm(
        ...
        [
          F(
            "Elle reste anodine lorsque l’opérateur est expérimenté.",
            "L’expertise ne protège pas de la rupture d’une séquence critique.",
          ),
          F(
            "Elle concerne surtout les périodes de faible activité.",
            "Les interruptions abondent dans les phases de forte charge et de stress.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Comparer l’organisation des plateaux entre les salles.",
            "L’hétérogénéité des présentations constitue une condition latente à corriger.",
          ),
          T(
      ...
      qcm(
        ...
        [
          F(
            "Confier la préparation au professionnel qui répond au téléphone.",
            "La séparation des rôles évite qu’une même personne subisse la rupture de tâche.",
          ),
          F(
            "Regrouper préparation et transmission d’équipe dans le même créneau.",
            "Les relèves imparfaites comptent parmi les situations qui favorisent l’erreur.",
          ),
          F(
          ...
          T(
            "Signaler visuellement la préparation en cours.",
            "Un repère visible décourage les sollicitations pendant la séquence critique.",
          ),
        ],
      ...
      qcm(
        ...
        [
          ...
          T(
            "Indiquer que l’analyse associe les professionnels concernés.",
            "Nommer les acteurs de l’investigation rend la démarche vérifiable.",
          ),
          F(
    ...
    questions: [
      qcm(
        ...
        [
          ...
          T(
            "Une crise peut suivre plusieurs anesthésies antérieures bien tolérées.",
            "Les manifestations varient et une exposition tolérée n’exclut pas un épisode ultérieur.",
          ),
        ],
      ),
      qcm(
        ...
        [
          ...
          F(
            "Ventiler à volume courant réduit pour limiter la production de CO2.",
            "La ventilation doit être fortement augmentée, parfois jusqu’à dix fois la normale.",
          ),
          T(
          ...
          T(
            "Traiter d’abord l’hypothèse la plus létale.",
            "Devant un doute diagnostique, l’hyperthermie maligne est prise en charge en priorité.",
          ),
          T(
      ...
      qcm(
        ...
        [
          F(
            "Un syndrome malin des neuroleptiques installé en quelques minutes.",
            "Son évolution s’étale habituellement sur sept à dix jours.",
          ),
          T(
          ...
          T(
            "Une réaction anaphylactique avec instabilité hémodynamique grave.",
            "Elle peut être difficile à distinguer de la crise durant les premières minutes.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          T(
            ...
            "Les antécédents familiaux pondèrent l’évaluation de la susceptibilité individuelle.",
          ),
        ],
      ...
      qcm(
        ...
        [
          F(
            "La réponse au dantrolène suffit à classer l’événement au rang 6.",
            "Le score NAMHR additionne plusieurs processus cliniques et biologiques pondérés.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Un coma persistant après la crise.",
            "Une atteinte neurologique prolongée complète le tableau des formes graves.",
          ),
        ],
      ...
      qcm(
        ...
        [
          ...
          F(
            "Le test de contracture possède une valeur prédictive positive élevée.",
            "Sa valeur prédictive positive demeure faible du fait de la rareté de la maladie.",
          ),
          T(
  ...
  },
  {
    ...
    questions: [
      qcm(
        ...
        [
          F(
            "L’anesthésie générale pour césarienne impose des doses hypnotiques majorées.",
            "Les doses sont souvent limitées pour épargner tonus utérin et nouveau-né.",
          ),
          F(
            "L’incidence de l’éveil en césarienne avoisine 1/19 600 anesthésies.",
            "L’audit britannique rapporte environ un cas pour six cent soixante-dix césariennes.",
          ),
          F(
            "L’emploi de bloqueurs neuromusculaires abaisse l’incidence rapportée.",
            "Ce même audit relève un cas pour huit mille deux cents anesthésies avec curare.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Expliquer que l’épisode relève d’une particularité génétique.",
            "L’enquête a identifié une fraction expirée insuffisante, cause technique corrigeable.",
          ),
          F(
            "Renvoyer la patiente vers son médecin traitant pour l’explication.",
            "L’anesthésiste doit la rencontrer lui-même et restituer ce qui a été trouvé.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Un adjuvant comme la kétamine lorsque l’anesthésie doit rester légère.",
            "Kétamine, midazolam ou scopolamine soutiennent l’inconscience dans ce contexte contraint.",
          ),
          T(
      ...
      qcm(
        ...
        [
          F(
            "Une amnésie complète de la période postopératoire.",
            "Le syndrome se manifeste par des reviviscences envahissantes bien plus que par un oubli.",
          ),
          F(
            "Un émoussement affectif apparaissant après six mois seulement.",
            "Les manifestations surviennent précocement et le repérage commence dès la sortie.",
          ),
          T(
          ...
          T(
            "Un état d’hyperstimulation anxieuse.",
            "Cet hyperéveil accompagne les désordres du sommeil décrits.",
          ),
        ],
      ...
      qcm(
        ...
        [
          F(
            "Un traitement anxiolytique au long cours en première intention.",
            "La thérapie cognitivo-comportementale est citée pour traiter ces symptômes persistants.",
          ),
          F(
            "Une consultation limitée au seul chirurgien ayant opéré.",
            "L’anesthésiste conduit l’analyse et restitue l’événement à la patiente.",
          ),
          F(
            "Une clôture du suivi dès la disparition des flashbacks.",
            "Le suivi reste primordial tant que l’anxiété persiste après le soutien initial.",
          ),
          F(
      ...
      qcm(
        ...
        [
          F(
            "Consigner l’antécédent dans le seul compte rendu opératoire.",
            "L’information doit rester visible dans le dossier anesthésique pour l’équipe suivante.",
          ),
          T(
          ...
          F(
            "Imposer une rachianesthésie pour chaque intervention ultérieure.",
            "La technique retenue dépend de l’acte et du terrain, non du seul antécédent.",
          ),
          F(
