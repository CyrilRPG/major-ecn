...
const ISOLATED_QCM = [
  {
    ...
    questions: [
      qcm(
        ...
        [
          ...
          T(
            ...
            "Un débit effondré réduit le volume sanguin acheminé chaque minute vers le réseau coronaire.",
          ),
          T(
            "Élévation de la pression télédiastolique du ventricule gauche.",
            "La pression de perfusion coronaire est la diastolique moins cette pression télédiastolique.",
          ),
          T(
            "Hypoxémie.",
      ...
      qcm(
        ...
        [
          F(
            "Il correspond à un infarctus de type 1 par rupture de plaque coronaire.",
            "Les infarctus postopératoires relèvent surtout du type 2 par déséquilibre énergétique.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Elle justifie de majorer les pressions intrathoraciques pendant la ventilation mécanique.",
            "Des pressions intrathoraciques hautes élèvent les résistances vasculaires pulmonaires.",
          ),
          F(
          ...
          F(
            "Son traitement de fond doit être suspendu la veille de l'intervention.",
            "Les thérapeutiques habituelles de l'hypertension pulmonaire sont poursuivies autour du geste.",
          ),
          T(
    ...
    questions: [
      qcm(
        ...
        [
          ...
          T(
            ...
            "L'atteinte cérébrovasculaire figure parmi les cinq items cliniques que compte ce score.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Courir une courte distance sans s'arrêter.",
            "Une course même brève dépasse le seuil de quatre équivalents métaboliques.",
          ),
          T(
      ...
      qcm(
        ...
        [
          F(
            "Maintenir la date opératoire prévue malgré l'instabilité constatée.",
            "Hors urgence, le report autorise un bilan puis un traitement cardiologique préalable.",
          ),
          T(
          ...
          F(
            "Alléger le monitorage peropératoire pour raccourcir la durée du geste.",
            "Une instabilité cardiaque impose une surveillance hémodynamique renforcée pendant l'anesthésie.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Elle est établie par le dosage du peptide natriurétique de type B.",
            "Ce biomarqueur estime un risque de complication mais ne chiffre aucun effort réalisable.",
          ),
          F(
            "Elle se quantifie grâce au score clinique de Lee.",
            "Ce score additionne cinq antécédents cliniques sans explorer la tolérance à l'effort.",
          ),
          F(
    ...
    questions: [
      qcm(
        ...
        [
          ...
          T(
            "Amputation de membre inférieur pour ischémie critique.",
            "L'artériopathie évoluée et la gravité du tableau placent ce geste au niveau élevé.",
          ),
          T(
          ...
          T(
            "Thrombo-endartériectomie aorto-iliaque.",
            "Le clampage artériel soumet le myocarde à de fortes variations de charge successives.",
          ),
        ],
      ),
      qcm(
        ...
        [
          ...
          T(
            "Exérèse d'une lésion cutanée superficielle.",
            "Un geste cutané limité entraîne peu de retentissement sur la circulation générale.",
          ),
        ],
      ),
      qcm(
        ...
        [
          ...
          T(
            "Trouble du rythme documenté ou palpitations rapportées.",
            "Une anomalie rythmique connue mérite un tracé de référence avant l'anesthésie.",
          ),
        ],
      ),
      qcm(
        ...
        [
          F(
            "Répéter une évaluation cardiologique tous les trois mois chez un cardiopathe stable.",
            "Une cardiopathie stable se réévalue lorsque le dernier bilan remonte à plus de douze mois.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Recherche d'une sténose coronaire significative.",
            "L'échocardiographie de repos apprécie mal l'anatomie des artères coronaires.",
          ),
          F(
            "Dépistage d'une coronaropathie chez un sujet sans symptôme.",
            "Ce dépistage systématique est déconseillé en dehors du haut risque avec faible capacité.",
          ),
          F(
  ...
  },
  {
    ...
    questions: [
      qcm(
        ...
        [
          F(
            "Remplacer le bétabloquant par un inhibiteur calcique le jour du geste.",
            "Aucune substitution de classe n'est proposée pour un bétabloquant chronique bien toléré.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Prévoir une interruption au moins douze heures avant l'intervention.",
            "Ce délai réduit nettement la fréquence des épisodes hypotensifs à l'induction.",
          ),
          T(
          ...
          T(
            "Reprendre la prescription dès que l'état hémodynamique et rénal le permet.",
            "La reprise précoce restaure le bénéfice de fond sur la pression et la fonction cardiaque.",
          ),
        ],
      ),
      qcm(
        ...
        [
          F(
            "Interrompre cinq jours avant le geste la bithérapie d'un stent actif posé le mois précédent.",
            "Un stent pharmacoactif très récent contre-indique l'arrêt de la double antiagrégation.",
          ),
          T(
          ...
          T(
            "Poursuivre l'aspirine seule au-delà de six mois si le saignement attendu impose de suspendre le second agent.",
            "Passé ce délai, la monothérapie antiplaquettaire redevient une option acceptable.",
          ),
        ],
      ),
      qcm(
        ...
        [
          ...
          T(
            "Son bénéfice repose notamment sur des effets pléiotropes portant sur la fonction endothéliale.",
            "Cette action vasculaire explique une part de la prévention des événements cardiaques.",
          ),
        ],
      ),
      qcm(
        ...
        [
          F(
            "Poursuivre l'antivitamine K jusqu'à la veille en misant sur un antagoniste peropératoire.",
            "Devant une chirurgie réglée, l'arrêt programmé plusieurs jours avant reste la règle.",
          ),
          F(
            "Introduire le relais héparinique dès que l'INR dépasse 3.",
            "Le relais débute lorsque l'INR passe sous 2, environ quarante-huit heures après la dernière prise.",
          ),
          T(
  ...
  },
  {
    ...
    questions: [
      qcm(
        ...
        [
          F(
            "La PAM est inversement proportionnelle au volume d'éjection systolique.",
            "La pression varie dans le même sens que le volume éjecté à chaque battement.",
          ),
          T(
          ...
          F(
            "La PAM croît proportionnellement au rayon des vaisseaux.",
            "Le rayon vasculaire intervient à la puissance quatre et de façon inverse sur la pression.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Fonction diastolique du ventricule.",
            "Relaxation et compliance conditionnent le remplissage puis le volume expulsé.",
          ),
        ],
      ),
      qcm(
        ...
        [
          ...
          F(
            "Elle est proportionnelle à l'épaisseur de la paroi ventriculaire.",
            "La loi de Laplace place l'épaisseur murale au dénominateur de la contrainte télédiastolique.",
          ),
          T(
            "Le diamètre télédiastolique mesuré en échographie en constitue un reflet.",
            "Diamètres ventriculaires et pressions télédiastoliques renseignent sur ce remplissage.",
          ),
          T(
      ...
      qcm(
        ...
        [
          F(
            "Administrer un vasoconstricteur puissant pour élever les résistances systémiques.",
            "Des résistances normales ou basses limitent au mieux le volume régurgité.",
          ),
          T(
      ...
      qcm(
        ...
        [
          F(
            "Accepter une pression artérielle diastolique à 35 mmHg sous anesthésie profonde.",
            "Une diastolique sous cinquante millimètres de mercure compromet la perfusion coronaire.",
          ),
          T(
  ...
  },
  {
    ...
    questions: [
      qcm(
        ...
        [
          F(
            "Choisir les dispositifs selon la seule habitude du bloc opératoire.",
            "Le niveau de surveillance découle du terrain, du geste et des décisions attendues.",
          ),
          F(
            "Réserver le suivi du segment ST à une dérivation unique.",
            "Deux dérivations au minimum sont nécessaires pour reconnaître une ischémie peropératoire.",
          ),
          T(
      ...
      qcm(
        ...
        [
          F(
            "Quantifier la fraction d'éjection du ventricule gauche.",
            "L'estimation de la fonction contractile relève de l'imagerie échographique.",
          ),
          F(
            "Offrir la meilleure sensibilité ischémique avec la seule dérivation D3.",
            "Une V5 modifiée procure la sensibilité maximale quand une seule piste est suivie.",
          ),
          F(
      ...
      qcm(
        ...
        [
          F(
            "Mesurer directement la pression de perfusion coronaire.",
            "Cette pression se calcule à partir de valeurs de pression, non d'une image ultrasonore.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Chez tout hypertendu chronique venant pour un geste superficiel.",
            "Une hypertension équilibrée avant une intervention mineure ne réclame aucune ligne artérielle.",
          ),
          T(
          ...
          T(
            "Titrage rapide et précis des agents vasoactifs.",
            "Le signal continu autorise une adaptation immédiate des doses de vasopresseur.",
          ),
        ],
      ),
      qcm(
        ...
        [
          ...
          F(
            "Une pression veineuse centrale à 12 mmHg garantit une réponse au remplissage.",
            "Aucun seuil de pression isolé ne prédit le gain de débit après un apport liquidien.",
          ),
          F(
    ...
    questions: [
      qcm(
        ...
        [
          ...
          T(
            "Connaître l'indication initiale de l'implantation.",
            "Bloc conductif ou prévention rythmique orientent différemment la conduite peropératoire.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Reprogrammation involontaire de certains paramètres.",
            "Un champ électrique intense peut altérer les réglages mémorisés du générateur.",
          ),
          T(
            "Brûlure tissulaire au contact d'une sonde de stimulation.",
            "Le courant se concentre parfois à la pointe d'une sonde et lèse le tissu voisin.",
          ),
        ],
      ),
      qcm(
        ...
        [
          ...
          T(
            "Réduire la puissance délivrée lorsque le geste le permet.",
            "Une énergie moindre diminue l'intensité du champ perçu par l'appareil implanté.",
          ),
        ],
      ),
      qcm(
        ...
        [
          ...
          F(
            "Laisser l'aimant en place jusqu'au retour dans le service d'hospitalisation.",
            "La protection interne doit être rétablie dès la fin de l'exposition électrique.",
          ),
          F(
      ...
      qcm(
        ...
        [
          F(
            "Attendre la consultation de rythmologie programmée dans six mois.",
            "Une exposition documentée impose un contrôle avant la sortie de la zone surveillée.",
          ),
          T(
          ...
          F(
            "Se contenter d'un tracé électrique normal pour affirmer le bon fonctionnement.",
            "Un tracé isolé renseigne mal la programmation et l'état des sondes implantées.",
          ),
          F(
    ...
    questions: [
      ...
      qcm(
        ...
        [
          ...
          T(
            "Sujet âgé opéré en urgence d'une fracture du col fémoral.",
            "L'urgence et l'âge sont deux facteurs reconnus de dommage myocardique.",
          ),
        ],
      ),
      qcm(
        ...
        [
          ...
          F(
            "Considérer une valeur au-dessus du seuil comme un artefact de dosage.",
            "Le dosage de troponine reste fiable et sa hausse traduit une lésion réelle.",
          ),
          F(
          ...
          T(
            "Tenir compte du délai depuis l'intervention, l'incidence culminant durant les 48 premières heures.",
            "La fenêtre des deux premiers jours concentre l'essentiel des événements coronaires.",
          ),
        ],
      ),
      qcm(
        ...
        [
          F(
            "Un NSTEMI se définit par un sus-décalage transitoire du segment ST.",
            "Cette forme se caractérise justement par un tracé sans sus-décalage persistant.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Interrompre définitivement les antiagrégants après l'épisode.",
            "Les traitements antiplaquettaires sont repris dès que l'hémostase le permet.",
          ),
          F(
    ...
    questions: [
      qcm(
        ...
        [
          ...
          F(
            "La colectomie appartient au groupe des chirurgies à faible risque cardiaque.",
            "Une chirurgie intrapéritonéale se situe au niveau de risque intermédiaire.",
          ),
          F(
          ...
          T(
            "L'ouverture de la cavité abdominale entraîne des variations volémiques notables.",
            "Ces transferts liquidiens sollicitent fortement l'adaptation circulatoire du patient.",
          ),
        ],
      ),
      qcm(
        ...
        [
          F(
            "Elle dispense d'évaluer le risque propre à la colectomie.",
            "Le risque chirurgical se cote indépendamment de la capacité d'effort du patient.",
          ),
          F(
            "Elle correspond à environ deux équivalents métaboliques.",
            "Deux étages gravis sans pause représentent nettement plus de quatre METS.",
          ),
          F(
      ...
      qcm(
        ...
        [
          F(
            "Suspendre le bisoprolol la veille pour limiter le risque d'hypotension.",
            "Un bétabloquant chronique bien toléré se poursuit à sa posologie habituelle.",
          ),
          T(
            "Administrer le comprimé du matin avec une gorgée d'eau.",
            "La prise matinale évite toute fenêtre d'arrêt le jour même de l'intervention.",
          ),
          T(
      ...
      qcm(
        ...
        [
          F(
            "Accepter 120 battements par minute tant que la pression reste normale.",
            "Un tel rythme raccourcit la diastole et augmente la demande en oxygène.",
          ),
          T(
          ...
          F(
            "Transfuser dès que l'hémoglobine passe sous 11 g/dL.",
            "Aucun seuil transfusionnel aussi haut n'est retenu chez le coronarien opéré.",
          ),
          T(
            "Rester dans une marge de 20 % des valeurs habituelles du patient.",
            "Respecter ses repères personnels préserve son équilibre énergétique myocardique.",
          ),
        ],
      ...
      qcm(
        ...
        [
          ...
          F(
            "L'approfondissement de l'anesthésie rétablira la pression artérielle.",
            "Une narcose plus profonde accentue la vasodilatation et abaisse encore la pression.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Relire la feuille d'anesthésie à la recherche d'hypotension ou de tachycardie.",
            "Le relevé peropératoire identifie les périodes de déséquilibre énergétique.",
          ),
          T(
            "Répéter l'examen clinique à la recherche de signes atypiques.",
            "Dyspnée, nausée ou malaise remplacent souvent la douleur thoracique typique.",
          ),
        ],
      ...
      qcm(
        ...
        [
          ...
          F(
            "Suspendre la statine jusqu'à la consultation de suivi.",
            "Interrompre une prévention secondaire fragilise le patient juste après l'épisode.",
          ),
          T(
    ...
    questions: [
      qcm(
        ...
        [
          ...
          T(
            "L'irradiation du souffle vers les vaisseaux du cou.",
            "La transmission carotidienne accompagne classiquement un obstacle à l'éjection.",
          ),
        ],
      ),
      qcm(
        ...
        [
          F(
            "Réaliser l'arthroplastie sous rachianesthésie en bolus unique.",
            "Le bloc sympathique dense et rapide de cette technique est déconseillé ici.",
          ),
          F(
            "Se limiter à un électrocardiogramme de repos pour quantifier la lésion.",
            "Seule l'imagerie ultrasonore mesure surface, gradient et retentissement ventriculaire.",
          ),
          T(
          ...
          T(
            "Prévoir la correction valvulaire avant la chirurgie non urgente.",
            "Une sténose serrée symptomatique se corrige avant un geste programmé.",
          ),
        ],
      ...
      qcm(
        ...
        [
          ...
          F(
            "Un gradient moyen inférieur à 20 mmHg.",
            "Une lésion serrée s'accompagne d'un gradient moyen bien plus important.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Anticiper une ischémie du myocarde hypertrophié.",
            "L'hypertrophie accroît la consommation en oxygène et la sensibilité ischémique.",
          ),
          T(
            "Traiter sans délai une fibrillation atriale rapide.",
            "La perte de contraction atriale effondre le remplissage d'un ventricule rigide.",
          ),
        ],
      ...
      qcm(
        ...
        [
          F(
            "Cathéter artériel pulmonaire systématique avant l'induction.",
            "Ce dispositif invasif reste réservé à des situations bien plus sélectionnées.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Vérifier la profondeur d'anesthésie et l'alléger si elle est excessive.",
            "Une concentration trop forte d'agent entretient la vasodilatation observée.",
          ),
        ],
      ...
      qcm(
        ...
        [
          ...
          T(
            "Le risque de dommage myocardique silencieux dans les premiers jours.",
            "Ces événements surviennent surtout entre le premier et le troisième jour.",
          ),
          F(
    ...
    questions: [
      qcm(
        ...
        [
          ...
          F(
            ...
            "Un rythme lent allonge le remplissage et réduit plutôt le gradient sous-aortique.",
          ),
          T(
          ...
          T(
            ...
            "La chute du retour veineux pendant l'effort expiratoire accentue le gradient.",
          ),
        ],
      ),
      qcm(
        ...
        [
          F(
            "Introduire un dérivé nitré la veille pour prévenir l'angor.",
            "Une vasodilatation veineuse abaisse la précharge et aggrave l'obstruction dynamique.",
          ),
          F(
            "Prescrire un jeûne hydrique prolongé de douze heures.",
            "Une déplétion volémique réduit la taille cavitaire et majore le gradient.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Choisir un agent d'induction titré comme l'étomidate.",
            "Une titration progressive limite l'effondrement du tonus vasculaire à l'induction.",
          ),
          T(
            "Préparer un vasoconstricteur pur pour restaurer la postcharge.",
            "Un agent purement vasoconstricteur relève les résistances sans stimuler la contraction.",
          ),
        ],
      ...
      qcm(
        ...
        [
          ...
          F(
            "L'élargissement de la cavité ventriculaire explique la chute de pression.",
            "L'imagerie montre ici une cavité de très petite taille en systole.",
          ),
          T(
            "L'hyperkinésie s'observe malgré un débit antérograde abaissé.",
            "Le muscle se contracte fort mais l'obstacle limite le volume propulsé.",
          ),
          T(
          ...
          T(
            "Le pneumopéritoine a pu réduire le retour veineux.",
            "Une pression abdominale élevée gêne l'écoulement veineux vers l'oreillette droite.",
          ),
        ],
      ...
      qcm(
        ...
        [
          F(
            "Injecter un dérivé nitré pour soulager le ventricule.",
            "La baisse de précharge et de postcharge accentuerait l'obstruction dynamique.",
          ),
          F(
            "Accélérer la fréquence par un agent chronotrope positif.",
            "Une diastole raccourcie diminue le volume cavitaire et majore le gradient.",
          ),
          F(
          ...
          T(
            "Approfondir l'analgésie pour réduire la décharge adrénergique.",
            "Moins de catécholamines endogènes signifie moins de contractilité et de tachycardie.",
          ),
        ],
      ...
      qcm(
        ...
        [
          F(
            "Attendre une cardioversion spontanée sous surveillance simple.",
            "Une arythmie mal tolérée exige une correction immédiate du rythme.",
          ),
          F(
            "Introduire un traitement digitalique par voie orale.",
            "Un délai d'action lent convient mal à une arythmie déjà mal supportée.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Repousser la reprise du bétabloquant à la première consultation.",
            "Une fenêtre prolongée expose à une tachycardie de rebond dangereuse ici.",
          ),
          F(
            "Restreindre les apports hydriques pour prévenir toute congestion.",
            "Une précharge basse réactive l'obstruction dynamique sous-aortique.",
          ),
          F(
    ...
    questions: [
      qcm(
        ...
        [
          ...
          T(
            "Le poids et l'âge de la patiente.",
            "Ces paramètres entrent dans l'adaptation posologique des anticoagulants directs.",
          ),
          T(
      ...
      qcm(
        ...
        [
          F(
            "Une clairance rénale normale justifie à elle seule un relais.",
            "La fonction rénale règle le délai d'arrêt, pas la décision d'un relais.",
          ),
          F(
            "L'arrêt d'un anticoagulant direct expose autant qu'un arrêt d'antivitamine K.",
            "La demi-vie brève de ces molécules raccourcit nettement la fenêtre sans protection.",
          ),
          F(
          ...
          T(
            "Le relais reste réservé à des situations comme une valve mécanique.",
            "Valve mécanique, embolie récente ou arythmie emboligène motivent seules cette stratégie.",
          ),
        ],
      ...
      qcm(
        ...
        [
          ...
          F(
            "Reporter le geste si la dernière prise remonte à plus de 48 heures.",
            "Un délai long est justement le but recherché avant l'incision chirurgicale.",
          ),
          F(
          ...
          T(
            "S'assurer que la voie veineuse et le groupe sanguin sont disponibles.",
            "La préparation transfusionnelle sécurise un geste au risque hémorragique réel.",
          ),
        ],
      ...
      qcm(
        ...
        [
          F(
            "Administrer immédiatement du plasma frais congelé pour antagoniser la molécule.",
            "Le plasma ne renverse pas l'effet d'un inhibiteur direct du facteur Xa.",
          ),
          F(
            "Poursuivre la dissection en misant sur une hémostase spontanée.",
            "Un saignement diffus croissant impose une reprise active du contrôle chirurgical.",
          ),
          T(
      ...
      qcm(
        ...
        [
          F(
            "Reprendre l'anticoagulant dès la fermeture cutanée.",
            "Une reprise trop précoce favorise l'hématome et la réintervention.",
          ),
          T(
          ...
          T(
            "Tenir compte du caractère encore productif du drain pelvien.",
            "Un drainage actif signale une hémostase locale non encore acquise.",
          ),
          T(
            "Peser le risque embolique de l'arythmie pendant la fenêtre sans traitement.",
            "Une interruption prolongée expose à l'accident thrombotique que l'on veut prévenir.",
          ),
        ],
      ...
      qcm(
        ...
        [
          ...
          F(
            "L'indication de doser régulièrement l'INR à domicile.",
            "Ce médicament ne se surveille pas par une mesure d'INR de routine.",
          ),
          F(
            "La liste des aliments interdits pendant le traitement.",
            "Les restrictions alimentaires concernent les antivitamines K, non cette classe.",
          ),
          F(
  ...
  },
  {
    ...
    questions: [
      qcm(
        ...
        [
          F(
            "Marche de trente minutes sans essoufflement.",
            "Cette tolérance à l'effort témoigne plutôt d'une situation compensée.",
          ),
          T(
          ...
          F(
            "Fréquence cardiaque de repos à 68 par minute.",
            "Un rythme calme au repos oriente mal vers une décompensation active.",
          ),
          F(
          ...
          T(
            ...
            "Ces signes droits accompagnent une élévation des pressions de remplissage.",
          ),
        ],
      ),
      qcm(
        ...
        [
          F(
            "Sa fraction d'éjection est probablement redevenue normale.",
            "Une bonne tolérance clinique ne garantit aucune récupération systolique.",
          ),
          F(
            "L'anesthésie générale peut être conduite comme chez un sujet sain.",
            "Une fraction d'éjection abaissée modifie la tolérance aux agents anesthésiques.",
          ),
          F(
      ...
      qcm(
        ...
        [
          F(
            "Interrompre le bétabloquant le matin pour préserver la pression à l'induction.",
            "Cette omission favorise une tachycardie de rebond chez un insuffisant cardiaque.",
          ),
          T(
          ...
          F(
            "Poursuivre l'inhibiteur du SRAA sans considérer le risque d'hypotension.",
            "Le blocage du système rénine-angiotensine majore la vasoplégie de l'induction.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Mesurer le débit cardiaque si le doute persiste.",
            "Une valeur de débit tranche entre vasoplégie dominante et défaillance de pompe.",
          ),
          T(
          ...
          T(
            "Vérifier l'effet résiduel des agents d'induction.",
            "La baisse des résistances et de l'inotropie suit couramment l'anesthésie générale.",
          ),
        ],
      ...
      qcm(
        ...
        [
          ...
          F(
            "Perfuser un litre de cristalloïde avant toute autre mesure.",
            "Un apport fixe et aveugle ignore la réponse individuelle du volume d'éjection.",
          ),
          F(
          ...
          T(
            "Maintenir une pression de perfusion compatible avec les organes.",
            "Rein, cerveau et myocarde tolèrent mal une hypotension qui se prolonge.",
          ),
        ],
      ...
      qcm(
        ...
        [
          F(
            "Diurèse abondante depuis l'intervention.",
            "Une élimination importante s'oppose plutôt à l'accumulation hydrosodée observée.",
          ),
          T(
          ...
          T(
            "Orthopnée survenue au cours de la nuit.",
            "Le décubitus redistribue le volume sanguin et démasque la congestion gauche.",
          ),
        ],
      ...
      qcm(
        ...
        [
          ...
          F(
            "Instaurer d'emblée un inotrope pour lever la congestion.",
            "Faute de défaillance contractile nouvelle, cette stimulation vient trop tôt.",
          ),
          T(
          ...
          T(
            "Réévaluer le bilan entrées-sorties chaque jour.",
            "Le suivi quotidien des volumes objective l'efficacité de la déplétion.",
          ),
        ],
    ...
    questions: [
      qcm(
        ...
        [
          ...
          F(
            "Impédance des sondes mesurée au moment de la pose.",
            "Seules les mesures de la dernière interrogation reflètent l'état actuel des sondes.",
          ),
          F(
            "Nombre de chocs délivrés par l'appareil depuis sa pose.",
            "Un simple stimulateur ne délivre aucune thérapie de défibrillation.",
          ),
          F(
            "Certitude que l'aimant suspendra la stimulation.",
            "Sur ce type d'appareil, l'aimant impose plutôt un fonctionnement asynchrone.",
          ),
          T(
            "Réponse attendue de l'appareil à l'application d'un aimant.",
            "Cette réponse conditionne la stratégie retenue pendant l'électrochirurgie.",
          ),
        ],
      ),
      qcm(
        ...
        [
          ...
          T(
            "Une pause prolongée peut provoquer une perte de connaissance.",
            "L'arrêt du débit cérébral survient en quelques secondes d'asystolie.",
          ),
          T(
            "La surveillance du pouls doit compléter le tracé électrique.",
            "Un signal mécanique distingue une contraction réelle d'un artefact électrique.",
          ),
        ],
      ...
      qcm(
        ...
        [
          ...
          T(
            "Vérifier la disponibilité d'un stimulateur externe avant l'incision.",
            "Un relais externe couvre une inhibition prolongée chez un patient dépendant.",
          ),
          T(
            "Interrompre le courant si une pause de stimulation apparaît.",
            "Cesser l'activation permet au dispositif de reprendre son fonctionnement normal.",
          ),
        ],
      ...
      qcm(
        ...
        [
          ...
          F(
            "Mesure de la pression artérielle toutes les quinze minutes.",
            "Un intervalle aussi long masquerait une pause de plusieurs battements.",
          ),
          T(
          ...
          T(
            "Personnel formé à la réponse du dispositif joignable.",
            "Une compétence d'interrogation doit rester accessible pendant toute l'intervention.",
          ),
        ],
      ...
      qcm(
        ...
        [
          ...
          F(
            "Remplacer le bistouri par un laser pour supprimer tout risque.",
            "Aucune technique ne dispense de la surveillance chez un patient dépendant.",
          ),
          T(
          ...
          T(
            "Documenter l'épisode d'inhibition dans le dossier d'anesthésie.",
            "La traçabilité de l'incident guidera le contrôle du boîtier après le geste.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Vérifier l'absence de modification des seuils de stimulation.",
            "Une exposition électrique peut déplacer les valeurs mesurées sur chaque sonde.",
          ),
          T(
            "Consigner l'événement sur la carte de porteur du dispositif.",
            "Ce document accompagne le patient et informe les équipes ultérieures.",
          ),
        ],
    ...
    questions: [
      qcm(
        ...
        [
          ...
          T(
            "Enregistrement des épisodes rythmiques survenus.",
            "La mémoire du boîtier conserve les tracés utiles au diagnostic ultérieur.",
          ),
          T(
            "Stimulation antitachycardique par salves rapides.",
            "Des salves programmées peuvent réduire une arythmie soutenue sans délivrer d'énergie.",
          ),
        ],
      ),
      qcm(
      ...
      qcm(
        ...
        [
          F(
            "Il augmente l'énergie du prochain choc interne délivré.",
            "L'aimant agit sur la détection, sans modifier l'énergie programmée.",
          ),
          F(
            "Il produit le même effet sur tous les modèles de défibrillateur.",
            "Fabricants et programmations font varier la réponse magnétique attendue.",
          ),
          F(
          ...
          F(
            "Il autorise à quitter la salle sans défibrillateur externe.",
            "La protection interne suspendue impose un moyen de choc externe immédiat.",
          ),
          T(
            "Il suspend habituellement la détection des tachyarythmies.",
            "Les thérapies antitachycardiques cessent tant que l'aimant reste en place.",
          ),
        ],
      ...
      qcm(
        ...
        [
          ...
          F(
            "Palettes externes collées directement sur le boîtier.",
            "Les électrodes doivent rester éloignées du générateur pour l'épargner.",
          ),
          F(
            "Interrogation du dispositif pendant l'électrochirurgie.",
            "Un contrôle du boîtier se réalise mal au milieu d'un champ perturbé.",
          ),
          F(
          ...
          T(
            "Défibrillateur externe immédiatement opérationnel.",
            "Une arythmie maligne doit pouvoir être traitée pendant la suspension.",
          ),
        ],
      ...
      qcm(
        ...
        [
          ...
          T(
            "Vérifier la présence d'un pouls avant tout choc.",
            "Une tachycardie sans pouls relève immédiatement de la réanimation cardiopulmonaire.",
          ),
          T(
            "Corriger une hypokaliémie ou une hypomagnésémie associée.",
            "Un déficit ionique entretient l'instabilité électrique du myocarde.",
          ),
        ],
      ...
      qcm(
        ...
        [
          ...
          T(
            "Doser la troponine à la recherche d'une souffrance myocardique.",
            "Le biomarqueur objective une atteinte cellulaire déclenchée par l'arythmie.",
          ),
        ],
      ...
      qcm(
        ...
        [
          F(
            "Transférer la patiente dès la fin de l'anesthésie sans contrôle du boîtier.",
            "Le dispositif doit être interrogé avant de quitter une zone monitorée.",
          ),
          T(
          ...
          T(
            "Retirer l'aimant et confirmer la restauration des thérapies.",
            "Une suspension prolongée laisserait la patiente sans protection interne.",
          ),
          T(
            "Transmettre les données de l'épisode au rythmologue référent.",
            "Le suivi spécialisé ajustera réglages et traitement antiarythmique ultérieurs.",
          ),
        ],
  ...
  },
  {
    ...
    questions: [
      qcm(
        ...
        [
          F(
            "Diabète équilibré par un seul antidiabétique oral.",
            "Seul le diabète traité par insuline compte dans ce score clinique.",
          ),
          F(
            "Créatinine plasmatique mesurée à 110 µmol/L.",
            "Le seuil retenu se situe au-dessus de 177 micromoles par litre.",
          ),
          T(
      ...
      qcm(
        ...
        [
          F(
            "Arrêt du bétabloquant pour démasquer une tachycardie d'alerte.",
            "Le maintien de ce traitement protège davantage qu'il ne masque un signal.",
          ),
          T(
          ...
          T(
            "Reprise précoce du traitement antiangineux habituel.",
            "Antiangineux et antiplaquettaires se reprennent le plus tôt possible après le geste.",
          ),
          T(
            "Maintien de la normothermie et contrôle de la douleur.",
            "Douleur et hypothermie déséquilibrent la balance énergétique au réveil.",
          ),
        ],
      ...
      qcm(
        ...
        [
          ...
          T(
            "Une élévation même isolée garde une valeur pronostique.",
            "Le surcroît de mortalité à distance persiste malgré un tableau muet.",
          ),
          T(
            "Le seuil et la génération du dosage doivent être connus.",
            "L'interprétation dépend du test employé et de sa valeur de référence.",
          ),
        ],
      ...
      qcm(
        ...
        [
          ...
          T(
            "Recherche d'un facteur déclenchant systémique.",
            "Sepsis, embolie ou trouble du rythme peuvent expliquer la hausse observée.",
          ),
          F(
      ...
      qcm(
        ...
        [
          F(
            "La poursuite du bétabloquant à sa dose habituelle.",
            "Cette classe améliore plutôt l'oxygénation myocardique périopératoire.",
          ),
          F(
            "L'analgésie postopératoire jugée efficace.",
            "Une douleur bien contrôlée limite l'activation sympathique et la demande.",
          ),
          T(
          ...
          T(
            "Le stress chirurgical majorant les besoins en oxygène.",
            "L'agression opératoire augmente la demande énergétique du muscle cardiaque.",
          ),
        ],
      ...
      qcm(
        ...
        [
          F(
            "Administrer un dérivé nitré à forte dose malgré l'hypotension.",
            "Une vasodilatation supplémentaire effondrerait la pression de perfusion coronaire.",
          ),
          F(
            "Viser une hémoglobine supérieure à 13 g/dL par transfusion.",
            "Aucune cible transfusionnelle aussi élevée n'est retenue en postopératoire.",
          ),
          T(
          ...
          T(
            "Poursuivre le monitorage du segment ST sur deux dérivations.",
            "Une surveillance électrique continue suit l'évolution des anomalies constatées.",
          ),
          F(
      ...
      qcm(
        ...
        [
          F(
            "Considérer la décroissance de troponine comme la fin du suivi.",
            "La normalisation biologique ne clôt pas la prise en charge cardiovasculaire.",
          ),
          F(
            "Interrompre la statine puisque le bilan lipidique est normal.",
            "Le bénéfice vasculaire de ce traitement dépasse la seule valeur du cholestérol.",
          ),
          F(
            "Confier le suivi au seul médecin traitant sans compte rendu.",
            "La transmission écrite conditionne la continuité du parcours cardiovasculaire.",
          ),
          F(
          ...
          T(
            "Prévoir une surveillance des jours qui suivent l'intervention.",
            "Les complications cardiaques surviennent surtout durant la première semaine.",
          ),
        ],
