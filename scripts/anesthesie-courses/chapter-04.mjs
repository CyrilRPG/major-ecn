...
const MANUAL_ISOLATED_QCM = [
  manualQcm('Au contrôle avant anesthésie, quels constats localisent correctement les trois étages pneumatiques ?', ['b00013','b00016','b00070','b00109'], 'La localisation suit le flux : stockage à haute pression, préparation du mélange en intermédiaire, échanges respiratoires en basse pression.', 'AC', [
    ...
    ['Le vaporisateur enrichit le mélange dans la partie à pression intermédiaire.', 'Il ajoute l’agent volatil aux gaz issus des débitmètres, avant leur entrée dans le circuit.'],
  ...
  manualQcm('Une défaillance électronique globale survient : quelles affirmations guident une ventilation de secours sûre ?', ['b00003','b00008','b00009','b00010','b00186'], 'Une interface intégrée peut perdre plusieurs fonctions ensemble ; l’oxygénation doit alors être assurée par un moyen indépendant pendant le diagnostic.', 'BCDE', [
    ...
    ['Les commandes et les alarmes d’un ventilateur pneumatique peuvent dépendre de l’électronique.', 'La force motrice gazeuse subsiste alors que le pilotage et la surveillance sont hors service.'],
    ['Le réseau d’antipollution évacue les gaz excédentaires sans produire de volume courant.', 'Sa fonction se limite à recueillir les effluents dirigés hors du circuit respiratoire.'],
    ['L’asservissement du protoxyde borne la composition du mélange mais ne ventile pas.', 'Cette sécurité agit sur les proportions gazeuses et laisse entière la question du volume délivré.'],
  ]),
  ...
  manualQcm('Quels dispositifs empêchent concrètement de raccorder le mauvais gaz ?', ['b00026','b00027','b00032','b00034'], 'La prévention repose sur des incompatibilités géométriques : DISS/NIST pour les canalisations et pin index pour les bouteilles.', 'B', [
    ['Un raccord DISS peut être adapté à une autre canalisation à l’aide d’un joint.', 'Le diamètre et le filetage sont spécifiques du gaz et interdisent tout montage intermédiaire.'],
  ...
  manualQcm('Un hôpital utilise un stockage d’oxygène liquide : quels repères techniques sont exacts ?', ['b00018','b00025','b00026'], 'Le stockage cryogénique combine fort rendement volumique, réservoir isolé, évaporation puis double abaissement de pression avant distribution.', 'A', [
    ...
    ['Un seul abaissement de pression conduit l’oxygène du réservoir à la canalisation.', 'L’évaporateur ramène d’abord la pression à 1 000 kPa, puis un second étage la fixe à 350 kPa.'],
  ...
  manualQcm('Comment interpréter le manomètre d’une bouteille d’oxygène comprimé ?', ['b00034','b00042','b00191'], 'L’oxygène est gazeux à température ambiante : à température stable, sa pression décroît avec le volume et permet d’estimer l’autonomie.', 'A', [
    ...
    ['Une pesée reste indispensable pour connaître le contenu d’une bouteille de ce gaz.', 'Le manomètre fournit déjà une estimation fiable lorsque la température reste comparable.'],
    ...
    ['Le contenu se lit sur le manomètre indépendamment de la température ambiante.', 'La relation pression-volume est valable à température constante, ce qui impose une lecture comparable.'],
  ]),
  manualQcm('Une bouteille de protoxyde contient encore du liquide : quelles méthodes ou conclusions sont valides ?', ['b00034','b00043','b00044','b00048'], 'La pression traduit la vapeur saturante tant que persiste le liquide ; la masse suit la consommation et devient l’indicateur utile.', 'BCE', [
    ...
    ['La température critique de 36,5 °C autorise une phase liquide aux températures du bloc.', 'Une bouteille pleine renferme donc du protoxyde liquide surmonté de sa propre vapeur.'],
  ]),
  manualQcm('La phase liquide du protoxyde vient de disparaître : quels calculs deviennent pertinents ?', ['b00043','b00044','b00045','b00047','b00048'], 'Après le plateau liquidien, pression et volume redeviennent liés ; environ 235 L subsistent, donnant près de quatre heures à 1 L/min.', 'B', [
    ...
    ['La pression décroît désormais avec chaque litre prélevé dans la bouteille.', 'Le contenu entièrement gazeux suit la relation pression-volume à température stable.'],
    ['La pesée devient la seule méthode utilisable à ce stade.', 'Le contenu étant devenu monophasique, le manomètre redevient directement exploitable.'],
    ['Le volume résiduel dépasse le millier de litres à la pression atmosphérique.', 'Le calcul aboutit à environ 235 litres, soit à peine 16 % de la capacité initiale.'],
    ['L’autonomie théorique dépasse une dizaine d’heures à un litre par minute.', 'Deux cent trente-cinq minutes représentent un peu moins de quatre heures de réserve.'],
  ]),
  manualQcm('Pourquoi oxygène et protoxyde ne se lisent-ils pas de la même façon en bouteille ?', ['b00034','b00042','b00043','b00191'], 'La température critique détermine la phase : oxygène gazeux avec pression informative, protoxyde liquide avec plateau de vapeur.', 'ABCDE', [
    ['Les deux manomètres mesurent une pression par le même principe mécanique.', 'C’est la phase du contenu, et non l’instrument, qui change l’interprétation du chiffre lu.'],
    ...
    ['L’évaporation du liquide restant remplace la vapeur consommée après l’ouverture.', 'Cet équilibre entretient un plateau tant que subsiste une phase liquide dans l’enceinte.'],
  ...
  manualQcm('Une chute de pression d’oxygène est détectée : quelle réponse automatique protège du mélange hypoxique ?', ['b00060','b00061','b00064','b00065','b00066'], 'La pression d’oxygène pilote la fermeture du protoxyde et une alarme rapide ; cette barrière agit avant la désaturation.', 'BE', [
    ...
    ['Une alarme de défaut d’oxygène retentit dans les cinq secondes suivant la chute.', 'Ce délai très court signale le franchissement du seuil avant toute désaturation mesurable.'],
  ]),
  ...
  manualQcm('Une fuite apparaît sur le bloc débitmètres : quelles barrières limitent un mélange pauvre en oxygène ?', ['b00075','b00078','b00079'], 'L’oxygène placé en dernier réduit certaines pertes, l’asservissement limite les proportions et l’analyseur aval détecte le résultat réel.', 'ABCDE', [
    ...
    ['Une alimentation correcte peut coexister avec une fuite située dans l’appareil.', 'Le raccord verre-métal du débitmètre constitue le point le plus fragile du poste.'],
    ['L’asservissement mécanique borne la proportion de protoxyde admise dans le mélange.', 'Le rapport de pignons entraîne le débit d’oxygène dès l’ouverture du protoxyde.'],
    ['Une fuite sur le tube de protoxyde peut refluer vers le réseau d’alimentation.', 'Cette rétropollution emprunte le circuit central de distribution des gaz médicaux.'],
  ]),
  manualQcm('Pourquoi l’oxygène est-il ajouté en dernier dans l’assemblage des débitmètres ?', ['b00075','b00078','b00079','b00193'], 'Placer l’oxygène près de la sortie protège contre certaines fuites en amont, mais une fuite de sa propre branche reste dangereuse.', 'CE', [
    ['Un débitmètre d’oxygène placé en tête de l’assemblage remplit ce rôle.', 'L’oxygène est justement ajouté en dernier, au plus près de la sortie commune.'],
    ...
    ['L’ordre des tubes et l’asservissement des débits répondent à des pannes distinctes.', 'Le premier limite l’effet d’une fuite en amont, le second borne la proportion réglable de protoxyde.'],
  ]),
  ...
  manualQcm('Quelles sécurités préviennent une administration imprévue de deux halogénés ?', ['b00084','b00095','b00096','b00102','b00105','b00106'], 'Remplissage spécifique et interverrouillage évitent les substitutions et l’ouverture simultanée ; la rétropression reste compensée séparément.', 'ABCDE', [
    ['L’ouverture simultanée de deux cuves rendrait la concentration délivrée imprévisible.', 'L’addition de deux agents distincts échapperait à toute calibration fiable.'],
    ...
    ['Un système à cassette n’intègre qu’un seul vaporisateur au circuit à la fois.', 'L’unicité physique de la cassette écarte matériellement l’emploi simultané de deux agents.'],
  ...
  manualQcm('Quelles fonctions du circuit dépassent le simple transport des gaz inspirés ?', ['b00109','b00139','b00182'], 'Le circuit doit éliminer le CO₂, conduire l’excédent vers l’antipollution et préserver autant que possible chaleur et humidité.', 'ABCD', [
    ['Il conserve autant que possible la chaleur et l’humidité des gaz.', 'La réinspiration de gaz déjà traités par le patient limite les pertes thermiques.'],
    ['Il prolonge les voies aériennes jusqu’à l’appareil d’anesthésie.', 'Cette continuité tubulaire achemine le mélange final préparé en amont.'],
    ...
    ['Il oriente l’excédent gazeux vers le système d’antipollution.', 'Les effluents quittent ainsi la salle sans exposer inutilement l’équipe.'],
  ...
  manualQcm('Pourquoi un Mapleson peut-il être choisi chez un petit enfant ?', ['b00121','b00132','b00133'], 'Sa légèreté et l’absence de valves réduisent la résistance, au prix de forts débits, de pollution et de pertes thermiques.', 'ABDE', [
    ...
    ['La disposition coaxiale du Bain conserve une partie de la chaleur des gaz frais.', 'Le tube interne est réchauffé par le flux expiré qui l’entoure dans la tubulure.'],
    ['Le circuit impose un espace mort supérieur à celui d’un cercle pédiatrique.', 'L’absence de valves et la légèreté du montage constituent justement ses atouts chez l’enfant.'],
    ['Le montage exige un débit de gaz frais élevé chez ce patient.', 'L’épuration du dioxyde de carbone repose entièrement sur ce renouvellement.'],
    ['L’absence de valve unidirectionnelle diminue le travail respiratoire imposé.', 'Le flux ne rencontre ni disque mobile ni bac de chaux sur son trajet.'],
  ]),
  manualQcm('Quelles pannes du Bain exposent respectivement à hypercapnie ou surpression ?', ['b00129','b00130','b00133'], 'Tube frais obstrué ou rompu : réinspiration de CO₂ ; échappement bloqué : accumulation de pression et barotraumatisme.', 'DE', [
    ['Une obstruction du tube interne provoque d’abord une chute des pressions d’insufflation.', 'Elle interrompt l’apport frais distal et se traduit par une réinspiration de dioxyde de carbone.'],
    ...
    ['Une rupture du segment proximal du tube frais expose à une réinspiration.', 'Les gaz neufs se perdent près de l’appareil et ne parviennent plus au patient.'],
  ]),
  manualQcm('Comment le circuit cercle autorise-t-il une forte réinspiration sans hypercapnie ?', ['b00134','b00135','b00139','b00142','b00143'], 'Les valves dirigent les gaz vers une chaux active ; le CO₂ retiré, chaleur et humidité peuvent être réutilisées.', 'ADE', [
    ...
    ['La capnographie reste nécessaire pour détecter une défaillance de l’épuration.', 'Une valve ou un bac défaillant restaure une réinspiration dangereuse de dioxyde de carbone.'],
  ...
  manualQcm('Comment une valve unidirectionnelle incompétente perturbe-t-elle le cercle ?', ['b00134','b00135','b00142','b00143'], 'Le reflux court-circuite l’absorbeur, remet du CO₂ dans la branche inspiratoire et expose à une hypercapnie.', 'ABCDE', [
    ['Elle ouvre un trajet de retour qui évite le compartiment absorbant.', 'Le gaz expiré rejoint la branche inspiratoire sans avoir traversé le bac.'],
    ...
    ['Elle concerne le circuit à basse pression et non les canalisations murales.', 'Ces valves appartiennent au cercle placé entre l’appareil et les voies aériennes.'],
  ...
  manualQcm('Quels traits opposent un soufflet pneumatique à un piston électrique ?', ['b00148','b00149','b00151','b00156','b00157','b00158'], 'Le soufflet utilise un gaz moteur et peut intégrer le débit frais ; le piston est mû électriquement dans un circuit unique.', 'AC', [
    ...
    ['Le débit de gaz frais influence le volume délivré par un ventilateur pneumatique.', 'Le piston, lui, reste indépendant de cette contribution supplémentaire.'],
    ...
    questions: [
      ...
      },
      {
        ...
        items:[
          ...
          {lettre:'E',enonce:'Une fuite en aval peut appauvrir le mélange malgré une coupure fonctionnelle.',is_correct:true,justification:'La sécurité agit sur l’admission du protoxyde et n’explore pas la composition délivrée.'},
        ],
      },
      {
      ...
      },
      {
        ...
        items:[
          {lettre:'A',enonce:'Une chute régulière de pression signale forcément une fuite du circuit patient.',is_correct:false,justification:'Elle traduit d’abord la consommation normale du gaz stocké dans la bouteille.'},
          {lettre:'B',enonce:'La pression de la bouteille varie linéairement avec le contenu d’oxygène.',is_correct:true,justification:'Ce gaz reste monophasique aux températures usuelles du bloc opératoire.'},
    ...
    questions:[
      {
        ...
        items:[
          {lettre:'A',enonce:'Le tube externe ondulé conduit les gaz frais vers le patient.',is_correct:false,justification:'Dans le montage coaxial du Bain, le flux neuf circule par le tube interne.'},
      ...
      },
      {
        ...
        items:[
          ...
          {lettre:'C',enonce:'Le dioxyde de carbone expiré cesse d’être détecté par le capnographe.',is_correct:false,justification:'La réinspiration élève la ligne de base sans supprimer le plateau expiratoire.'},
          ...
          {lettre:'E',enonce:'La PaCO₂ de l’enfant peut s’élever si la situation se prolonge.',is_correct:true,justification:'L’accumulation de gaz carbonique réinspiré finit par dépasser les capacités d’élimination.'},
        ],
      },
      {
        ...
        items:[
          ...
          {lettre:'C',enonce:'L’ouverture complète de la valve garantit une insufflation manuelle efficace.',is_correct:false,justification:'Un échappement total empêche la mise en pression nécessaire au gonflement pulmonaire.'},
          {lettre:'D',enonce:'Le réglage de la valve doit être réévalué à chaque changement de mode ventilatoire.',is_correct:true,justification:'Le passage en mécanique confie la limitation de pression à une soupape interne distincte.'},
      ...
      },
      {
        ...
        correction_generale:'Une hypercapnie persistante malgré un débit théoriquement suffisant impose de vérifier le trajet des gaz frais, le débit réellement délivré et la ventilation minute prise pour référence.',
        items:[
          ...
          {lettre:'C',enonce:'Une ventilation minute réellement supérieure à celle prise pour référence.',is_correct:true,justification:'Un débit calculé sur une estimation trop basse ne représente plus deux fois et demie le besoin réel.'},
          ...
          {lettre:'E',enonce:'Un débitmètre défectueux délivrant moins que la valeur affichée.',is_correct:true,justification:'Le rinçage effectif reste insuffisant alors que la commande semble correcte.'},
        ],
      },
      {
        ...
        items:[
          ...
          {lettre:'B',enonce:'L’espace annulaire conserve du dioxyde de carbone faute d’apport frais distal.',is_correct:true,justification:'Le rinçage attendu à l’expiration ne se produit plus dans la tubulure ondulée.'},
          ...
          {lettre:'E',enonce:'L’obstruction réduit le renouvellement global sans enrichir le mélange en oxygène.',is_correct:true,justification:'Aucun tri sélectif n’accompagne la perte de débit imposée par l’obstacle.'},
        ],
      },
      {
      ...
      },
      {
        ...
        items:[
          ...
          {lettre:'B',enonce:'Une charge accrue pour le système d’évacuation des gaz.',is_correct:true,justification:'Le volume excédentaire dirigé vers l’antipollution croît avec le débit choisi.'},
          ...
          {lettre:'D',enonce:'Un maintien du fonctionnement semi-ouvert malgré la respiration spontanée.',is_correct:true,justification:'L’absence d’absorbeur impose ce régime tant que le circuit reste en place.'},
    ...
    questions:[
      {
        ...
        items:[
          ...
          {lettre:'B',enonce:'Un débit frais élevé contribue à chasser une partie des gaz expirés.',is_correct:true,justification:'Dans un cercle semi-fermé, la poussée expiratoire complète l’action chimique de l’absorbant.'},
          ...
          {lettre:'E',enonce:'L’eau présente dans l’absorbant conditionne la neutralisation du dioxyde de carbone.',is_correct:true,justification:'L’acide carbonique se forme d’abord au contact de l’eau avant de réagir avec les bases.'},
        ],
      },
      {
        ...
        items:[
          ...
          {lettre:'B',enonce:'Un bac tiède signale une chaux dont la capacité reste entièrement disponible.',is_correct:false,justification:'Le dégagement de chaleur accompagne la neutralisation mais ne mesure pas la réserve restante.'},
          ...
          {lettre:'E',enonce:'Une capnographie montrant du CO₂ inspiré complète utilement ces constatations.',is_correct:true,justification:'Le retour de dioxyde de carbone à l’inspiration confirme la perte d’efficacité du bac.'},
        ],
      },
      {
        ...
        items:[
          {lettre:'A',enonce:'Remplacer immédiatement le bac par un modèle de plus grande capacité.',is_correct:false,justification:'Un absorbant neuf vient d’être installé ; le défaut se situe ailleurs sur le trajet.'},
      ...
      },
      {
        ...
        items:[
          ...
          {lettre:'B',enonce:'Le trajet circulaire perd le sens unique que les valves devaient garantir.',is_correct:true,justification:'Les deux branches communiquent alors que leur séparation conditionne l’épuration.'},
      ...
      },
      {
        ...
        items:[
          ...
          {lettre:'B',enonce:'Le haut débit masque partiellement la réinspiration sans réparer la valve.',is_correct:true,justification:'Le remplacement matériel reste indispensable pour rétablir le sens unique du cercle.'},
          ...
          {lettre:'E',enonce:'Les pertes de chaleur et d’humidité augmentent pendant cette phase.',is_correct:true,justification:'Le mélange neuf sec remplace des gaz déjà conditionnés par les voies aériennes.'},
        ],
      },
      {
        ...
        items:[
          ...
          {lettre:'E',enonce:'Un absorbant pauvre en bases fortes limite la formation de ces produits.',is_correct:true,justification:'Le retrait du KOH et du NaOH supprime les catalyseurs impliqués dans ces dégradations.'},
        ],
      },
      {
        ...
        items:[
          {lettre:'A',enonce:'Espacer la capnographie puisque la boucle automatique contrôle déjà la fraction expirée.',is_correct:false,justification:'La rétroaction règle l’agent volatil et ne surveille pas le dioxyde de carbone réinspiré.'},
    ...
    questions:[
      {
        ...
        items:[
          ...
          {lettre:'E',enonce:'Une surveillance des pressions d’insufflation s’impose chez ce patient.',is_correct:true,justification:'Le suivi des valeurs de crête et de plateau permet de détecter une contrainte excessive.'},
        ],
      },
      {
        ...
        items:[
          ...
          {lettre:'D',enonce:'La limite de pression choisie explique à elle seule la baisse observée.',is_correct:true,justification:'Le mode impose un plafond d’insufflation sans renseigner sur la mécanique respiratoire.'},
      ...
      },
      {
        ...
        items:[
          ...
          {lettre:'C',enonce:'Adapter le niveau de pression cycle après cycle selon la mécanique mesurée.',is_correct:true,justification:'L’appareil réévalue l’insufflation nécessaire à partir du volume obtenu au cycle précédent.'},
          {lettre:'D',enonce:'Réduire le risque de barotraumatisme sans dispenser de surveiller les pressions.',is_correct:true,justification:'La limitation obtenue reste relative et impose de suivre les valeurs affichées.'},
      ...
      },
      {
        ...
        items:[
          ...
          {lettre:'D',enonce:'Un rapport inversé accentue le risque de rétention gazeuse.',is_correct:true,justification:'La phase expiratoire raccourcie devient le principal facteur limitant de la vidange.'},
          {lettre:'E',enonce:'Le débit inspiratoire de pointe modifie le rapport entre les deux phases.',is_correct:true,justification:'Une insufflation plus rapide libère du temps pour l’expiration et inversement.'},
        ],
      },
      {
        ...
        items:[
          ...
          {lettre:'C',enonce:'Le seuil de déclenchement peut être réglé en débit ou en pression.',is_correct:true,justification:'Ce réglage détermine la sensibilité avec laquelle l’appareil détecte l’effort du patient.'},
          ...
          {lettre:'E',enonce:'Le patient doit franchir le seuil avant de recevoir la pression d’assistance.',is_correct:true,justification:'L’appareil demeure en attente tant que l’effort ne dépasse pas la valeur programmée.'},
        ],
      },
    ],
  },
    ...
    questions:[
      ...
      },
      {
        ...
        items:[
          ...
          {lettre:'C',enonce:'Quand la cuve refroidit, le second bypass se referme progressivement.',is_correct:true,justification:'La fermeture dirige une part plus grande du gaz frais vers la chambre de vaporisation.'},
          {lettre:'D',enonce:'Le plénum classique fonctionne sans alimentation électrique.',is_correct:true,justification:'Sa compensation repose uniquement sur des éléments mécaniques sensibles à la température.'},
      ...
      },
      {
        ...
        items:[
          {lettre:'A',enonce:'Le point d’ébullition du desflurane dépasse celui du sévoflurane.',is_correct:false,justification:'Il se situe à 22,8 °C, très en dessous des 58,5 °C du sévoflurane.'},
          {lettre:'B',enonce:'Le chauffage de la cuve compense l’absence de clé de remplissage spécifique.',is_correct:false,justification:'Chaque agent conserve une clé normalisée, indépendante de la technologie de vaporisation.'},
          {lettre:'C',enonce:'La chaleur perçue correspond au fonctionnement normal de cette cuve.',is_correct:true,justification:'Le chauffage entretenu par l’alimentation électrique fait partie de sa conception.'},
          {lettre:'D',enonce:'Le dispositif sature passivement le gaz frais au contact du liquide.',is_correct:false,justification:'Ce léchage caractérise le plénum, alors que le desflurane est dosé par un mélangeur mesuré.'},
          {lettre:'E',enonce:'Le remplissage reste réservé au desflurane par une clé spécifique.',is_correct:true,justification:'L’étalonnage du dispositif interdit d’y introduire un autre agent volatil.'},
        ],
      },
      {
        ...
        items:[
          {lettre:'A',enonce:'La pression de vapeur saturante du sévoflurane diminue avec la pression atmosphérique.',is_correct:false,justification:'Cette propriété varie avec la température du liquide, jamais avec la pression ambiante.'},
          {lettre:'B',enonce:'Le plénum délivre un pourcentage plus faible lorsque l’altitude augmente.',is_correct:false,justification:'La même pression de vapeur représente une fraction plus grande d’une pression totale réduite.'},
          ...
          {lettre:'D',enonce:'Le mélangeur de desflurane conserve le pourcentage programmé en altitude.',is_correct:true,justification:'Sa chambre pressurisée et thermostatée reste insensible à la pression ambiante.'},
          {lettre:'E',enonce:'Le réglage du mélangeur doit être abaissé pour compenser l’altitude.',is_correct:false,justification:'La pression partielle délivrée diminue en altitude et impose plutôt d’augmenter le pourcentage.'},
        ],
      },
      {
        ...
        items:[
          ...
          {lettre:'C',enonce:'L’enclenchement et les clés de remplissage préviennent deux erreurs différentes.',is_correct:true,justification:'L’un interdit l’usage simultané des cuves, l’autre empêche d’y verser un mauvais liquide.'},
      ...
      },
      {
        ...
        items:[
          {lettre:'A',enonce:'La fraction expirée reflète instantanément la concentration cérébrale, sans délai d’équilibre.',is_correct:false,justification:'L’estimation devient fidèle après le temps nécessaire à la diffusion des molécules.'},
          ...
          {lettre:'D',enonce:'L’analyse continue de l’oxygène et des agents reste la condition du très bas débit.',is_correct:true,justification:'Le faible renouvellement rend la composition du cercle imprévisible sans mesure directe.'},
    ...
    questions:[
      {
        ...
        items:[
          ...
          {lettre:'B',enonce:'Une alarme de volume ou de pression complète l’inspection visuelle du soufflet.',is_correct:true,justification:'Les capteurs de l’appareil détectent une perte que le mouvement mécanique ne trahit pas.'},
          ...
          {lettre:'E',enonce:'Le modèle ascendant se vide immédiatement et signale mieux la déconnexion.',is_correct:true,justification:'Sa course dépend du retour gazeux, absent dès que le circuit s’ouvre.'},
        ],
      },
      {
        ...
        items:[
          ...
          {lettre:'C',enonce:'Une saturation encore normale ne prouve pas que la ventilation est assurée.',is_correct:true,justification:'Le réservoir d’oxygène retarde la désaturation de plusieurs minutes après l’arrêt des échanges.'},
      ...
      },
      {
        ...
        items:[
          ...
          {lettre:'E',enonce:'Un modèle descendant poursuivrait sa course sous l’effet de son propre poids.',is_correct:true,justification:'Cette persistance masquerait la déconnexion et retarderait la reconnaissance de la fuite.'},
        ],
      },
      {
      ...
      },
      {
        ...
        items:[
          ...
          {lettre:'B',enonce:'Le gaz emmagasiné par la dilatation est restitué lors de la baisse de pression.',is_correct:true,justification:'Il demeure à l’intérieur du montage sans rejoindre l’atmosphère de la salle.'},
          ...
          {lettre:'E',enonce:'L’effet relatif de la compliance grandit lorsque le volume courant est petit.',is_correct:true,justification:'Une même quantité retenue pèse davantage sur un volume pédiatrique que sur un volume adulte.'},
        ],
      },
      {
        ...
        items:[
          ...
          {lettre:'C',enonce:'L’oxygène de la bouteille n’est plus consommé par la motorisation.',is_correct:true,justification:'L’énergie provient du secteur électrique et non d’une détente gazeuse.'},
          ...
          {lettre:'E',enonce:'Les alarmes de déconnexion restent nécessaires avec une motorisation électrique.',is_correct:true,justification:'Une fuite côté patient demeure possible quelle que soit la technologie du ventilateur.'},
        ],
      },
      {
        ...
        items:[
          ...
          {lettre:'D',enonce:'Un mode à volume garanti impose la pression maximale autorisée à chaque cycle.',is_correct:false,justification:'L’algorithme recherche la pression la plus basse compatible avec le volume cible.'},
          {lettre:'E',enonce:'L’identification de la cause précède toute majoration de la pression cible.',is_correct:true,justification:'Un obstacle bronchique, un pneumothorax ou une intubation sélective appellent des traitements différents.'},
        ],
      },
    ],
  },
    ...
    questions:[
      {
        ...
        items:[
          {lettre:'A',enonce:'Filtrer chimiquement les halogénés avant leur rejet dans l’atmosphère.',is_correct:false,justification:'Le système décrit conduit les effluents vers l’aspiration centrale sans les traiter.'},
          ...
          {lettre:'C',enonce:'Recevoir uniquement les gaz déjà sortis du circuit respiratoire.',is_correct:true,justification:'L’interface se situe en aval de la valve d’échappement et du trop-plein.'},
      ...
      },
      {
        ...
        items:[
          ...
          {lettre:'B',enonce:'Le réservoir témoin doit être maintenu complètement vide en permanence.',is_correct:false,justification:'Son rôle de tampon suppose la présence d’un volume gazeux disponible.'},
          ...
          {lettre:'E',enonce:'Le réglage de la force aspiratoire doit être adapté à l’interface utilisée.',is_correct:true,justification:'Une dépression excessive dépasse la capacité d’équilibrage prévue par le constructeur.'},
        ],
      },
      {
      ...
      },
      {
        ...
        items:[
          ...
          {lettre:'E',enonce:'Les deux conduites doivent rester acheminées parallèlement jusqu’au réseau central.',is_correct:true,justification:'Leur séparation physique protège l’installation et stabilise chaque prélèvement.'},
        ],
      },
      {
        ...
        items:[
          ...
          {lettre:'B',enonce:'Le ballon témoin se rétracte lorsque l’évacuation devient insuffisante.',is_correct:false,justification:'Un défaut de vidange le distend au lieu de l’affaisser.'},
          ...
          {lettre:'D',enonce:'L’accumulation siège dans le circuit d’évacuation et non dans le cercle.',is_correct:true,justification:'Le réservoir d’antipollution est situé en dehors du trajet respiratoire du patient.'},
          {lettre:'E',enonce:'Un système actif exige un débit d’aspiration suffisant pour évacuer les effluents.',is_correct:true,justification:'Sans transport, les gaz recueillis stagnent puis se dispersent dans la salle.'},
        ],
      },
      {
        ...
        items:[
          ...
          {lettre:'D',enonce:'Des volumes excédentaires subsistent et doivent encore être captés.',is_correct:true,justification:'Le cercle rejette toujours une part du mélange par la valve de trop-plein.'},
          {lettre:'E',enonce:'La surveillance continue des concentrations accompagne obligatoirement ce pilotage.',is_correct:true,justification:'La boucle calcule ses corrections à partir de ces mesures et ne saurait les remplacer.'},
        ],
      },
      {
    ...
    questions:[
      {
        ...
        items:[
          ...
          {lettre:'C',enonce:'La relation linéaire entre pression et contenu ne s’installe qu’après le plateau.',is_correct:true,justification:'Elle suppose une phase gazeuse unique, obtenue seulement quand le liquide a disparu.'},
          ...
          {lettre:'E',enonce:'La pesée reste le moyen d’estimer le contenu pendant la phase biphasique.',is_correct:true,justification:'La masse diminue régulièrement alors que le manomètre demeure sur son plateau.'},
        ],
      },
      {
        ...
        items:[
          ...
          {lettre:'B',enonce:'Les deux mesures explorent des propriétés physiques différentes.',is_correct:true,justification:'La pesée suit la quantité totale tandis que le manomètre traduit la vapeur en équilibre.'},
          ...
          {lettre:'D',enonce:'Le poids de la bouteille reste stable tant que la phase liquide persiste.',is_correct:false,justification:'La pesée traduit précisément la consommation que le manomètre ne montre pas encore.'},
      ...
      },
      {
        ...
        items:[
          {lettre:'A',enonce:'La phase biphasique se poursuit alors que la pression commence à décroître.',is_correct:false,justification:'La chute de pression signe justement la disparition complète du liquide.'},
          ...
          {lettre:'D',enonce:'Une réserve gazeuse mesurable subsiste malgré cette baisse de pression.',is_correct:true,justification:'Environ 235 litres restent disponibles au moment où le liquide vient de disparaître.'},
          {lettre:'E',enonce:'La pression continuera de décroître avec chaque prélèvement supplémentaire.',is_correct:true,justification:'Plus aucun liquide ne peut entretenir la vapeur consommée par le patient.'},
        ],
      },
      {
        ...
        items:[
          {lettre:'A',enonce:'L’autonomie théorique atteint 1 590 minutes à ce débit.',is_correct:false,justification:'Ce chiffre correspond au contenu d’une bouteille pleine, non à la réserve résiduelle.'},
          ...
          {lettre:'D',enonce:'La réserve représente environ 16 % du contenu d’une bouteille pleine.',is_correct:true,justification:'Le rapport entre 235 L et la capacité pleine de 1 590 L donne ce pourcentage.'},
      ...
      },
      {
        ...
        items:[
          {lettre:'A',enonce:'La température critique de ce gaz exclut toute phase liquide dans la bouteille.',is_correct:true,justification:'Sa valeur de −113 °C reste très éloignée des conditions rencontrées au bloc opératoire.'},
          {lettre:'B',enonce:'La pression interne dépend surtout de la pression de vapeur du contenu.',is_correct:false,justification:'Ce comportement caractérise le protoxyde liquéfié, et non un gaz resté monophasique.'},
          ...
          {lettre:'D',enonce:'L’absence de plateau de pression distingue ce gaz du protoxyde d’azote.',is_correct:true,justification:'Le protoxyde conserve une vapeur saturante constante tant que du liquide subsiste.'},
          {lettre:'E',enonce:'Le suivi du manomètre dispense de peser la bouteille pour ce gaz.',is_correct:true,justification:'La relation linéaire entre pression et contenu fournit déjà l’information recherchée.'},
        ],
      },
      {
        ...
        items:[
          ...
          {lettre:'C',enonce:'Le détendeur de bouteille se règle sur la valeur exacte de la canalisation.',is_correct:false,justification:'Un écart volontaire est ménagé pour que la canalisation reste prioritaire.'},
      ...
      },
      {
        ...
        items:[
          ...
          {lettre:'D',enonce:'Elle est placée à la sortie des bouteilles et sur les canaux du réseau.',is_correct:true,justification:'Une soupape est insérée sur chaque ligne pour éviter fuites et reflux entre sources.'},
          {lettre:'E',enonce:'Elle agit sur le sens du flot sans en régler la valeur de pression.',is_correct:true,justification:'L’abaissement de pression relève du détendeur placé sur la même ligne.'},
        ],
      },
    ],
  },
