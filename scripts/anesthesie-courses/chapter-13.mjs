...
const QCM_SERIES = [
  {
    label: 'QCM — Série 1 · Organisation autonome', allowed_voies: ['interne'], questions: [
      qcm('Quelles propriétés décrivent l’organisation générale d’une voie autonome ?', src('b00005', 'b00006'), 'Une voie autonome efférente relie le SNC à un effecteur viscéral par un relais ganglionnaire entre deux neurones.', [
        ...
        [false, 'La synapse entre les deux neurones autonomes se situe dans la corne latérale de la moelle.', 'Le relais s’effectue dans un ganglion périphérique, en dehors du névraxe.'],
      ...
      qcm('À propos de la médullosurrénale, quelles affirmations sont exactes ?', src('b00021', 'b00024', 'b00025'), 'La médullosurrénale se comporte comme un relais sympathique modifié qui transforme une stimulation cholinergique en sécrétion endocrine de catécholamines.', [
        [false, 'Ses cellules chromaffines sont innervées par des fibres postganglionnaires noradrénergiques.', 'Le splanchnique lui apporte une commande préganglionnaire cholinergique.'],
      ...
      qcm('Quelles données distinguent la division parasympathique ?', src('b00027'), 'Le parasympathique craniosacré possède de longues fibres préganglionnaires et des ganglions juxtaviscéraux, ce qui rend son action ciblée.', [
        ...
        [false, 'Ses fibres préganglionnaires sont plus courtes que celles du système sympathique.', 'Le relais juxtaviscéral impose un très long trajet avant la synapse.'],
      ...
      qcm('Quelles associations entre nerf crânien et territoire parasympathique sont correctes ?', src('b00027'), 'Les voies crâniennes distribuent une commande ciblée aux yeux, aux glandes et à de nombreux viscères thoracoabdominaux.', [
        ...
        [false, 'Le nerf VII assure l’innervation parasympathique du cœur.', 'Cette commande cardiaque appartient au nerf vague.'],
  ...
  },
  {
    label: 'QCM — Série 2 · Neurotransmetteurs', allowed_voies: ['interne'], questions: [
      qcm('Quelles étapes appartiennent à la biosynthèse de la noradrénaline ?', src('b00031'), 'La tyrosine devient successivement DOPA, dopamine puis noradrénaline, avec une compartimentation vésiculaire de la dernière étape.', [
        [false, 'L’étape limitante de la voie est assurée par la DOPA décarboxylase.', 'La tyrosine hydroxylase contrôle le débit de la voie catécholaminergique.'],
      ...
      qcm('Quels mécanismes encadrent la libération de noradrénaline ?', src('b00031', 'b00032', 'b00033'), 'La stimulation augmente la synthèse et déclenche une exocytose calcique, puis la recapture présynaptique termine l’essentiel du signal.', [
        [true, 'Une libération basale de noradrénaline existe déjà au repos.', 'Ce tonus permanent assure les fonctions de l’organisme hors stimulation.'],
        [false, 'La fusion vésiculaire est déclenchée par l’entrée de sodium dans la terminaison.', 'Le calcium est l’ion qui commande la fusion des vésicules à la membrane.'],
        [false, 'La totalité du neurotransmetteur diffuse dans le sang.', 'Seule une faible fraction échappe à la synapse.'],
        [false, 'La COMT dégrade environ 95 % de la noradrénaline présente dans la fente.', 'La recapture présynaptique assure l’essentiel de l’arrêt du signal.'],
      ...
      qcm('Quelles propositions décrivent la terminaison cholinergique ?', src('b00039', 'b00040', 'b00041'), 'L’acétylcholine est synthétisée à partir de choline et d’acétyl-CoA, stockée en vésicules puis hydrolysée très rapidement.', [
        ...
        [false, 'L’acétylcholine est synthétisée directement à l’intérieur des vésicules synaptiques.', 'Le cytoplasme est le lieu de synthèse, la vésicule celui du stockage.'],
      ...
      qcm('Quelles voies autonomes sont cholinergiques ?', src('b00029', 'b00040', 'b00051'), 'Toutes les fibres préganglionnaires et les fibres postganglionnaires parasympathiques libèrent de l’acétylcholine ; certaines fibres sympathiques font exception au modèle noradrénergique.', [
        ...
        [true, 'La commande splanchnique de la médullosurrénale.', 'Ces axones préganglionnaires libèrent l’acétylcholine sur les cellules chromaffines.'],
      ...
      qcm('Quelles affirmations sur la cotransmission autonome sont justes ?', src('b00034', 'b00037', 'b00040'), 'Un neurotransmetteur classique peut partager sa terminaison avec un peptide ou l’ATP, lesquels modulent l’intensité et la durée de la réponse.', [
        ...
        [true, 'Des substances circulantes ou endothéliales peuvent moduler la libération sympathique.', 'Elles agissent sur des récepteurs présynaptiques qui freinent ou renforcent l’émission du médiateur.'],
  ...
  },
  {
    label: 'QCM — Série 3 · Récepteurs et organes', allowed_voies: ['interne'], questions: [
      qcm('Quels effets relèvent principalement d’un récepteur α1 ?', src('b00043', 'b00049'), 'L’activation α1 contracte de nombreux muscles lisses, augmente le tonus vasculaire et produit une mydriase radiaire.', [
        [false, 'La dilatation des artérioles du muscle squelettique.', 'Ce territoire se relâche sous l’effet des récepteurs β2.'],
      ...
      qcm('Quelles réponses sont compatibles avec une activation β2 ?', src('b00043'), 'β2 relâche plusieurs muscles lisses et peut modifier la perfusion, la ventilation et le métabolisme.', [
        ...
        [false, 'Une augmentation de la sécrétion salivaire par action glandulaire directe.', 'La sécrétion salivaire dépend surtout des récepteurs muscariniques M3.'],
      ...
      qcm('Quels rôles peut-on attribuer aux récepteurs cholinergiques autonomes ?', src('b00051'), 'Le nicotinique transmet le signal au ganglion, tandis que les muscariniques assurent l’essentiel de la réponse viscérale parasympathique.', [
        ...
        [true, 'Le sous-type M1 est largement représenté dans le système nerveux central.', 'Plusieurs sous-types cérébraux y sont décrits, M1 au premier plan.'],
      ]),
  ...
  },
  {
    label: 'QCM — Série 4 · Réflexes autonomes', allowed_voies: ['interne'], questions: [
      qcm('Quelles étapes composent la réponse à une élévation de pression artérielle ?', src('b00067', 'b00068', 'b00071'), 'L’étirement des barorécepteurs active les afférences IX-X, réduit le tonus sympathique et augmente le frein vagal.', [
        ...
        [true, 'Le centre vasoconstricteur bulbaire est inhibé.', 'Son retrait diminue les résistances artérielles périphériques.'],
        ...
        [true, 'Une vasodilatation diffuse accompagne le retrait du tonus sympathique.', 'La perte du tonus vasoconstricteur relâche le lit artériel.'],
      ]),
      ...
      qcm('Quelles caractéristiques définissent le réflexe de Bezold-Jarisch ?', src('b00078'), 'Une stimulation ventriculaire gauche déclenche une réponse cardio-inhibitrice associant hypotension, bradycardie et vasodilatation coronaire.', [
        ...
        [false, 'L’arc naît de mécanorécepteurs de l’oreillette droite.', 'Cette origine atriale correspond au réflexe de Bainbridge.'],
      ...
      qcm('Quelles propositions décrivent le réflexe oculocardiaque ?', src('b00082'), 'La traction oculaire emprunte une afférence trigéminale et déclenche une réponse parasympathique pouvant causer une bradycardie profonde.', [
        ...
        [true, 'L’efférence emprunte le nerf vague jusqu’au nœud sinusal.', 'Le tonus parasympathique cardiaque augmente et ralentit brutalement le rythme.'],
      ...
      qcm('Que peut-on observer au cours d’une manœuvre de Valsalva ?', src('b00084'), 'La contrainte diminue le retour veineux et active le sympathique ; la libération entraîne un rebond pressif puis un frein parasympathique.', [
        ...
        [false, 'La pression veineuse centrale diminue pendant la contrainte.', 'La compression thoracique fait monter la pression veineuse centrale.'],
...

  {
    label: 'QCM — Série 5 · Vasopresseurs', allowed_voies: ['interne'], questions: [
      qcm('Quelles propriétés pharmacodynamiques caractérisent l’adrénaline ?', src('b00094', 'b00099'), 'L’adrénaline active les récepteurs α et β, stimule le cœur, contracte certains vaisseaux et dilate les bronches.', [
        ...
        [false, 'Son effet chronotrope passe par les récepteurs β2 du nœud sinusal.', 'Le nœud sinusal est accéléré par la voie β1 cardiaque.'],
      ...
      qcm('Quelles réponses hémodynamiques sont attendues sous noradrénaline ?', src('b00101'), 'Le profil α dominant élève les résistances et les deux composantes de pression, tandis que le baroréflexe peut ralentir le cœur.', [
        ...
        [true, 'Une augmentation de la contractilité par stimulation β1.', 'Son activité β1 renforce la force de contraction myocardique.'],
      ...
      qcm('Quels éléments doivent être anticipés avec l’éphédrine ?', src('b00103'), 'L’éphédrine augmente pression et activité cardiaque par des actions directes et par libération de noradrénaline, avec tachyphylaxie aux répétitions.', [
        ...
        [true, 'Une action à la fois directe et indirecte sur la transmission adrénergique.', 'Elle stimule les récepteurs et mobilise aussi la noradrénaline stockée.'],
      ...
      qcm('À propos de la phényléphrine, quelles affirmations sont justes ?', src('b00105'), 'La phényléphrine est un agoniste α1 pur : sa vasoconstriction augmente la pression mais peut ralentir le cœur et diminuer le débit.', [
        ...
        [true, 'Son agonisme reste sélectif des récepteurs α1.', 'Sa sélectivité pour ce sous-type explique un effet purement vasculaire.'],
      ...
      qcm('Quelles comparaisons entre adrénaline, noradrénaline et phényléphrine sont correctes ?', src('b00094', 'b00099', 'b00101', 'b00105'), 'Le choix dépend du besoin de stimulation cardiaque, de vasoconstriction et du risque de réflexe barorécepteur.', [
        ...
        [true, 'L’adrénaline peut abaisser la pression diastolique par sa composante β2.', 'La vasodilatation musculaire réduit les résistances pendant la diastole.'],
  ...
  },
  {
    label: 'QCM — Série 6 · Inotropes et agonistes α2', allowed_voies: ['interne'], questions: [
      qcm('Quelles données orientent vers la dobutamine ?', src('b00107'), 'La dobutamine soutient un débit insuffisant par agonisme β1, au prix possible d’une vasodilatation et d’une hypotension.', [
        ...
        [true, 'Une redistribution des débits régionaux par faible activité β2.', 'Le territoire musculaire peut être privilégié par cette composante vasodilatatrice.'],
      ...
      qcm('Quelles propositions concernant la dopamine sont exactes ?', src('b00109'), 'La dopamine change de profil avec la dose et n’occupe plus une place routinière en réanimation.', [
        ...
        [true, 'Son emploi de routine en réanimation a été abandonné.', 'Les unités de soins intensifs lui préfèrent aujourd’hui d’autres agents.'],
        [true, 'Elle figure comme second choix dans la bradycardie résistante à l’atropine.', 'L’algorithme la place après l’échec de l’antimuscarinique.'],
      ]),
      qcm('Quels effets sont cohérents avec un agonisme α2 central ?', src('b00111', 'b00113'), 'Clonidine et dexmédétomidine diminuent la transmission noradrénergique centrale, produisant sédation, analgésie et parfois brady-hypotension.', [
        ...
        [true, 'Une action antihypertensive en situation d’urgence.', 'La clonidine est administrée comme antihypertenseur dans certaines urgences.'],
      ...
      qcm('Quelles caractéristiques appartiennent à l’isoprotérénol ?', src('b00115'), 'L’isoprotérénol active β1 et β2, accélère nettement le cœur et réduit les résistances, ce qui impose une perfusion.', [
        [false, 'Sa longue demi-vie autorise une administration orale espacée.', 'Sa durée d’action très brève impose une perfusion continue.'],
  ...
  },
  {
    label: 'QCM — Série 7 · Bronches, phosphodiestérases et bêtabloquants', allowed_voies: ['interne'], questions: [
      qcm('Quelles affirmations décrivent le salbutamol ?', src('b00116', 'b00117', 'b00118', 'b00119'), 'Le salbutamol est un agoniste β2 préférentiel bronchodilatateur, dont les fortes doses exposent à des effets musculaires et digestifs.', [
        ...
        [true, 'La voie intraveineuse est également possible.', 'L’administration systémique est décrite à côté de l’inhalation.'],
        [true, 'Un tremblement musculaire peut apparaître à forte dose.', 'La stimulation β2 du muscle squelettique explique cet effet.'],
        [true, 'Il ralentit le péristaltisme intestinal.', 'Le transit digestif est freiné par la stimulation β2.'],
      ...
      qcm('Que provoque l’inhibition des phosphodiestérases décrites dans ce chapitre ?', src('b00120', 'b00121', 'b00123', 'b00125'), 'En empêchant la dégradation de l’AMPc, ces agents renforcent la contraction cardiaque et peuvent relâcher le muscle lisse vasculaire.', [
        ...
        [true, 'Une efficacité particulière chez le patient à tonus sympathique élevé.', 'L’insuffisance cardiaque, avec son tonus adrénergique fort, en est l’exemple.'],
        [true, 'Un effet inotrope positif avec l’enoximone.', 'La force de contraction augmente nettement.'],
        [true, 'Une vasodilatation périphérique associée à l’effet inotrope.', 'L’enoximone relâche le lit vasculaire en même temps qu’elle stimule le cœur.'],
      ]),
      qcm('Quelles propriétés caractérisent la milrinone ?', src('b00125'), 'La milrinone est un inodilatateur employé dans l’insuffisance cardiaque aiguë, notamment lorsque le lit pulmonaire et la charge ventriculaire doivent être réduits.', [
        ...
        [true, 'Elle est employée dans l’insuffisance cardiaque aiguë.', 'Cette indication aiguë correspond à son usage clinique décrit.'],
      ...
      qcm('Quels effets résultent d’un bêtablocage β1 cardiosélectif ?', src('b00127', 'b00128'), 'Aténolol et métoprolol diminuent le travail cardiaque et la consommation d’oxygène tout en allongeant la diastole.', [
        ...
        [false, 'Une augmentation de la consommation myocardique en oxygène.', 'Le moindre travail cardiaque abaisse la demande en oxygène du myocarde.'],
      ...
      qcm('Quelles particularités rendent l’esmolol adapté à un contrôle rapide ?', src('b00129', 'b00130'), 'Son administration intraveineuse et son hydrolyse érythrocytaire donnent à l’esmolol un effet bref et rapidement titrable.', [
        ...
        [false, 'Son antagonisme concerne autant les récepteurs α que les récepteurs β.', 'L’esmolol est décrit comme un antagoniste cardiosélectif β1.'],
      ]),
    ],
  },
  {
    label: 'QCM — Série 8 · Cholinergiques et antimuscariniques', allowed_voies: ['interne'], questions: [
      qcm('Quels effets accompagnent l’inhibition de l’acétylcholinestérase ?', src('b00137', 'b00138'), 'L’acétylcholine s’accumule aux synapses, renforçant la transmission neuromusculaire mais aussi les manifestations muscariniques.', [
        ...
        [false, 'Un blocage compétitif des récepteurs muscariniques.', 'Ces agents augmentent la stimulation muscarinique en préservant l’acétylcholine.'],
        [true, 'Une accumulation d’acétylcholine dans la fente synaptique.', 'L’enzyme qui l’hydrolyse est inhibée, ce qui prolonge sa présence.'],
        [false, 'Un relâchement du muscle lisse bronchique.', 'L’excès cholinergique contracte le muscle lisse des voies aériennes.'],
        [false, 'Une rétention urinaire par relâchement du détrusor.', 'Le détrusor est stimulé par l’acétylcholine et favorise la miction.'],
      ]),
      qcm('Quelles caractéristiques distinguent la néostigmine ?', src('b00139', 'b00140'), 'La néostigmine carbamyle réversiblement l’enzyme, agit environ une heure et ne franchit pas la barrière cérébrale.', [
        ...
        [true, 'Elle carbamyle temporairement le site actif de l’enzyme.', 'La forme carbamylée se dissocie et l’enzyme retrouve son activité.'],
        [true, 'Son effet maximal survient en 7 à 10 minutes.', 'Ce délai guide l’évaluation de la réponse.'],
        [true, 'Elle est utilisée dans le traitement de la myasthénie grave.', 'Cette indication figure parmi ses usages cliniques établis.'],
      ...
      qcm('Quelles comparaisons entre anticholinestérases sont exactes ?', src('b00140', 'b00142', 'b00144', 'b00146'), 'Le choix dépend de la durée, de la voie possible et du passage central : pyridostigmine prolongée, édrophonium bref, physostigmine cérébrale.', [
        ...
        [false, 'La physostigmine est le seul anticholinestérase administrable par voie orale.', 'La voie orale caractérise plutôt la pyridostigmine dans la myasthénie.'],
        [false, 'L’édrophonium inhibe l’enzyme de façon covalente et durable.', 'Il occupe le site actif de manière compétitive pendant une dizaine de minutes.'],
      ...
      qcm('Quels signes appartiennent à un syndrome antimuscarinique ?', src('b00147', 'b00148'), 'Le blocage périphérique assèche et ralentit les viscères, tandis que le passage central peut provoquer confusion et hallucinations.', [
        ...
        [true, 'Une constipation.', 'Le transit intestinal se ralentit sous blocage muscarinique.'],
      ...
      qcm('Quelles différences entre atropine, scopolamine et glycopyrrolate sont exactes ?', src('b00150', 'b00153', 'b00155', 'b00157'), 'La liposolubilité favorise les effets centraux de l’atropine et surtout de la scopolamine, tandis que le glycopyrrolate quaternaire reste périphérique.', [
        ...
        [false, 'La scopolamine est une amine quaternaire dépourvue d’effets centraux.', 'Cette amine tertiaire très liposoluble produit somnolence et amnésie.'],
        [false, 'Le glycopyrrolate accélère plus le cœur que l’atropine.', 'Son effet cardiaque est moins marqué.'],
        [false, 'L’effet antisialagogue de l’atropine dépasse celui du glycopyrrolate.', 'Le glycopyrrolate est décrit comme le plus puissant sur la salive.'],
      ]),
    ],
  },
];
...
const DP_QCM_SERIES = [
  {
    ...
    questions: [
      ...
      qcm('Quelles propriétés rendent la phényléphrine cohérente ici ?', src('b00105'), 'Une vasoplégie avec fréquence conservée peut répondre à un agoniste α1 pur, tout en imposant de surveiller le débit et le baroréflexe.', [
        [true, 'Son action vasoconstrictrice directe.', 'La contraction artériolaire relève les résistances.'],
        [true, 'Sa sélectivité α1 sans stimulation cardiaque directe.', 'L’effet presseur repose uniquement sur le versant vasculaire du récepteur.'],
        ...
        [true, 'La surveillance du débit cardiaque reste nécessaire malgré la correction pressive.', 'La hausse de postcharge et le ralentissement réflexe peuvent l’abaisser.'],
      ], 'La pression tombe à 72/38 mmHg et la fréquence reste stable.'),
      qcm('Comment interpréter cette évolution ?', src('b00071', 'b00105'), 'La hausse de pression a activé les barorécepteurs puis le vague, produisant une bradycardie réflexe attendue avec un agoniste α1.', [
        ...
        [true, 'Le baroréflexe explique le ralentissement sans effet cardiaque direct.', 'L’agoniste α1 agit sur les vaisseaux, la réponse cardiaque venant du réflexe.'],
      ], 'Après le premier bolus, la pression atteint 110/62 mmHg et la fréquence passe à 58/min.'),
      qcm('Quels arguments peuvent faire préférer l’éphédrine ?', src('b00103'), 'L’éphédrine associe effet presseur et stimulation cardiaque ; elle répond mieux qu’un α1 pur à une hypotension accompagnée de bradycardie.', [
        ...
        [true, 'Elle libère la noradrénaline stockée dans les terminaisons.', 'Sa composante indirecte complète l’action directe sur les récepteurs.'],
      ], 'Quelques minutes plus tard, l’hypotension récidive avec une fréquence à 48/min.'),
      qcm('Quelles explications sont plausibles ?', src('b00103'), 'La tachyphylaxie de l’éphédrine vient surtout de l’épuisement progressif des réserves neuronales de noradrénaline mobilisées par son action indirecte.', [
        ...
        [true, 'Un recours possible à un agoniste adrénergique direct.', 'Un agent agissant directement sur le récepteur dépend moins des réserves neuronales.'],
      ...
      qcm('Quels mécanismes peuvent l’expliquer ?', src('b00067', 'b00068', 'b00105'), 'La pression peut se corriger alors que le débit diminue : le produit résistances × débit autorise cette dissociation.', [
        [false, 'Une stimulation β2 responsable d’une chute du volume d’éjection.', 'L’agent employé est un vasoconstricteur α1 dépourvu d’action β2.'],
        [false, 'Une relaxation généralisée des artérioles.', 'Le traitement provoque une contraction et non une vasodilatation.'],
        [false, 'Une accélération sinusale provoquée par le baroréflexe.', 'La hausse de pression déclenche un frein vagal qui ralentit le cœur.'],
      ...
      qcm('Quels enseignements retenir ?', src('b00054', 'b00067', 'b00068', 'b00103', 'b00105'), 'Le choix d’un sympathomimétique doit intégrer pression, fréquence et débit ; relever un chiffre tensionnel ne suffit pas à garantir une perfusion adaptée.', [
  ...
  },
  {
    ...
    questions: [
      qcm('Quel profil pharmacologique répond au mécanisme hémodynamique dominant ?', src('b00043', 'b00054', 'b00067', 'b00068'), 'Une vasoplégie avec débit préservé appelle d’abord une augmentation des résistances par stimulation vasculaire α1.', [
        [false, 'Un agonisme dopaminergique D1 rénal.', 'Ce versant dopaminergique dilate le lit rénal au lieu d’élever les résistances.'],
      ...
      qcm('Quelles réponses faut-il attendre ?', src('b00101'), 'La noradrénaline contracte les artérioles et les grosses artères, augmente pression systolique et diastolique et peut déclencher un ralentissement vagal.', [
      ...
      qcm('Quelles interprétations sont correctes ?', src('b00071', 'b00101'), 'Une décélération après correction pressive est compatible avec le baroréflexe et ne signifie pas nécessairement une défaillance du médicament.', [
        ...
        [false, 'La fréquence à 74/min garantit un débit cardiaque optimal.', 'Le débit dépend aussi du volume d’éjection, qui doit être vérifié.'],
      ], 'La pression moyenne se corrige, mais la fréquence passe de 104 à 74/min.'),
      qcm('Quelles propriétés de l’adrénaline deviennent pertinentes ?', src('b00094', 'b00099'), 'L’adrénaline associe β2 bronchique, β1 cardiaque et α vasculaire, mais son profil plus large impose de surveiller fréquence et pression.', [
      ...
      qcm('Quels éléments peuvent être retenus ?', src('b00094', 'b00099'), 'Les effets durent 10 à 15 minutes et des doses répétées peuvent s’accompagner de désensibilisation, ce qui impose une réévaluation globale.', [
        [false, 'Un effet qui se prolonge plusieurs heures après chaque injection.', 'La durée décrite est de dix à quinze minutes.'],
        ...
        [false, 'Une accumulation progressive expliquant une réponse de plus en plus forte.', 'Les administrations répétées s’accompagnent plutôt d’une désensibilisation.'],
      ...
      qcm('Quelles options seraient mal appariées à cette situation ?', src('b00105', 'b00107', 'b00115'), 'Un inotrope ou un β-agoniste renforçant davantage le cœur ne traite pas une vasoplégie à haut débit ; un agent α1 répond mieux au défaut de résistance.', [
      ...
      qcm('Quelles règles de raisonnement ressortent de ce dossier ?', src('b00043', 'b00067', 'b00068', 'b00071', 'b00101'), 'La pression doit être décomposée en débit et résistances, puis la réponse baroréflexe doit être distinguée d’un effet cardiaque direct.', [
        ...
        [true, 'Le profil récepteur de chaque agent oriente le choix thérapeutique.', 'Répartition α, β et actions indirectes diffèrent d’une molécule à l’autre.'],
  ...
  },
  {
    ...
    questions: [
      qcm('Quelles propriétés d’un médicament sont recherchées en première analyse ?', src('b00043', 'b00107', 'b00125'), 'Le défaut de pompe appelle un inotrope β1 ou une augmentation d’AMPc, tandis qu’une vasodilatation pulmonaire peut réduire la charge du ventricule.', [
        [false, 'Une augmentation des résistances systémiques comme objectif premier.', 'Élever la postcharge aggraverait l’éjection d’un ventricule défaillant.'],
        [false, 'Un blocage β1 cardiaque immédiat.', 'Il réduirait la contractilité déjà insuffisante.'],
        [false, 'Un effet chronotrope négatif pour économiser le myocarde.', 'Ralentir davantage le cœur réduirait encore un débit déjà bas.'],
      ...
      qcm('Quels effets sont attendus ?', src('b00107'), 'L’agonisme β1 de la dobutamine augmente contractilité, fréquence et débit ; une faible activité β2 peut abaisser la pression.', [
        ...
        [true, 'Une amélioration de la perfusion régionale par redistribution.', 'La faible activité β2 favorise les débits musculaires.'],
      ...
      qcm('Quelles interprétations sont adaptées ?', src('b00067', 'b00068', 'b00107'), 'L’inotropisme a corrigé le débit tandis que la vasodilatation a réduit les résistances ; le produit des deux explique une pression encore insuffisante.', [
        ...
        [true, 'La titration doit tenir compte à la fois du débit et de la pression.', 'Un seul paramètre suffit rarement à guider l’ajustement des doses.'],
      ...
      qcm('Quelles propriétés sont pertinentes ?', src('b00121', 'b00125'), 'La milrinone augmente l’AMPc, renforce la contraction et relâche le lit vasculaire, notamment pulmonaire, réduisant précharge et postcharge.', [
        [false, 'Une stimulation directe des récepteurs β1 myocardiques.', 'Son action se situe en aval du récepteur, sur la phosphodiestérase.'],
        ...
        [true, 'Une réduction de la précharge et de la postcharge.', 'La vasodilatation veineuse et artérielle allège les deux charges du ventricule.'],
      ], 'L’hypertension pulmonaire persiste et l’équipe envisage la milrinone.'),
      qcm('Quels risques doivent être anticipés ?', src('b00125'), 'L’effet vasodilatateur de la milrinone facilite l’éjection mais peut provoquer une hypotension qui limite son emploi ou impose un soutien vasculaire.', [
        ...
        [true, 'Un rapport bénéfice-risque défavorable à l’emploi prolongé.', 'L’usage durable reste déconseillé dans l’insuffisance cardiaque sévère.'],
      ], 'Après introduction de milrinone, la pression baisse à nouveau malgré un meilleur débit.'),
      qcm('Quels effets physiologiques sont en cause ?', src('b00043', 'b00107'), 'β1 accélère le nœud sinusal, augmente la conduction et renforce la contraction ; l’efficacité hémodynamique doit être confrontée au coût cardiaque.', [
        ...
        [true, 'Une libération de rénine favorisée par les cellules juxtaglomérulaires.', 'Le rein participe à la réponse adrénergique par ce sous-type.'],
        [true, 'Une hausse de la demande myocardique en oxygène.', 'Le coût énergétique croît avec la fréquence et la force de contraction.'],
      ], 'Une tachycardie importante apparaît sous stimulation β1.'),
      qcm('Quelles conclusions sont justes ?', src('b00043', 'b00107', 'b00121', 'b00125'), 'Dobutamine et milrinone peuvent améliorer un bas débit par des voies différentes, mais leur vasodilatation exige une titration fondée sur pression et perfusion.', [
        [false, 'La dobutamine inhibe la phosphodiestérase myocardique.', 'Son effet passe par l’agonisme du récepteur β1 cardiaque.'],
  ...
  },
  {
    ...
    questions: [
      qcm('Quelles propriétés rendent un agoniste α2 adapté à cette stratégie ?', src('b00111', 'b00113'), 'L’agonisme α2 central procure sédation et analgésie en diminuant la transmission noradrénergique, ce qui convient à une procédure consciente.', [
        [false, 'Une amnésie antérograde constante et complète.', 'La sédation obtenue reste consciente et coopérative, sans amnésie garantie.'],
        [false, 'Une action par blocage des récepteurs muscariniques.', 'Ces agents agissent sur des récepteurs adrénergiques α2, pas cholinergiques.'],
        [true, 'Une réduction de la transmission noradrénergique centrale.', 'L’activation α2 diminue la libération de noradrénaline dans le cerveau.'],
        [false, 'Une stimulation β2 assurant la bronchodilatation pendant la procédure.', 'Le versant bronchique relève des agonistes β2, non des α2.'],
        [false, 'Une activation sympathique massive obligatoire.', 'Le profil central est surtout sympatholytique.'],
      ]),
      qcm('Quelles caractéristiques la distinguent de la clonidine ?', src('b00111', 'b00113'), 'La dexmédétomidine est beaucoup plus sélective pour α2 et dispose d’un emploi établi en perfusion pour sédation consciente.', [
      ...
      qcm('Comment expliquer ce phénomène ?', src('b00113'), 'Une activation α2 périphérique initiale contracte les vaisseaux avant que la sympatholyse centrale ne domine.', [
        [false, 'Une libération massive d’adrénaline par la médullosurrénale.', 'La dexmédétomidine agit directement sur les récepteurs vasculaires, sans relais surrénalien.'],
        [true, 'Une action sur les récepteurs α2 du muscle lisse vasculaire.', 'Le pic de concentration initial contracte les vaisseaux avant l’effet central.'],
        [false, 'Un effet qui persiste pendant toute la perfusion d’entretien.', 'L’hypertension est signalée surtout pendant la dose de charge.'],
        [true, 'Une phase transitoire précédant la sympatholyse centrale.', 'Le frein sympathique central prend ensuite le dessus.'],
      ...
      qcm('Quels mécanismes sont plausibles ?', src('b00065', 'b00113'), 'La diminution du tonus sympathique sous agoniste α2 favorise la bradycardie, à laquelle peut s’ajouter une stimulation vagale liée à la procédure.', [
        [true, 'Une sympatholyse centrale par activation α2.', 'Le retrait de la commande accélératrice ralentit le nœud sinusal.'],
        [false, 'Un blocage des récepteurs β1 du nœud sinusal.', 'Le médicament est un agoniste α2, sans propriété bêtabloquante.'],
      ...
      qcm('Quels paramètres méritent une réévaluation ?', src('b00067', 'b00068', 'b00113'), 'La baisse conjointe de fréquence et de tonus vasculaire peut réduire débit et résistances ; la profondeur de sédation et le débit de perfusion doivent être réexaminés.', [
        [false, 'La profondeur du bloc neuromusculaire résiduel.', 'Aucun curare n’a été utilisé pour cette intubation vigile.'],
      ...
      qcm('Quelles réponses pharmacologiques sont cohérentes ?', src('b00065', 'b00150', 'b00153', 'b00157'), 'Une bradycardie vagale symptomatique peut être antagonisée par un antimuscarinique, atropine ou glycopyrrolate, dont le passage central diffère.', [
        [false, 'Administrer un bêtabloquant cardiosélectif pour stabiliser le rythme.', 'Bloquer β1 accentuerait le ralentissement déjà provoqué par le vague.'],
        ...
        [true, 'Titrer la dose d’antimuscarinique selon la tolérance hémodynamique.', 'L’effet chronotrope recherché doit rester proportionné à la bradycardie observée.'],
      ...
      qcm('Quels points de sécurité résument ce dossier ?', src('b00111', 'b00113', 'b00150', 'b00157'), 'La sédation α2 consciente exige une titration continue et une anticipation de la brady-hypotension ; un antimuscarinique périphérique peut être choisi selon le contexte.', [
        [false, 'Interrompre le monitorage tensionnel une fois l’intubation réussie.', 'Les effets hémodynamiques peuvent persister après le geste.'],
        [false, 'Considérer la dose de charge comme dépourvue d’effet vasculaire.', 'Une hypertension transitoire est possible.'],
        [false, 'Administrer une dose fixe de sédatif indépendante de la réponse clinique.', 'La sédation consciente impose une titration continue.'],
        ...
        [true, 'Préférer un antimuscarinique quaternaire pour limiter les effets centraux.', 'Le glycopyrrolate agit en périphérie sans confusion ni sédation ajoutée.'],
...
const MORE_DP_QCM_SERIES = [
  {
    ...
    questions: [
      ...
      qcm('Quelles interprétations sont exactes ?', src('b00082'), 'La relation temporelle et l’intensité du ralentissement évoquent une activation vagale oculocardiaque, fréquente en chirurgie de l’œil.', [
      ...
      qcm('Quels médicaments peuvent réduire cette réponse ?', src('b00082', 'b00150'), 'Un antimuscarinique comme le glycopyrrolate bloque les récepteurs muscariniques cardiaques et diminue l’incidence du réflexe.', [
        [false, 'La phényléphrine.', 'Son effet presseur activerait le baroréflexe et accentuerait le ralentissement.'],
      ...
      qcm('Quels effets périphériques faut-il anticiper ?', src('b00147', 'b00148'), 'Le blocage muscarinique accélère le cœur, dilate la pupille et réduit sécrétions et motilité viscérale.', [
        ...
        [true, 'Une peau sèche par blocage des glandes sudoripares.', 'Les glandes sudoripares reçoivent une commande cholinergique sympathique.'],
      ...
      qcm('Quelles propriétés justifient ce choix ?', src('b00157'), 'Le glycopyrrolate quaternaire, fortement ionisé, pénètre peu dans le cerveau tout en réduisant efficacement la salivation.', [
        [false, 'Sa capacité à inhiber l’acétylcholinestérase plasmatique.', 'Il bloque les récepteurs muscariniques sans toucher l’enzyme.'],
        [false, 'Une très grande liposolubilité cérébrale.', 'La molécule franchit difficilement la barrière hémato-encéphalique.'],
        [false, 'Un effet sédatif central recherché en fin d’intervention.', 'La molécule quaternaire reste confinée en périphérie.'],
      ...
      qcm('Quelle analyse est correcte ?', src('b00148', 'b00150', 'b00157'), 'L’effet thérapeutique et la sécheresse relèvent du même antagonisme muscarinique périphérique ; l’intensité sécrétoire ne traduit pas un passage central.', [
        [true, 'La diminution salivaire est un effet pharmacologique attendu.', 'Le glycopyrrolate est un antisialagogue puissant.'],
        [true, 'La sécheresse et l’effet cardiaque relèvent du même blocage muscarinique.', 'Un seul mécanisme périphérique explique les deux observations.'],
        [true, 'L’efficacité cardiaque confirme le blocage du versant vagal.', 'La fréquence ne chute plus lors du stimulus.'],
        [true, 'Le degré de sécheresse dépend de la puissance antisialagogue du produit.', 'Son pouvoir antisialagogue dépasse celui de l’atropine.'],
      ...
      qcm('Quels éléments permettent de distinguer ce réflexe d’autres réponses autonomes ?', src('b00075', 'b00078', 'b00080', 'b00082'), 'Le déclencheur extraoculaire et la bradycardie vagale identifient le réflexe oculocardiaque, contrairement aux stimuli atrial, ventriculaire ou intracrânien.', [
        [false, 'Une afférence par le nerf glossopharyngien le caractérise.', 'L’information part du trijumeau par les nerfs ciliaires.'],
        [false, 'Une efférence sympathique explique la chute de fréquence observée.', 'Le ralentissement provient d’une décharge vagale sur le nœud sinusal.'],
  ...
  },
  {
    ...
    questions: [
      qcm('Quels mécanismes initiaux peuvent expliquer la hausse tensionnelle ?', src('b00080'), 'L’ischémie cérébrale liée à la pression intracrânienne active le centre vasomoteur et le sympathique pour tenter de préserver la perfusion cérébrale.', [
        [false, 'Une compression directe du nœud sinusal par l’hypertension intracrânienne.', 'L’atteinte porte sur le centre vasomoteur du tronc cérébral.'],
        ...
        [false, 'Une libération d’acétylcholine responsable de la hausse tensionnelle.', 'La montée de pression vient d’une décharge noradrénergique sympathique.'],
        [false, 'Une vasodilatation périphérique muscarinique isolée.', 'Le tonus vasomoteur s’élève pour soutenir la pression.'],
      ]),
      qcm('Quelle séquence est probable ?', src('b00071', 'b00080'), 'Après la réponse sympathique pressive, les barorécepteurs activent le vague et produisent une bradycardie secondaire.', [
        [false, 'La bradycardie précède toujours la poussée hypertensive.', 'La séquence de Cushing débute par une activation sympathique.'],
        [false, 'L’hypertension diminue la décharge des barorécepteurs artériels.', 'L’étirement pariétal augmente leur fréquence de décharge.'],
      ...
      qcm('Quelles affirmations sont justes ?', src('b00067', 'b00068', 'b00071', 'b00080'), 'Le tableau associe une pression élevée par tonus vasomoteur et un ralentissement baroréflexe ; la fréquence seule ne reflète donc pas l’intensité sympathique vasculaire.', [
        [true, 'Le tonus vasculaire sympathique peut rester très élevé.', 'Les résistances soutiennent toujours l’hypertension.'],
        [true, 'Le frein vagal cardiaque coexiste avec une vasoconstriction sympathique.', 'Les deux divisions agissent simultanément sur des cibles différentes.'],
      ...
      qcm('Comment interpréter cette dissociation ?', src('b00071', 'b00080', 'b00150'), 'Le médicament bloque l’efférence vagale cardiaque mais ne supprime ni l’activation vasomotrice sympathique ni l’ischémie cérébrale déclenchante.', [
        [false, 'Le blocage muscarinique corrige aussi le tonus vasoconstricteur.', 'Les récepteurs α1 vasculaires restent libres sous antimuscarinique.'],
      ...
      qcm('Quelles modifications autonomes sont attendues ?', src('b00071', 'b00080'), 'La disparition du stimulus ischémique réduit l’activation sympathique ; la moindre pression diminue aussi la stimulation baroréceptrice.', [
        [false, 'Un renforcement du réflexe de Cushing malgré le geste chirurgical.', 'Le stimulus ischémique ayant disparu, la boucle s’éteint.'],
        [true, 'Une diminution de la décharge des barorécepteurs.', 'Leur étirement baisse avec la pression.'],
        [true, 'Une normalisation progressive des résistances vasculaires périphériques.', 'La vasoconstriction déclenchée par l’ischémie centrale s’atténue.'],
      ...
      qcm('Quelles différences sont correctes ?', src('b00078', 'b00080'), 'Cushing est pressif et d’origine cérébrale ; Bezold-Jarisch naît du ventricule gauche et associe hypotension, bradycardie et vasodilatation coronaire.', [
      ...
      qcm('Quels repères diagnostiques retenir ?', src('b00078', 'b00080', 'b00082'), 'Déclencheur, pression et fréquence permettent de distinguer rapidement Cushing, Bezold-Jarisch et oculocardiaque.', [
        ...
        [true, 'Une bradycardie après traction oculaire oriente vers l’arc trigémino-vagal.', 'Le déclencheur mécanique oculaire signe ce réflexe.'],
        [true, 'Le contexte causal est aussi important que la fréquence cardiaque.', 'Plusieurs arcs différents ralentissent le cœur.'],
        [true, 'Le déclencheur et le profil tensionnel séparent ces trois réflexes.', 'La seule fréquence cardiaque suffit rarement à les distinguer.'],
  ...
  },
  {
    ...
    questions: [
      qcm('Quelles voies autonomes régulent normalement sa fréquence cardiaque ?', src('b00043', 'b00051', 'b00065'), 'La noradrénaline sympathique stimule β1 et accélère le cœur, tandis que l’acétylcholine vagale active M2 et le ralentit.', [
        ...
        [false, 'Le récepteur β2 assure l’accélération du nœud sinusal.', 'Le chronotropisme cardiaque dépend du sous-type β1.'],
        [false, 'Le parasympathique accélère le cœur par M3.', 'La commande vagale utilise surtout M2 et ralentit le rythme.'],
        [false, 'Le nerf vague libère de la noradrénaline sur le nœud sinusal.', 'Le médiateur du frein vagal est l’acétylcholine.'],
        [false, 'Le récepteur α1 constitue le principal frein sinusal.', 'α1 agit surtout sur le muscle lisse vasculaire.'],
      ]),
      qcm('Quels éléments décrivent son action ?', src('b00149', 'b00150', 'b00153'), 'L’atropine bloque compétitivement les récepteurs muscariniques, lève le frein vagal et peut agir en périphérie comme dans le SNC.', [
      ...
      qcm('Quelles options de deuxième choix sont décrites ?', src('b00109', 'b00115'), 'Une bradycardie résistante peut conduire à une stimulation adrénergique par dopamine ou isoprotérénol selon le contexte.', [
      ...
      qcm('Quels mécanismes expliquent cette réponse ?', src('b00115'), 'L’isoprotérénol stimule β1 au cœur et β2 dans les vaisseaux : la tachycardie s’accompagne donc d’une diminution des résistances et de la pression.', [
        [false, 'Une activation des récepteurs M2 cardiaques par l’isoprotérénol.', 'L’agent est un agoniste β, sans activité cholinergique.'],
        [false, 'Une stimulation des barorécepteurs par la baisse de pression.', 'La chute tensionnelle réduit l’étirement pariétal et leur décharge.'],
      ...
      qcm('Quelles propriétés varient avec la dose ?', src('b00109'), 'Le profil de la dopamine évolue de D1 vers β puis α1-β1 lorsque la dose augmente, modifiant débit régional, fréquence et pression.', [
        ...
        [true, 'Les vaisseaux du muscle squelettique se dilatent aux doses intermédiaires.', 'Le versant β2 relâche ce territoire vasculaire.'],
        [true, 'À forte dose, la contractilité et le débit cardiaques augmentent.', 'Le versant β1 s’ajoute alors à la vasoconstriction.'],
      ], 'Une dopamine est discutée à la place.'),
      qcm('Quelles propriétés doivent être intégrées ?', src('b00043', 'b00109', 'b00115'), 'La stimulation β1 augmente fréquence, conduction et contractilité ; l’objectif est de corriger le ralentissement sans dépasser une réponse cardiaque utile.', [
        [true, 'β1 accélère la conduction atrioventriculaire.', 'L’influx traverse plus rapidement les tissus nodaux.'],
        [false, 'β1 réduit la vitesse de conduction dans le nœud atrioventriculaire.', 'La conduction nodale est accélérée par cette stimulation.'],
        ...
        [true, 'Un remplissage ventriculaire réduit peut limiter le bénéfice hémodynamique.', 'Une diastole trop courte diminue le volume d’éjection.'],
      ], 'La fréquence se normalise mais une tachyarythmie menace sous stimulation adrénergique.'),
      qcm('Quelles distinctions thérapeutiques sont exactes ?', src('b00109', 'b00115', 'b00130', 'b00153'), 'Atropine retire le frein muscarinique ; dopamine et isoprotérénol apportent une stimulation adrénergique, tandis qu’esmolol aurait l’effet opposé.', [
        [false, 'L’atropine stimule directement les récepteurs β1 du nœud sinusal.', 'Son action se limite au blocage des récepteurs muscariniques.'],
  ...
  },
  {
    ...
    questions: [
      qcm('Quelles conséquences découlent de l’inhibition de l’acétylcholinestérase ?', src('b00137', 'b00138'), 'L’acétylcholine s’accumule dans les fentes synaptiques, renforçant à la fois la transmission neuromusculaire et les réponses muscariniques.', [
        ...
        [false, 'Un blocage de la libération présynaptique d’acétylcholine.', 'L’inhibition porte sur l’enzyme de dégradation, non sur l’exocytose.'],
        ...
        [true, 'Un myosis par stimulation du sphincter irien.', 'Le sphincter de l’iris répond à l’excès d’acétylcholine.'],
      ]),
      qcm('Quelles caractéristiques pharmacologiques sont exactes ?', src('b00140'), 'La néostigmine inhibe réversiblement l’enzyme sous forme carbamylée, atteint son maximum en 7 à 10 minutes et agit environ une heure.', [
        [false, 'Elle appartient aux amines tertiaires liposolubles.', 'Sa charge permanente explique qu’elle reste en dehors du cerveau.'],
        ...
        [false, 'Elle est utilisée pour traiter un syndrome anticholinergique central.', 'Cette indication revient à la physostigmine, qui franchit la barrière.'],
      ...
      qcm('Quels effets expliquent ce tableau ?', src('b00138', 'b00140'), 'L’excès d’acétylcholine stimule les récepteurs muscariniques cardiaques et glandulaires, donnant bradycardie et hypersalivation.', [
        ...
        [true, 'Une augmentation du péristaltisme intestinal.', 'La motilité digestive est stimulée par l’excès d’acétylcholine.'],
        ...
        [true, 'Une réponse antagonisable par un antimuscarinique.', 'Atropine ou glycopyrrolate bloquent ces effets périphériques.'],
      ], 'Peu après l’administration, la fréquence diminue et la salivation augmente.'),
      qcm('Quelles raisons justifient ce choix ?', src('b00138', 'b00157'), 'Le glycopyrrolate bloque les effets muscariniques périphériques, réduit fortement la salivation et a un effet cardiaque moins marqué que l’atropine.', [
        ...
        [true, 'Il agit comme antagoniste compétitif des récepteurs muscariniques.', 'Le blocage réversible des récepteurs M explique ses effets.'],
      ...
      qcm('Pourquoi la néostigmine ne corrige-t-elle pas un syndrome central ?', src('b00140', 'b00146'), 'La néostigmine ne franchit pas la barrière cérébrale ; une molécule tertiaire comme la physostigmine peut atteindre les synapses centrales.', [
        [false, 'La confusion observée relève d’un excès d’acétylcholine central.', 'Le tableau central traduit un déficit cholinergique cérébral.'],
        ...
        [true, 'Le passage de la barrière hémato-encéphalique conditionne l’effet central.', 'Seule une molécule qui franchit cette barrière agit sur les synapses cérébrales.'],
        [true, 'La charge quaternaire d’un agent le confine au compartiment périphérique.', 'Le glycopyrrolate et la néostigmine restent ainsi hors du cerveau.'],
      ], 'La patiente reste confuse alors que les signes périphériques sont contrôlés.'),
      qcm('Quelles distinctions sont exactes ?', src('b00140', 'b00142', 'b00144'), 'Ces inhibiteurs partagent une cible mais diffèrent par rapidité, durée et voie : édrophonium très bref, pyridostigmine prolongée et orale.', [
        ...
        [true, 'L’édrophonium est utilisé pour le diagnostic de la myasthénie grave.', 'Son action très rapide convient à un test diagnostique.'],
        [true, 'L’édrophonium inhibe l’enzyme de façon compétitive et réversible.', 'Il empêche temporairement l’accès au site actif.'],
        [true, 'La néostigmine agit environ une heure après son administration.', 'Sa durée d’action est plus longue que celle de l’édrophonium.'],
      ], 'Un diagnostic différentiel compare néostigmine, pyridostigmine et édrophonium.'),
      qcm('Quels principes faut-il retenir ?', src('b00138', 'b00140', 'b00146', 'b00157'), 'Une anticholinestérase agit sur toutes les synapses cholinergiques accessibles ; l’antimuscarinique associé doit contrôler les effets périphériques sans masquer une atteinte centrale.', [
