    ...
    questions: [
      ...
      qcm(
        ...
        [
          ...
          T("Une ou deux réponses post-tétaniques orientent vers 4 mg/kg.", "Le bloc profond contient davantage de rocuronium actif."),
...
const DP_QCM_SERIES = [
  {
    ...
    questions: [
      ...
      qcm(
        "Le bilan préinduction montre une kaliémie normale et aucun antécédent d’hyperthermie maligne. Quel choix est cohérent pour le curare d’intubation ?",
      ...
      qcm(
        "Après injection, des fasciculations apparaissent puis toute réponse motrice devient faible. Quels signes de monitorage sont attendus juste après succinylcholine ?",
      ...
      qcm(
        "Quarante minutes plus tard, aucune ventilation spontanée efficace n’est revenue et aucune dose supplémentaire n’a été donnée. Comment interpréter cette évolution et que faire ?",
      ...
      qcm(
        "Le dossier confirme une dose unique, une normothermie et l’absence de tout autre curare. Quelles données renforcent l’hypothèse enzymatique ?",
        src("b00038", "b00045", "b00048"),
      ...
      qcm(
        "Après poursuite du support, les quatre réponses réapparaissent et le patient recommence à ventiler. Quels critères autorisent finalement l’extubation ?",
      ...
      qcm(
        "Le rapport T4/T1 atteint 0,94 et l’extubation se déroule sans incident. Quelles informations doivent être transmises au patient ?",
  ...
  },
  {
    ...
    questions: [
      ...
      qcm(
        "La kaliémie est à 4,6 mmol/L, mais la brûlure date de vingt et un jours. Quel schéma d’intubation est approprié ?",
      ...
      qcm(
        "Deux réponses décroissantes sont observées au Td4 après l’intubation. Comment interpréter le train-de-quatre après le bolus ?",
      ...
      qcm(
        "Un SDRA sévère impose finalement une perfusion de curare pendant quarante-huit heures. Quels objectifs guident l’entretien en réanimation ?",
      ...
      qcm(
        "À l’arrêt de la perfusion, le patient présente une cholestase et ne récupère que lentement ses réponses. Quels facteurs peuvent expliquer une récupération lente ?",
        src("b00076", "b00077", "b00078", "b00079"),
      ...
      qcm(
        "Après plusieurs heures, deux réponses réapparaissent au train-de-quatre et la fonction rénale reste normale. Quelle antagonisation est cohérente à ce stade ?",
      ...
      qcm(
        "Trente minutes plus tard, le patient ventile et le rapport mesuré atteint 0,93. Quels éléments confirment une récupération sûre ?",
  ...
  },
  {
    ...
    questions: [
      ...
      qcm(
        "La chirurgie ne nécessite pas de séquence rapide et l’équipe souhaite éviter une élimination biliaire dominante. Quel choix limite la dépendance hépatique ?",
        src("b00074", "b00075"),
      ...
      qcm(
        "Le cisatracurium est injecté et la pression artérielle reste stable. Quelles propriétés expliquent ce choix ?",
        src("b00074", "b00075"),
      ...
      qcm(
        "Après quatre-vingt-dix minutes, le chirurgien demande encore un relâchement profond. Comment guider les bolus d’entretien ?",
      ...
      qcm(
        "En fin d’intervention, quatre réponses sont visibles avec une fatigue nette. Quelle stratégie de décurarisation est possible ?",
        src("b00092", "b00114"),
      ...
      qcm(
        "La fréquence cardiaque est à 54/min avant l’antagonisation. Quels effets indésirables de néostigmine faut-il prévenir ?",
        src("b00092", "b00114"),
      ...
      qcm(
        "Après traitement, le rapport T4/T1 est mesuré à 0,91 et la ventilation spontanée est satisfaisante. Quelle donnée permet l’extubation ?",
        src("b00090", "b00113"),
  ...
  },
  {
    ...
    questions: [
      ...
      qcm(
        "La fracture nécessite une induction urgente, sans estomac plein mais avec immobilisation douloureuse. Quel agent convient pour une intubation rapide ?",
        src("b00034", "b00065", "b00066"),
      ...
      qcm(
        "Après rocuronium, aucune fasciculation n’a été vue et les réponses répétées s’épuisent. Comment expliquer le profil observé ?",
      ...
      qcm(
        "Une complication technique impose d’arrêter l’intervention cinq minutes après le bolus d’intubation. Quelle conduite adopter si l’intervention s’achève très tôt ?",
        src("b00093", "b00099", "b00102"),
      ...
      qcm(
        "Le rapport augmente rapidement après la dose de sugammadex. Pourquoi le monitorage reste-t-il indispensable ?",
        ...
        [
          ...
          T("Rechercher une recurarisation après un éventuel sous-dosage.", "Du rocuronium demeuré libre peut réoccuper les récepteurs lorsque la quantité de sugammadex est insuffisante.")
        ],
        "Le rapport augmente rapidement après la dose de sugammadex."
      ),
      qcm(
        "Dix minutes plus tard, quatre réponses égales donnent un rapport à 0,96. Quels résultats sont rassurants avant extubation ?",
        src("b00090", "b00113"),
        "Un rapport supérieur à 0,9 et une fonction ventilatoire stable indiquent une récupération neuromusculaire complète.",
        [
          ...
          T("Quatre contractions sans fade mesurable.", "La transmission soutient la stimulation répétée."),
          T("Toux et ventilation efficaces.", "Les fonctions respiratoires sont revenues."),
          T("Une déglutition sans signe d’obstruction.", "La récupération des muscles pharyngés contribue à protéger les voies aériennes."),
      ...
      qcm(
        "Le patient quitte la SSPI sans symptôme et demande les précautions pour une future opération. Quelles informations doivent figurer dans le dossier ?",
  ...
  },
  {
    ...
    questions: [
      ...
      qcm(
        "L’équipe se demande si la réaction peut être une simple histaminolibération. Quelles distinctions pharmacologiques faut-il garder ?",
      ...
      qcm(
        "La chirurgie est interrompue, mais le bloc neuromusculaire persiste. Quelles mesures concernant la curarisation sont prudentes ?",
      ...
      qcm(
        "La patiente est stabilisée, et une réponse post-tétanique apparaît sans réponse au Td4. Quelle option peut lever le bloc au rocuronium ?",
        src("b00093", "b00102"),
      ...
      qcm(
        "Le compte post-tétanique montre deux réponses, la fonction rénale est normale. Quelle dose correspond à cette profondeur ?",
        src("b00099", "b00102"),
      ...
      qcm(
        "Après traitement, l’hémodynamique se normalise et quatre réponses réapparaissent. Quels critères permettent la levée du support ventilatoire ?",
        src("b00090", "b00104", "b00113"),
      ...
      qcm(
        "La patiente récupère avec un rapport à 0,95 et doit être adressée après sa sortie. Quelles consignes sont pertinentes à distance ?",
  ...
  },
  {
    ...
    questions: [
      ...
      qcm(
        "En SSPI, il se plaint de faiblesse, tousse mal et son rapport T4/T1 est mesuré à 0,62. Quels éléments orientent vers une curarisation résiduelle ?",
        src("b00090", "b00113"),
        ...
        [
          ...
          T("Quatre réponses tactiles n’excluent pas un fade quantitatif.", "Le toucher détecte mal les rapports modérément diminués et peut surestimer la récupération.")
        ],
        "En SSPI, il se plaint de faiblesse, tousse mal et son rapport T4/T1 est mesuré à 0,62."
      ),
      qcm(
        "La saturation chute à 89 % avec tirage et ventilation superficielle. Quelles mesures immédiates sont adaptées ?",
      ...
      qcm(
        "Quatre réponses sont visibles, et l’atracurium est le seul curare reçu. Quelle décurarisation est possible avec l’atracurium ?",
      ...
      qcm(
        "La fréquence cardiaque est à 58/min avant l’administration. Quels effets de la néostigmine doivent être anticipés ?",
        src("b00092", "b00114"),
      ...
      qcm(
        "Après traitement et soutien, le rapport atteint 0,92 et la toux redevient efficace. Quels résultats montrent l’efficacité de la prise en charge ?",
      ...
      qcm(
        "Le dossier est revu lors de la réunion qualité du service. Comment prévenir une récidive de ce scénario ?",
        src("b00085", "b00109", "b00113"),
  ...
  },
  {
    ...
    questions: [
      ...
      qcm(
        "Après l’intubation, la chirurgie se prolonge et un relâchement modéré suffit. Comment gérer l’entretien du bloc ?",
      ...
      qcm(
        "Quatre réponses sont visibles, mais T4 reste nettement plus faible que T1. Quelle interprétation faire en fin d’intervention ?",
        src("b00088", "b00090"),
      ...
      qcm(
        "La fonction rénale est terminale et aucune urgence d’extubation n’existe. Quelle stratégie respecte le terrain rénal ?",
        src("b00092", "b00102", "b00114"),
        ...
        [
          ...
          F("Remplacer la néostigmine par l’atropine seule pour éviter l’excrétion rénale.", "L’antimuscarinique prévient des effets secondaires mais ne restaure pas la transmission nicotinique."),
          F("Sugammadex systématique malgré l’insuffisance terminale.", "L’usage n’est pas recommandé dans ce contexte."),
          F("Néostigmine sans monitorage car le rein est malade.", "Le prérequis neuromusculaire reste essentiel."),
      ...
      qcm(
        "L’interne propose de doubler la dose si le rapport monte lentement. Pourquoi ne pas augmenter indéfiniment la néostigmine ?",
        src("b00092", "b00114"),
      ...
      qcm(
        "Après attente et traitement, le rapport atteint 0,94. Quand l’extubation devient-elle acceptable ?",
        src("b00090", "b00113"),
      ...
      qcm(
        "La patiente est extubée sans complication après récupération complète. Quels enseignements organisationnels retenir ?",
  ...
  },
  {
    ...
    questions: [
      ...
      qcm(
        "L’équipe retient une faible dose fractionnée de rocuronium sous monitorage. Quelle stratégie est prudente ?",
      ...
      qcm(
        "Après une dose bien inférieure à l’ordinaire, aucune réponse au Td4 n’est obtenue. Comment interpréter la disparition rapide des réponses ?",
        src("b00054", "b00085"),
      ...
      qcm(
        "En fin d’intervention, le Td4 est encore nul mais deux réponses post-tétaniques apparaissent. Quelle donnée permet de quantifier un bloc encore profond ?",
      ...
      qcm(
        "La fonction rénale est normale et le rocuronium est l’unique curare. Quelle antagonisation correspond à ce résultat ?",
        src("b00093", "b00099", "b00102"),
      ...
      qcm(
        "Après antagonisation, quatre réponses reviennent mais le premier rapport n’est que de 0,84. Quels éléments doivent faire différer l’extubation ?",
        src("b00090", "b00113"),
      ...
      qcm(
        "Après surveillance prolongée, le rapport atteint 0,95 sans fatigue ventilatoire. Quels critères finaux sont nécessaires ?",
        src("b00104", "b00109", "b00113"),
