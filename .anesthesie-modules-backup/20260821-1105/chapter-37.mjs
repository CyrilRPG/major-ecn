...
const ISOLATED_QCM = [
  { title: "Définitions et développement", questions: [
    qcm("Quelles propositions caractérisent correctement la douleur ?", [
      it("Elle comporte une dimension sensitive.", true, "La localisation, la qualité et l’intensité relèvent de sa dimension sensorielle."),
      ...
      it("Elle peut être liée à une lésion potentielle.", true, "La définition inclut la menace tissulaire même sans lésion objectivée."),
    ...
    qcm("Comment la nociception se caractérise-t-elle du stimulus au système central ?", [
      ...
      it("Elle implique une voie ascendante à trois neurones.", true, "Les relais périphérique, spinal-thalamique puis thalamo-cortical sont successifs."),
      ...
      it("Elle peut se plastifier en cas de stimulation persistante.", true, "La transmission répétée modifie durablement l’excitabilité du système."),
    ...
    qcm("Quelles étapes appartiennent à l’intégration douloureuse ?", [
      it("Transduction.", true, "Elle convertit le stimulus en activité électrique."),
      it("Transmission.", true, "Elle achemine le message vers le système central."),
      it("Modulation.", true, "Elle augmente ou inhibe l’afférence nociceptive."),
    ...
    qcm("Pourquoi la physiologie de la douleur est-elle centrale en anesthésie ?", [
      ...
      it("Elle permet de raisonner l’analgésie multimodale.", true, "Les traitements peuvent cibler plusieurs relais complémentaires."),
    ...
    ], ["b00004", "b00005", "b00009"], "La neurophysiologie soutient une prévention ciblée, une combinaison raisonnée et le suivi du risque de chronicisation."),
  ] },
  { title: "Fibres et premier neurone", questions: [
    ...
    qcm("Quel profil anatomofonctionnel distingue les fibres Aδ ?", [
      it("Elles sont faiblement myélinisées.", true, "Cette myélinisation explique une conduction intermédiaire."),
    ...
    qcm("Quel profil anatomofonctionnel distingue les fibres C ?", [
      ...
      it("Leur vitesse est de 0,5 à 2 m/s environ.", true, "Cette plage illustre leur conduction lente."),
    ...
    qcm("Quel trajet suit le premier neurone nociceptif ?", [
      ...
      it("Il peut parcourir le tractus de Lissauer.", true, "Il peut monter ou descendre sur un à deux niveaux."),
    ...
    qcm("Quelles afférences véhiculent la nociception viscérale ?", [
      it("Les nerfs sympathiques.", true, "Ils transportent une part importante des afférences viscérales."),
      it("Les nerfs parasympathiques.", true, "Ils participent aussi à cette transmission."),
  ...
  { title: "Corne dorsale et portillon", questions: [
    qcm("Quelles lames médullaires reçoivent surtout les afférences nociceptives ?", [
      it("La lame I.", true, "Elle reçoit des afférences nociceptives et thermiques."),
      it("La lame II.", true, "La substantia gelatinosa est un site majeur d’intégration."),
      it("La lame V.", true, "Elle reçoit notamment des convergences viscéro-somatiques."),
    ...
    qcm("Quelles propositions expliquent la douleur référée ?", [
      it("Des afférences viscérales et somatiques convergent sur la lame V.", true, "Un même deuxième neurone reçoit les deux origines."),
      ...
      it("Elle est favorisée par une représentation centrale imprécise des viscères.", true, "La voie viscérale est diffuse et peu discriminante."),
    ...
    qcm("Comment la théorie du portillon explique-t-elle la modulation segmentaire ?", [
      ...
      it("Le portillon est situé uniquement dans le cortex préfrontal.", false, "Le modèle s’applique surtout à la corne dorsale."),
    ...
    qcm("Quels types de neurones de deuxième ordre sont décrits ?", [
      ...
      it("Des neurones à large spectre.", true, "Ils répondent à plusieurs catégories et codent l’intensité."),
      it("Des neurones non nociceptifs.", true, "Ils participent notamment à l’inhibition."),
  ...
  { title: "Voies ascendantes et perception", questions: [
    qcm("Quel trajet et quelle fonction définissent la voie néospinothalamique ?", [
      ...
      it("Elle projette vers le VPL thalamique.", true, "Ce noyau relaie vers le cortex somatosensitif primaire."),
      it("Elle participe à la localisation de la douleur.", true, "Elle code siège et intensité du stimulus."),
    ...
    qcm("Quel trajet et quelle fonction définissent la voie paléospinothalamique ?", [
      ...
      it("Elle atteint le cortex cingulaire.", true, "Le cingulaire antérieur participe au caractère déplaisant."),
    ...
    qcm("Quelles propositions décrivent la voie spinoréticulaire ?", [
      it("Elle traverse la formation réticulée.", true, "Son nom reflète ce relais du tronc cérébral."),
  ...
  { title: "Contrôle descendant", questions: [
    ...
    qcm("Comment les voies descendantes inhibent-elles la transmission ?", [
      it("Par inhibition directe des neurones de la corne dorsale.", true, "Elles réduisent directement l’excitabilité du relais."),
      ...
      it("Par une action dans les lames II et III.", true, "Les projections du raphé atteignent ces couches."),
    ...
    qcm("Quels facteurs peuvent modifier le portillon spinal ?", [
      it("Une stimulation tactile.", true, "Elle recrute les fibres Aβ inhibitrices."),
    ...
    qcm("Pourquoi le système descendant est-il cliniquement important ?", [
      ...
      it("Il constitue une cible de traitements antalgiques.", true, "Renforcer son frein peut réduire la transmission."),
  ...
  { title: "Sensibilisation périphérique et centrale", questions: [
    qcm("Quels éléments appartiennent à la soupe inflammatoire ?", [
      ...
      it("Uniquement du glutamate cortical.", false, "La soupe inflammatoire est un phénomène tissulaire périphérique."),
    ...
    qcm("Quelles propositions décrivent la sensibilisation périphérique ?", [
      ...
      it("Elle exige obligatoirement une lésion du cortex.", false, "Elle se déroule à la terminaison périphérique."),
    ...
    qcm("Comment l’inflammation neurogène s’étend-elle autour d’une lésion ?", [
      ...
      it("Elle reste strictement limitée au tissu initialement lésé.", false, "Elle s’étend aux tissus voisins non lésés."),
    ...
    qcm("Quelles propositions décrivent l’activation NMDA ?", [
      ...
      it("Du Ca2+ entre dans le deuxième neurone.", true, "Cette entrée augmente l’excitabilité postsynaptique."),
      it("Elle réduit durablement toute transmission.", false, "Elle amplifie au contraire le signal et la plasticité."),
      it("Elle participe à la chronicisation.", true, "L’hyperexcitabilité centrale peut persister après la douleur aiguë."),
    ...
    qcm("Quels acteurs contribuent à la sensibilisation centrale ?", [
      ...
      it("La microglie.", true, "Elle participe au maintien de l’état hyperexcitable."),
  ...
  { title: "Cibles pharmacologiques", questions: [
    ...
    qcm("Comment les anesthésiques locaux interrompent-ils la conduction nociceptive ?", [
      ...
      it("Ils activent directement les récepteurs NMDA.", false, "Ils ciblent les canaux Na+ axonaux."),
    ...
    qcm("Quels effets synaptiques ont les opioïdes μ ?", [
      ...
      it("Ils ouvrent systématiquement les canaux NMDA.", false, "Ils ne reposent pas sur une activation NMDA."),
    ...
    qcm("Quelles propositions concernent les anti-NMDA ?", [
      ...
      it("Ils augmentent l’entrée postsynaptique de Ca2+.", false, "Le blocage NMDA diminue au contraire le flux calcique dans le deuxième neurone."),
  ...
  { title: "Raisonnement multimodal", questions: [
    qcm("Quels principes définissent une analgésie multimodale raisonnée ?", [
      it("Associer des cibles complémentaires.", true, "Chaque classe interrompt un relais distinct."),
      it("Adapter la combinaison au mécanisme dominant.", true, "Inflammation, conduction et sensibilisation ne se traitent pas de façon identique."),
      it("Tenir compte des effets indésirables.", true, "Le terrain limite certaines classes."),
    ...
    qcm("Quelles cibles appartiennent à la périphérie ?", [
      it("Les cyclooxygénases.", true, "Les AINS réduisent la production de prostaglandines."),
      it("Les canaux sodiques axonaux.", true, "Les anesthésiques locaux interrompent la conduction."),
      it("Les médiateurs de la soupe inflammatoire.", true, "Ils activent et sensibilisent le nocicepteur."),
      it("Le cortex cingulaire uniquement.", false, "Il appartient aux réseaux centraux affectifs."),
      it("Les récepteurs NGF/Trk.", true, "Ils participent à la sensibilisation du nocicepteur."),
    ...
    qcm("Quelles cibles appartiennent à la synapse spinale ?", [
      ...
      it("Les récepteurs AMPA.", true, "Ils assurent la transmission excitatrice rapide."),
    ...
    qcm("Quels éléments favorisent la chronicisation d’une douleur aiguë ?", [
      ...
      it("Une sensibilisation centrale.", true, "La synapse devient durablement hyperexcitable."),
      it("Une douleur postopératoire sévère.", true, "Elle est associée au développement ultérieur de douleur chronique."),
    ...
    qcm("Quels réflexes évitent un raisonnement réducteur sur la douleur ?", [
      ...
      it("Rechercher une douleur référée devant un territoire trompeur.", true, "La convergence viscéro-somatique peut déplacer la perception."),
...
const DP_QCM = [
  {
    ...
    questions: [
      qcm("Quels éléments doivent guider la discussion initiale ?", [
        it("Les nocicepteurs existent déjà à ce terme.", true, "Ils apparaissent dès la 7e semaine et couvrent les surfaces vers la 20e."),
      ...
      qcm("Quelles structures périphériques sont activées par l’incision ?", [
        ...
        it("Une activation limitée aux motoneurones intercostaux.", false, "Les motoneurones commandent le geste moteur mais ne transduisent pas l’incision."),
      ...
      qcm("Quels mécanismes peuvent amplifier la douleur autour du drain ?", [
        it("La libération d’histamine et de bradykinine.", true, "Ces médiateurs sensibilisent le nocicepteur."),
        it("Le réflexe d’axone.", true, "Il étend l’inflammation aux tissus voisins."),
      ...
      qcm("Quels relais spinaux participent au message ?", [
        ...
        it("Le contrôle descendant.", true, "Il peut inhiber la transmission dans la corne dorsale."),
      ...
      qcm("Quels principes justifient une analgésie adaptée ?", [
        ...
        it("Ne rien traiter car le cortex est immature.", false, "Les connexions nécessaires peuvent déjà être fonctionnelles."),
  ...
  },
  {
    ...
    questions: [
      qcm("Quels mécanismes expliquent le tableau initial ?", [
        ...
        it("Une sensibilisation des nocicepteurs.", true, "Les médiateurs inflammatoires abaissent le seuil périphérique d’activation."),
      ...
      qcm("Quels médiateurs locaux sont plausibles ?", [
        ...
        it("Uniquement de l’acétylcholine motrice.", false, "Le tableau est dominé par des médiateurs inflammatoires."),
      ...
      qcm("Quels acteurs entretiennent l’extension de l’hypersensibilité ?", [
        it("La substance P.", true, "Elle est libérée par les nocicepteurs peptidergiques."),
      ...
      ], ["b00051", "b00052", "b00058", "b00059"], "Le réflexe d’axone, SP, CGRP et NGF étendent et entretiennent la sensibilisation.", "La douleur est maintenant provoquée par un contact léger autour de l’incision."),
      qcm("Quelle cible est cohérente pour réduire la composante inflammatoire ?", [
        ...
        it("Activer davantage NMDA.", false, "Cela favoriserait l’hyperexcitabilité centrale."),
      ...
      qcm("Quels risques doivent rester associés à l’inhibition de COX-1 ?", [
        ...
        it("Atteinte rénale.", true, "Les prostaglandines contribuent à l’hémodynamique rénale."),
      ...
      qcm("Quels signes feraient craindre une sensibilisation centrale ?", [
        ...
        it("Une activation répétée des récepteurs NMDA.", true, "Elle entretient l’amplification calcique."),
  ...
  },
  {
    ...
    questions: [
      ...
      qcm("Quelles voies transportent les afférences viscérales ?", [
        ...
        it("Uniquement les nerfs moteurs de l’épaule.", false, "La source du message est viscérale."),
      ...
      qcm("Quelles caractéristiques soutiennent une douleur viscérale ?", [
        ...
        it("Une somatotopie plus fine que la douleur cutanée.", false, "Elle est au contraire moins précise."),
      ...
      qcm("Quelles voies ascendantes peuvent contribuer au caractère déplaisant ?", [
        ...
        it("Uniquement le cortex moteur primaire.", false, "Il n’est pas la cible majeure de l’affect douloureux."),
      ...
      qcm("Quels éléments doivent être intégrés à l’évaluation ?", [
        ...
        it("Le contexte viscéral.", true, "Il donne sens à la projection somatique."),
        it("Les dimensions affective et autonome.", true, "Elles caractérisent la voie médiale."),
      ...
      qcm("Quelles interventions sont cohérentes avec une stratégie multimodale ?", [
        it("Traiter la cause viscérale.", true, "Réduire la stimulation périphérique supprime l’afflux causal."),
        it("Associer un antalgique non opioïde si approprié.", true, "Il complète la réduction de transduction."),
        ...
        it("Réévaluer la fonction et les signes abdominaux.", true, "La douleur est un indicateur de l’évolution viscérale."),
  ...
  },
  {
    ...
    questions: [
      ...
      qcm("Comment le récepteur NMDA devient-il actif ?", [
        it("Une stimulation répétée renforce la dépolarisation.", true, "L’activation AMPA répétée prépare l’ouverture."),
        it("Le bloc magnésium est levé.", true, "La levée du magnésium rend le canal NMDA perméable aux cations."),
        it("Le récepteur est phosphorylé.", true, "Cette modification favorise son activation."),
        it("Une entrée postsynaptique de calcium devient possible.", true, "Ce flux calcique déclenche des modifications soutenant la plasticité synaptique."),
        it("Le glutamate devient totalement absent.", false, "Il reste indispensable à la stimulation excitatrice."),
      ...
      qcm("Quels acteurs non neuronaux peuvent entretenir l’état ?", [
        ...
        it("Des astrocytes couplés aux neurones sensoriels.", true, "Leur interaction glio-neuronale participe au maintien du message."),
      ...
      qcm("Quelles classes ciblent directement cette synapse ?", [
        ...
        it("Les gabapentinoïdes.", true, "Ils réduisent le calcium et le glutamate présynaptiques."),
      ...
      ], ["b00080", "b00082", "b00084", "b00087"], "Anti-NMDA, gabapentinoïdes, opioïdes et α2 agissent sur des composantes distinctes de la synapse.", "L’équipe souhaite désormais cibler spécifiquement les mécanismes pré- et postsynaptiques responsables de l’hyperexcitabilité."),
      qcm("Quels principes corrigent l’échec d’une monothérapie ?", [
        ...
        it("Ignorer la tolérance et les contre-indications.", false, "Le bénéfice doit rester supérieur au risque."),
      ...
      qcm("Quels critères indiqueraient une amélioration mécanistique ?", [
        ...
        it("Une moindre douleur au contact léger.", true, "La réduction de l’allodynie traduit une normalisation du seuil central."),
  ...
  },
  {
    ...
    questions: [
      ...
      qcm("Quelles propriétés de l’anesthésique local sont exactes ?", [
        it("Il doit pénétrer dans la fibre.", true, "La cible du canal sodique est accessible depuis l’intérieur."),
        it("Il bloque les canaux sodiques.", true, "Le potentiel d’action ne peut plus se propager."),
      ...
      qcm("Quels messages seraient préférentiellement interrompus ?", [
        ...
        it("Uniquement la perception cognitive corticale.", false, "Le bloc agit en amont, sur la conduction."),
      ...
      qcm("Pourquoi maintenir d’autres antalgiques malgré le bloc ?", [
        ...
        it("Il faut obligatoirement associer tous les opioïdes forts.", false, "Le choix dépend du geste, du terrain et de la réponse."),
      ...
      qcm("Quels signes évoqueraient la levée du bloc ?", [
        ...
        it("Le retour d’une douleur localisée rapide.", true, "Les fibres Aδ redeviennent fonctionnelles."),
        ...
        it("La nécessité de réévaluer l’analgésie relais.", true, "Le traitement systémique doit couvrir la transition."),
      ...
      qcm("Quels principes assurent une transition sûre ?", [
        ...
        it("Réévaluer l’intensité et la fonction.", true, "La réponse antalgique et la mobilisation guident les ajustements du relais."),
        it("Conserver seulement les traitements utiles.", true, "Chaque composante doit garder une cible et un bénéfice clinique identifiables."),
        it("Ignorer les effets indésirables puisque le bloc est levé.", false, "La surveillance dépend des agents systémiques."),
        it("Informer la patiente de la levée attendue.", true, "L’éducation permet une prise précoce du relais."),
  ...
  },
  {
    ...
    questions: [
      qcm("Quels principes doivent précéder la prescription ?", [
        it("Identifier les cibles utiles.", true, "Chaque classe doit répondre à un mécanisme."),
        it("Intégrer le risque rénal et plaquettaire.", true, "Le terrain conditionne l’usage des AINS."),
        it("Prévoir une stratégie multimodale.", true, "Elle peut réduire la charge d’une classe unique."),
        it("Utiliser automatiquement un AINS à forte dose.", false, "Le risque rénal et plaquettaire impose la prudence."),
        it("Réévaluer après l’intervention.", true, "Efficacité et tolérance doivent être suivies."),
      ...
      qcm("Quels effets synaptiques explique la titration opioïde ?", [
        ...
        it("Davantage de sortie de K+ postsynaptique.", true, "La sortie potassique hyperpolarise le deuxième neurone et réduit son excitabilité."),
        it("Une stimulation de COX-2.", false, "Le récepteur μ module les canaux ioniques sans stimuler la cyclooxygénase."),
        it("Une activation de récepteurs μ couplés à Gi.", true, "La signalisation inhibitrice explique les effets."),
      ...
      qcm("Pourquoi éviter une escalade opioïde isolée ?", [
        it("Le signal inflammatoire périphérique persiste.", true, "L’opioïde ne supprime pas la source locale."),
        ...
        it("Le terrain âgé impose une surveillance accrue.", true, "L’objectif est une analgésie efficace et tolérée."),
      ...
      qcm("Quel ajustement correspond à cette douleur provoquée ?", [
        ...
        it("Utiliser une titration de secours mesurée.", true, "Elle cible le pic tout en évitant une exposition continue excessive."),
      ...
      qcm("Quelles conclusions résument la stratégie ?", [
        it("La cible pharmacologique ne suffit pas sans le terrain.", true, "Le risque peut contre-indiquer une classe pourtant mécanistiquement pertinente."),
        it("La multimodalité peut épargner les opioïdes.", true, "Conduction et perception sont traitées séparément."),
        it("La fonction guide autant que le score de douleur.", true, "La mobilisation teste l’efficacité réelle."),
  ...
  },
  {
    ...
    questions: [
      qcm("Quels éléments suggèrent une composante neuropathique et centrale ?", [
        ...
        it("Une douleur au toucher léger.", true, "L’allodynie suggère un seuil central abaissé."),
      ...
      qcm("Quels mécanismes peuvent suivre une lésion nerveuse ?", [
        ...
        it("Une libération répétée de glutamate.", true, "L’afflux entretient la synapse spinale."),
      ...
      qcm("Quelles cibles sont cohérentes pour cette composante ?", [
        it("Les canaux calciques de la terminaison primaire.", true, "Les gabapentinoïdes réduisent ainsi la libération de glutamate."),
        it("Les récepteurs NMDA postsynaptiques hyperactifs.", true, "Leur inhibition cible directement l’hyperexcitabilité centrale."),
        it("Les circuits inhibiteurs descendant vers la moelle.", true, "Renforcer ce contrôle peut diminuer le passage du message spinal."),
        it("Uniquement COX-1 plaquettaire.", false, "La douleur neuropathique ne se résume pas aux prostaglandines."),
        it("Les récepteurs opioïdes spinaux.", true, "Ils freinent la synapse mais ne constituent pas l’unique solution."),
      ...
      qcm("Comment agit un gabapentinoïde dans ce contexte ?", [
        it("Il réduit l’entrée de Ca2+ présynaptique.", true, "La modulation des canaux calciques diminue l’exocytose à la première synapse."),
        it("Il réduit la fusion des vésicules de glutamate.", true, "Moins de calcium limite l’exocytose."),
        ...
        it("Il cible un mécanisme central de transmission.", true, "La première synapse est sa cible majeure."),
      ...
      qcm("Quels éléments non pharmacologiques restent à intégrer ?", [
        ...
        it("L’absence de toute réévaluation.", false, "La réponse et les effets indésirables doivent être suivis."),
  ...
  },
  {
    ...
    questions: [
      qcm("Quelles propositions structurent l’évaluation initiale ?", [
        it("L’absence de parole n’exclut pas la douleur.", true, "La nociception et la perception ne dépendent pas du langage."),
        it("Les signes comportementaux sont pertinents.", true, "Grimaces et réactions aux soins renseignent l’expérience."),
        it("Les variations physiologiques doivent être contextualisées.", true, "Tachycardie et hypertension ne sont pas spécifiques."),
        it("La douleur est identique à la seule nociception.", false, "La perception comporte des dimensions affective et cognitive."),
        it("Il faut anticiper les gestes répétitifs.", true, "Ils créent un afflux nociceptif prévisible."),
      ], ["b00003", "b00004", "b00039"], "Chez le patient non communicant, comportement, contexte et réponse guident une prévention des gestes douloureux."),
      qcm("Quelles fibres participent au soin trachéal douloureux ?", [
        it("Les fibres Aδ pour la douleur rapide.", true, "Elles transmettent le stimulus aigu."),
        ...
        it("Les terminaisons libres de la muqueuse stimulée.", true, "Elles transduisent les composantes mécaniques et chimiques de l’aspiration."),
      ...
      qcm("Quels relais expliquent la réponse autonome et affective ?", [
        ...
        it("Uniquement le cervelet.", false, "Il n’est pas le réseau principal décrit ici."),
      ...
      qcm("Quels mécanismes pharmacologiques peuvent compléter cette prévention ?", [
        it("Un opioïde titré peut inhiber la synapse.", true, "Il réduit glutamate et hyperpolarise le deuxième neurone."),
        it("Un agoniste α2 peut hyperpolariser les circuits spinaux.", true, "Clonidine ou dexmédétomidine agissent sur la corne dorsale."),
        ...
        it("La combinaison doit être adaptée et surveillée.", true, "La multimodalité n’est pas automatique."),
      ...
      qcm("Quels critères comparent l’efficacité entre deux soins ?", [
        it("La diminution des grimaces.", true, "Le comportement est un indicateur direct chez ce patient."),
        it("Une moindre réponse cardiovasculaire.", true, "Elle soutient une meilleure tolérance si le contexte est stable."),
        it("Une récupération plus rapide après le geste.", true, "La diminution de l’agitation prolongée témoigne d’un meilleur contrôle du soin."),
      ...
      qcm("Quelles conclusions doivent guider la suite ?", [
        it("Anticiper chaque geste nociceptif.", true, "La répétition sans prévention favorise l’amplification."),
        it("Réévaluer même en l’absence de parole.", true, "Les indicateurs indirects permettent un suivi."),
        it("Préserver une stratégie multimodale proportionnée.", true, "Plusieurs cibles peuvent être utiles sans surtraiter."),
        it("Assimiler sédation et analgésie.", false, "La sédation ne garantit pas le contrôle nociceptif."),
        it("Documenter la réponse au protocole.", true, "La comparaison des soins permet d’ajuster la stratégie."),
