...
const ISOLATED_QCM = [
  {
    ...
    questions: [
      qcm("Quels éléments définissent ou orientent un arrêt cardiocirculatoire de l’adulte ?", [
        it("Une interruption brutale de la circulation.", true, "La disparition du débit sanguin efficace constitue le versant circulatoire de l’arrêt."),
        ...
        it("Des prodromes parfois utiles à l’enquête causale.", true, "Des symptômes précédant l’effondrement peuvent orienter vers l’étiologie responsable."),
      ...
      qcm("Comment classer correctement les rythmes initiaux d’un arrêt ?", [
        ...
        it("La tachycardie ventriculaire sans pouls est choquable.", true, "La TV sans circulation efficace suit la même branche thérapeutique que la FV."),
        ...
        it("L’activité électrique sans pouls est non choquable.", true, "Un tracé organisé sans circulation impose massage, adrénaline et recherche causale."),
      ...
      qcm("Quels constats épidémiologiques sont rapportés pour l’arrêt extrahospitalier ?", [
        it("La France compte environ 40 000 à 50 000 arrêts inopinés annuels.", true, "Cet ordre de grandeur souligne la fréquence de la mort subite de l’adulte."),
  ...
  },
  {
    ...
    questions: [
      qcm("Quels signes imposent de débuter la réanimation hors du bloc ?", [
        it("Une victime inconsciente qui ne respire pas.", true, "L’association inconscience et apnée suffit à considérer un arrêt et à agir."),
        ...
        it("Une absence de réaction associée à une respiration anormale.", true, "Ces deux éléments constituent la définition clinique pratique utilisée par le témoin."),
      ...
      qcm("Pourquoi la recherche du pouls n’est-elle pas centrale au diagnostic initial ?", [
        ...
        it("Elle peut être réalisée brièvement par un secouriste régulièrement entraîné.", true, "Cette possibilité est réservée aux professionnels familiers de la prise en charge."),
      ...
      qcm("Quels maillons composent la chaîne de survie ?", [
        ...
        it("La sortie immédiate sans soins post-arrêt.", false, "Les soins spécialisés après reprise constituent précisément le cinquième maillon."),
  ...
  },
  {
    ...
    questions: [
      ...
      qcm("Comment positionner et organiser les compressions chez l’adulte ?", [
        it("Placer les mains au centre du thorax sur le sternum inférieur.", true, "Cette position transmet efficacement la force au compartiment cardiaque central."),
      ...
      qcm("Quelle conduite ventilatoire convient à un témoin non entraîné ?", [
        it("Débuter des compressions seules sans attendre un masque.", true, "Cette stratégie réduit le no-flow et évite un bouche-à-bouche mal maîtrisé."),
  ...
  },
  {
    ...
    questions: [
      ...
      qcm("Quels réglages et matériels sont recommandés pour le choc ?", [
        ...
        it("Une énergie monophasique de 360 J si nécessaire.", true, "Cette énergie compense la moindre efficacité du courant monophasique."),
      ...
      qcm("Comment placer les électrodes en position antérolatérale ?", [
        it("L’électrode droite se place sous la clavicule près du sternum.", true, "Cette position dirige le vecteur électrique depuis la région sous-claviculaire droite."),
        it("L’électrode gauche se place sur la ligne axillaire moyenne.", true, "Elle se situe latéralement au sein gauche pour traverser la masse ventriculaire."),
      ...
      qcm("Quelle séquence suit un choc unique en situation habituelle ?", [
        it("Reprendre immédiatement les compressions thoraciques.", true, "Le délai de récupération mécanique justifie un massage sans contrôle préalable du pouls."),
      ...
      qcm("Dans quelles circonstances la stratégie électrique diffère-t-elle ?", [
        ...
        it("La présence d’un DAE auprès du témoin favorise un choc très précoce.", true, "Si le rythme est choquable et le DAE immédiatement disponible, il doit être utilisé sans délai."),
  ...
  },
  {
    ...
    questions: [
      qcm("Comment hiérarchiser les voies d’administration pendant l’arrêt ?", [
        ...
        it("La voie centrale est obligatoire avant toute adrénaline.", false, "Sa pose est plus longue et ne se discute qu’après l’échec des accès simples."),
      ...
      qcm("Quelles affirmations décrivent l’adrénaline pendant l’arrêt ?", [
        ...
        it("Elle peut améliorer le débit sanguin cérébral produit par le massage.", true, "La redistribution du flux soutient les organes vitaux pendant le low-flow."),
        it("La dose recommandée est de 1 mg toutes les 3 à 5 minutes.", true, "Cette périodicité correspond approximativement à deux cycles de réanimation."),
      ...
      qcm("Comment utiliser les antiarythmiques dans une FV ou TV réfractaire ?", [
        it("Administrer 300 mg d’amiodarone après trois chocs.", true, "Le troisième échec électrique définit le moment du premier bolus antiarythmique."),
        ...
        it("Poursuivre éventuellement par 900 mg sur vingt-quatre heures.", true, "La perfusion entretient l’effet après les bolus de réanimation."),
      ...
      qcm("Quels traitements ont des indications étiologiques limitées ?", [
        ...
        it("L’atropine est administrée en routine dans toute AESP.", false, "Aucune utilisation systématique de l’atropine n’est recommandée pendant l’arrêt."),
      ...
      ], ["b00056", "b00058", "b00060", "b00062"], "Magnésium, bicarbonate et fibrinolyse ne sont utiles qu’en présence d’une cible précise ; l’atropine ne fait pas partie du traitement routinier."),
    ],
  },
  {
    ...
    questions: [
      ...
      qcm("Quels réglages ventilatoires sont décrits pendant l’arrêt intubé ?", [
        ...
        it("Une PEP nulle pendant les compressions.", true, "L’absence de pression expiratoire positive favorise le retour veineux."),
      ...
      qcm("Comment interpréter l’EtCO₂ au cours d’une réanimation prolongée ?", [
        ...
        it("La valeur est indépendante de la fréquence ventilatoire.", false, "Une hyperventilation abaisse l’EtCO₂ sans nécessairement modifier le débit circulatoire."),
      ...
      ], "b00099", "L’EtCO₂ possède une valeur dynamique et pronostique, mais son analyse doit intégrer ventilation et médicaments avant toute décision."),
    ],
  },
  {
    ...
    questions: [
      ...
      qcm("Quelles causes appartiennent aux quatre H ?", [
        ...
        it("Une tamponnade péricardique.", false, "La tamponnade appartient au groupe des quatre T mécaniques."),
      ...
      qcm("Quelles causes appartiennent aux quatre T ?", [
        ...
        it("Un pneumothorax sous tension.", true, "La surpression intrathoracique bloque le retour veineux et exige une décompression."),
      ...
      qcm("Quel rôle attribuer à l’échographie pendant l’arrêt ?", [
        ...
        it("Suggérer un pneumothorax suffocant.", true, "L’analyse thoracique peut contribuer au diagnostic d’une cause obstructive réversible."),
  ...
  },
  {
    ...
    questions: [
      qcm("Quels éléments peuvent justifier une réanimation prolongée et une ECLS ?", [
        ...
        it("Des mouvements spontanés pendant les compressions.", true, "Ces signes de vie suggèrent une perfusion neurologique encore compatible avec une récupération."),
      ...
      qcm("Comment encadrer une décision d’arrêt de la réanimation ?", [
        ...
        it("Trente minutes constituent une règle absolue dans tous les contextes.", false, "Le seuil n’est ni universel ni applicable de la même façon en hypothermie."),
      ...
      qcm("Quels mécanismes participent au syndrome neurologique post-arrêt ?", [
        ...
        it("Une protection garantie par l’hyperthermie.", false, "L’hyperthermie est au contraire particulièrement délétère après un arrêt."),
      ], "b00109", "La reperfusion sauve les organes mais déclenche stress oxydatif, inflammation et excitotoxicité, justifiant une neuroprotection post-arrêt structurée."),
...
const DP_QCM = [
  {
    ...
    questions: [
      qcm("Quelles actions doivent être entreprises sans attendre ?", [
        ...
        it("Déclencher l’alerte et demander le DAE.", true, "Alerte et défibrillation constituent deux maillons précoces de la chaîne."),
      ...
      qcm("Quels paramètres caractérisent le massage initial ?", [
        ...
        it("Une pause de quinze secondes toutes les minutes.", false, "Des interruptions répétées font chuter la perfusion coronaire acquise."),
      ...
      qcm("Comment utiliser le défibrillateur dans cette situation ?", [
        ...
        it("Délivrer le choc proposé après avoir dégagé le patient.", true, "La sécurité électrique impose qu’aucun sauveteur ne touche la victime."),
      ...
      qcm("Quels gestes suivent le premier choc ?", [
        ...
        it("Préparer l’accès vasculaire sans ralentir le massage.", true, "Les traitements avancés se préparent parallèlement aux gestes de base."),
      ...
      qcm("Quels traitements deviennent indiqués après ce nouvel échec ?", [
        it("Un troisième choc à l’énergie recommandée.", true, "La persistance de la FV justifie une nouvelle tentative électrique."),
        ...
        it("Trois cents milligrammes d’amiodarone.", true, "Le premier bolus antiarythmique est recommandé après trois CEE inefficaces."),
      ...
      qcm("Quels éléments orientent maintenant le traitement de la cause ?", [
        it("Un syndrome coronarien aigu doit être suspecté.", true, "Il constitue la cause la plus fréquente d’arrêt extrahospitalier chez l’adulte."),
        it("Une échographie peut rechercher une cause mécanique réversible.", true, "L’examen focalisé explore tamponnade, embolie ou hypovolémie sans longue pause."),
      ...
      ], ["b00072", "b00088", "b00094", "b00095"], "La FV réfractaire impose une enquête parallèle : cause coronaire en tête, échographie ciblée et revue systématique des 4 H et 4 T.", "Une activité organisée réapparaît avec une hausse brutale de l’EtCO₂ et un pouls central."),
      qcm("Quelles priorités suivent cette reprise circulatoire ?", [
        it("Adapter la FiO₂ pour viser 94 à 98 % de SpO₂.", true, "L’hyperoxie peut majorer les lésions de reperfusion cérébrale."),
        it("Éviter l’hyperthermie par une cible de 34 à 36 °C.", true, "Le contrôle thermique participe à la neuroprotection post-arrêt."),
        it("Organiser une coronarographie en l’absence de cause extracardiaque.", true, "Une origine coronaire reste probable même si l’ECG est peu démonstratif."),
  ...
  },
  {
    ...
    questions: [
      qcm("Quelles particularités guident les premiers gestes ?", [
        ...
        it("Les compressions thoraciques restent indispensables.", true, "Une ventilation isolée ne crée aucun débit vers le cerveau et le cœur."),
        ...
        it("Un intervenant entraîné peut associer bouche-à-bouche ou ballon.", true, "La ventilation fait partie des gestes de base lorsque la cause est respiratoire."),
      ...
      qcm("Comment ventiler avant une voie aérienne avancée ?", [
        ...
        it("Dépasser 1 000 mL à chaque insufflation.", false, "Le volume recommandé se limite à environ 400–600 mL chez l’adulte."),
      ...
      qcm("Comment obtenir un accès médicamenteux sans interrompre la réanimation ?", [
        ...
        it("Passer à l’intraosseux si l’accès veineux est retardé.", true, "La voie osseuse évite une perte de temps chez une patiente vasoconstrictée."),
      ...
      qcm("Quels paramètres ventilatoires utiliser après intubation ?", [
        ...
        it("Une PEP élevée obligatoire à 15 cmH₂O.", false, "Une PEP nulle est recommandée durant les compressions."),
      ...
      qcm("Quels signes peuvent soutenir une prolongation des efforts ?", [
        it("Une durée d’immersion brève et témoin.", true, "Le no-flow potentiellement court rend une récupération neurologique plus plausible."),
      ...
      qcm("Quels soins suivent une reprise circulatoire dans ce contexte ?", [
        ...
        it("Réchauffer brutalement au-delà de 38 °C.", false, "La cible thermique post-arrêt reste contrôlée entre 34 et 36 °C."),
  ...
  },
  {
    ...
    questions: [
      ...
      qcm("Quelles actions traiteront simultanément le débit et la cause ?", [
        ...
        it("Poursuivre la chirurgie avant de rétablir l’oxygénation.", false, "L’intervention non causale doit cesser pendant la réanimation."),
      ...
      ], ["b00020", "b00074", "b00075"], "Le traitement associe immédiatement massage, oxygénation et sauvetage des voies aériennes, avec un leadership qui maintient la continuité des gestes." , "L’équipe annonce l’arrêt, interrompt l’acte et répartit les postes de massage, voie aérienne et médicaments."),
      qcm("Quels dispositifs et contrôles sont adaptés à la voie aérienne ?", [
        it("Un masque laryngé peut fournir rapidement une ventilation.", true, "Sa mise en place simple offre une solution transitoire en cas d’intubation difficile."),
        ...
        it("L’intubation ne doit pas interrompre le massage plus de cinq secondes.", true, "La pause nécessaire doit rester exceptionnellement brève."),
      ...
      qcm("Quelle conduite adopter vis-à-vis de la chirurgie ?", [
        ...
        it("Poursuivre uniquement si le geste traite directement la cause.", true, "Une réparation vasculaire hémostatique représenterait une exception justifiée."),
      ...
      qcm("Quels examens et objectifs sont prioritaires après la reprise ?", [
        ...
        it("Maintenir une PEP nulle indéfiniment après stabilisation.", false, "La PEP nulle est un réglage de la phase de massage, pas une règle post-arrêt permanente."),
  ...
  },
  {
    ...
    questions: [
      ...
      qcm("Comment utiliser l’accès intraosseux obtenu ?", [
        ...
        it("Il est approprié après échec ou retard d’une voie périphérique.", true, "La vasoconstriction rend souvent l’abord veineux difficile pendant l’arrêt."),
      ...
      qcm("Quels traitements médicamenteux sont cohérents avec la cause suspectée ?", [
        ...
        it("Une dose de 0,5 mmol/kg peut suivre après dix minutes.", true, "Cette seconde administration dépend de la persistance de l’indication."),
      ...
      qcm("Quels éléments peuvent être évalués sans ralentir le massage ?", [
        it("Une échographie ciblée pendant une pause déjà prévue.", true, "L’examen peut rechercher une autre cause mécanique sans pause additionnelle."),
        it("L’EtCO₂ pour apprécier le débit produit par les compressions.", true, "La capnométrie reste le suivi circulatoire le plus pertinent sous massage."),
      ...
      qcm("Quels critères soutiendraient une assistance extracorporelle ?", [
        ...
        it("Une asystolie prolongée sans aucun signe de vie comme critère favorable.", false, "Ce tableau isolé ne soutient pas un bon pronostic neurologique."),
      ...
      qcm("Quels objectifs suivent une reprise circulatoire obtenue après correction ?", [
        ...
        it("Négliger la température parce que la cause est métabolique.", false, "La prévention de l’hyperthermie s’applique quelle que soit l’étiologie."),
  ...
  },
  {
    ...
    questions: [
      qcm("Quels éléments initiaux concordent avec une AESP obstructive ?", [
        ...
        it("Une thrombose pulmonaire parmi les quatre T.", true, "L’embolie massive bloque brutalement le débit pulmonaire et le remplissage gauche."),
        it("Une indication immédiate à défibriller le tracé organisé.", false, "L’AESP ne relève pas du choc en l’absence de FV ou TV."),
        it("Une adrénaline précoce avec compressions continues.", true, "La branche non choquable associe vasopresseur et massage de qualité."),
      ...
      qcm("Quelle stratégie étiologique est justifiée ?", [
        ...
        it("Maintenir simultanément l’algorithme non choquable.", true, "Adrénaline, ventilation et massage restent nécessaires pendant l’action du traitement."),
      ...
      qcm("Quels paramètres surveiller pendant la réanimation prolongée ?", [
        it("L’EtCO₂ pour suivre le débit créé par les compressions.", true, "Une valeur soutenue reflète indirectement une perfusion pulmonaire utile."),
        it("Une hausse brutale d’EtCO₂ comme signe de reprise.", true, "Le retour circulatoire relargue le CO₂ accumulé vers les poumons."),
      ...
      qcm("Quels éléments peuvent faire discuter une assistance circulatoire ?", [
        ...
        it("Une absence totale de moyens de traitement causal.", false, "L’ECLS se justifie surtout si une cause peut être corrigée."),
      ...
      qcm("Comment interpréter une reprise circulatoire tardive ?", [
        it("Elle ne met pas fin au risque neurologique.", true, "Une longue ischémie-reperfusion expose à des lésions secondaires majeures."),
      ...
      qcm("Quelles complications et décisions doivent être anticipées ensuite ?", [
        ...
        it("Reporter toute surveillance parce que le pouls est revenu.", false, "Le syndrome post-arrêt exige au contraire une observation intensive."),
  ...
  },
  {
    ...
    questions: [
      ...
      qcm("Quels traitements deviennent pertinents après le cinquième choc ?", [
        ...
        it("La poursuite de l’adrénaline toutes les 3 à 5 minutes.", true, "Le vasopresseur est répété au fil des cycles tant que l’arrêt persiste."),
      ...
      qcm("Pourquoi discuter rapidement une ECLS ?", [
        ...
        it("La FV réfractaire interdit toute assistance mécanique.", false, "Elle constitue au contraire un scénario possible d’ECLS de sauvetage."),
      ...
      qcm("Quels moyens facilitent le transfert sous réanimation ?", [
        ...
        it("Une voie intraosseuse peut suppléer un accès veineux perdu.", true, "Elle fournit rapidement un accès fiable sans procédure centrale complexe."),
  ...
  },
  {
    ...
    questions: [
      ...
      qcm("Comment limiter l’impact circulatoire de la tentative ?", [
        ...
        it("Limiter une pause indispensable à moins de cinq secondes.", true, "Une brève fenêtre peut suffire au passage sans perdre la perfusion acquise."),
        ...
        it("Utiliser un supraglottique en cas de difficulté.", true, "Le masque laryngé offre une ventilation rapide sans laryngoscopie répétée."),
      ...
      qcm("Quels signes valident la sonde finalement posée ?", [
        ...
        it("Une SpO₂ inchangée pendant dix secondes comme preuve suffisante.", false, "La réserve d’oxygène peut masquer transitoirement une intubation incorrecte."),
      ...
      qcm("Que signifie une EtCO₂ restant à 7 mmHg après vingt minutes ?", [
        it("Elle représente un élément pronostique défavorable.", true, "Une valeur durablement inférieure à 10 mmHg est associée à une faible survie."),
        it("Elle impose de vérifier la qualité des compressions.", true, "Une profondeur ou un recoil insuffisants peuvent réduire le débit pulmonaire."),
      ...
      qcm("Quels indices modifieraient l’interprétation pronostique ?", [
        ...
        it("Une asystolie persistante sans aucun signe de vie.", false, "Ce tableau ajoute au contraire un critère défavorable."),
  ...
  },
  {
    ...
    questions: [
      qcm("Quels mécanismes neurologiques doivent être anticipés ?", [
        it("Une cascade d’ischémie-reperfusion.", true, "Le retour du débit déclenche des lésions secondaires après la privation initiale."),
      ...
      qcm("Quelle stratégie thermique convient ?", [
        it("Prévenir activement toute hyperthermie.", true, "La température élevée aggrave les lésions neurologiques après l’arrêt."),
        ...
        it("Surveiller la température de façon continue.", true, "Une cible thérapeutique exige mesure fiable et prévention des variations."),
      ...
      qcm("Quel bilan biologique doit être obtenu ?", [
        ...
        it("Une numération sanguine.", true, "Elle évalue anémie, hémoconcentration et anomalies associées."),
        it("Des gaz du sang avec lactate.", true, "Ils apprécient échanges, acidose et dette d’oxygène."),
      ...
      qcm("Quelle stratégie coronaire faut-il envisager ?", [
        it("Suspecter un syndrome coronarien aigu en l’absence de cause extracardiaque.", true, "Il demeure la cause la plus fréquente d’arrêt extrahospitalier."),
        it("Réaliser un ECG après la reprise.", true, "Le tracé participe au bilan sans posséder une sensibilité parfaite."),
      ...
      qcm("Quelles informations structurent la communication avec les proches ?", [
        ...
        it("Décrire le traitement de la cause coronaire.", true, "La famille doit comprendre la raison de la coronarographie et de la surveillance."),
      ...
      ], ["b00107", "b00109"], "La communication reste prudente, factuelle et accompagnante : elle distingue reprise du pouls, traitement causal et incertitude neurologique initiale." , "La famille arrive et demande si le retour du cœur signifie que la patiente va se réveiller normalement."),
    ],
  },
];
