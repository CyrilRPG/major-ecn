    ...
    questions: [
      qcm(
        ...
        [
          ...
          T(
            "Elle doit être active dès l’incision.",
            "La contamination peut commencer avec l’ouverture du site.",
          ),
          T(
      ...
      qcm(
        ...
        [
          T(
            ...
            "L’ouverture contrôlée d’un appareil colonisé expose à un risque supérieur au seuil prophylactique.",
          ),
          T(
      ...
      qcm(
        ...
        [
          T("Classe ASA.", "Elle résume la gravité du terrain préopératoire."),
          F(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Normothermie maintenue.",
            "La normothermie appartient aux mesures protectrices.",
          ),
          T(
      ...
      qcm(
        ...
        [
          T(
            "Préparation cutanée adaptée.",
            "Elle réduit la charge microbienne au point d’incision.",
          ),
          T(
    ...
    questions: [
      qcm(
        ...
        [
          ...
          F(
            "Bacteroides comme flore cutanée dominante.",
            "Bacteroides caractérise surtout la flore digestive distale.",
          ),
          T(
            "Micrococcus.",
      ...
      qcm(
        ...
        [
          T("Streptocoques.", "Ils sont abondants dans la flore orale."),
          F(
      ...
      qcm(
        ...
        [
          T(
            "L’estomac possède une flore relativement pauvre.",
            "Son acidité limite la densité bactérienne.",
          ),
          T(
            "Le grêle contient de nombreuses entérobactéries.",
            "Elles y sont largement représentées avec streptocoques et entérocoques.",
          ),
          F(
      ...
      qcm(
        ...
        [
          T(
            "Les entérobactéries occupent une part importante.",
            "Elles représentent une composante majeure de l’ensemble des ISO.",
          ),
          F(
    ...
    questions: [
      qcm(
        ...
        [
          ...
          F(
            "Usage curatif massif dans le même service.",
            "Une forte utilisation thérapeutique favorise des résistances compromettant la prophylaxie.",
          ),
        ],
      ),
      qcm(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Documenter une allergie alléguée.",
            "La nature de la réaction guide l’alternative.",
          ),
          F(
  ...
  },
  {
    ...
    questions: [
      qcm(
        ...
        [
          T(
            "Injection 30 à 60 minutes avant l’incision.",
            "Cette fenêtre minimise le risque d’une concentration insuffisante au début du geste.",
          ),
          F(
      ...
      qcm(
        ...
        [
          T(
            "Échéance toutes les deux demi-vies.",
            "Ce délai anticipe la baisse de concentration tissulaire.",
          ),
          T(
            "Calcul depuis l’heure de première injection.",
            "L’incision ne constitue pas le point de départ pharmacocinétique.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          T(
            ...
            "Sa demi-vie de 2 heures conduit à ce délai.",
          ),
        ],
      ),
      qcm(
        ...
        [
          ...
          F(
            "La césarienne ne nécessite jamais de prophylaxie.",
            "Il s’agit au contraire d’une indication organisée par des recommandations.",
          ),
        ],
      ),
    ],
    ...
    questions: [
      qcm(
        ...
        [
          ...
          F(
            "Infection profonde confirmée avec pus.",
            "Cette situation nécessite un traitement curatif, non une prophylaxie prolongée.",
          ),
        ],
      ),
      qcm(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Considérer le portage comme une infection active.",
            "Colonisation et infection sont deux états différents.",
          ),
        ],
      ),
      qcm(
        ...
        [
          T(
            "Vancomycine si SARM, ouverture cutanée et prothèse.",
            "Le réservoir cutané est alors directement lié au risque de contamination du matériel.",
          ),
          F(
      ...
      qcm(
        ...
        [
          T(
            "Une dose unique suffit souvent pour un geste court.",
            "La durée d’exposition reste couverte sans rappel inutile.",
          ),
          F(
    ...
    questions: [
      qcm(
        ...
        [
          ...
          F(
            "Il ne présente aucun lien avec le portage cutané.",
            "L’importance du portage cutané suit celle du réservoir nasal.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Cure de cinq jours.",
            "Ce schéma permet l’éradication décrite du portage.",
          ),
          F(
          ...
          T(
            "Activité surtout sur les bactéries à Gram positif.",
            "Son spectre correspond notamment au staphylocoque doré.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Chirurgie digestive comme indication la plus spécifique.",
            "Gram négatif et anaérobies y limitent une stratégie centrée sur S. aureus.",
          ),
        ],
      ),
      qcm(
        ...
        [
          ...
          F(
            "Efficacité identique dans toutes les spécialités.",
            "La flore exposée modifie fortement l’efficacité attendue.",
          ),
        ],
      ),
      qcm(
        ...
        [
          T(
            "La préparation colique isolée n’a pas montré d’efficacité.",
            "Vider mécaniquement le côlon ne suffit pas à réduire les ISO.",
          ),
          T(
          ...
          T(
            "La littérature reste controversée.",
            "Le poids des cointerventions et le faible nombre d’études isolées limitent la certitude.",
          ),
        ],
      ),
    ],
    ...
    questions: [
      qcm(
        ...
        [
          ...
          T(
            ...
            "Une récidive serait particulièrement grave.",
          ),
          F(
          ...
          T(
            ...
            "Cette cardiopathie congénitale est incluse dans les indications.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Brossage dentaire quotidien encadré.",
            "Il ne constitue pas un geste chirurgical concerné par ce protocole.",
          ),
        ],
      ),
      qcm(
        ...
        [
          ...
          T(
            "Amoxicilline 2 g par voie intraveineuse.",
            "Cette voie est une alternative si la prise orale est impossible.",
          ),
          F(
          ...
          F(
            "Vancomycine systématique chez tous les patients.",
            "Le spectre large n’est pas le schéma standard de cette indication.",
          ),
        ],
      ),
      qcm(
      ...
      qcm(
        ...
        [
          T(
            "La cardiopathie à haut risque est un critère nécessaire.",
            "Sans terrain concerné, le protocole d’endocardite ne s’applique pas.",
          ),
          T(
          ...
          T(
            "Une chirurgie non dentaire reprend le protocole opératoire usuel.",
            "La prévention d’ISO reste distincte de celle de l’endocardite.",
          ),
          F(
    ...
    questions: [
      qcm(
        ...
        [
          ...
          F(
            "Couleur des murs du bloc sans lien avec l’asepsie.",
            "Cet élément n’évalue pas la prescription antibiotique.",
          ),
        ],
      ),
      qcm(
        ...
        [
          ...
          T(
            "Évaluation de 2 082 procédures.",
            "Le volume permettait une mesure nationale structurée.",
          ),
          T(
...
const DP_QCM = [
  {
    ...
    questions: [
      qcm(
        ...
        [
          ...
          F(
            ...
            "Elle confirme le cadre prophylactique sans supprimer l’indication liée à la prothèse.",
          ),
        ],
      ),
      qcm(
        ...
        [
          T(
            "Achever la perfusion avant le garrot.",
            "La diffusion tissulaire doit précéder l’ischémie du membre.",
          ),
          T(
      ...
      qcm(
        ...
        [
          T(
            "Atteinte de quatre heures depuis la première dose.",
            "Le tableau fixe le rappel de céfazoline à cet intervalle.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Conclusion que toute prothèse exige une semaine d’antibiotique.",
            "Cette généralisation contredit le principe de durée minimale.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Étiquette d’allergie à la céfazoline sans réaction.",
            "Aucun événement hypersensible n’est survenu.",
          ),
        ],
    ...
    questions: [
      qcm(
        ...
        [
          ...
          F(
            "Supposer d’emblée une allergie à toutes les bêta-lactamines.",
            "La réactivité croisée dépend des molécules et de la réaction réelle.",
          ),
        ],
      ),
      qcm(
        ...
        [
          T(
            "L’allergie IgE immédiate devient peu probable.",
            "Le délai de plusieurs jours et l’absence de signes systémiques sont défavorables à ce mécanisme.",
          ),
          T(
            "Une réaction virale est plausible.",
            "La mononucléose associée à l’amoxicilline peut produire une éruption non IgE.",
          ),
          F(
      ...
      qcm(
        ...
        [
          T(
            "La chaîne latérale R1 est déterminante.",
            "Des chaînes similaires peuvent partager des épitopes reconnus.",
          ),
          F(
          ...
          T(
            "Les anciens taux étaient probablement surestimés.",
            "Les premières céphalosporines pouvaient être contaminées par des pénicillines.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Anaérobies coliques.",
            "Ils prédominent dans le côlon et le rectum.",
          ),
          F(
      ...
      qcm(
        ...
        [
          T(
            "Finir l’injection avant l’incision.",
            "La concentration protectrice doit être présente lors de l’ouverture colique.",
          ),
          T(
            "Respecter la fenêtre de 30 à 60 minutes.",
            "Elle correspond au délai associé au plus faible taux d’ISO.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Étiqueter sans nuance toutes les céphalosporines.",
            "L’imputabilité et la structure de la molécule doivent être analysées.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Chronologie de l’urticaire.",
            "Le délai par rapport à la perfusion soutient l’imputabilité.",
          ),
          T(
    ...
    questions: [
      qcm(
        ...
        [
          ...
          T(
            "Maintien de l’exposition jusqu’à midi.",
            "La fermeture marque la fin du besoin préventif.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Avant que la concentration ne devienne insuffisante.",
            "Le rappel préserve la couverture tissulaire.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Une dose choisie selon l’heure d’incision.",
            "L’intervalle est rattaché à l’administration précédente.",
          ),
          T(
      ...
      qcm(
        ...
        [
          T(
            "Sous-concentration au site opératoire.",
            "Quatre heures dépassent largement les deux demi-vies prévues.",
          ),
          T(
          ...
          T(
            "Écart de pratique à analyser.",
            "L’absence de dose à l’échéance prescrite signale une défaillance du processus de rappel peropératoire.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Demi-vie intrinsèquement imprévisible de toute molécule.",
            "Le tableau fournit précisément un rythme utilisable.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Prolongation de tous les patients pendant 48 heures.",
            "Cette compensation crée une pression de sélection sans corriger le défaut peropératoire.",
          ),
        ],
    ...
    questions: [
      qcm(
        ...
        [
          ...
          F(
            "Infection sanguine déjà prouvée.",
            "Le patient est colonisé sans infection active.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Traitement curatif de plusieurs semaines d’emblée.",
            "Le portage n’est pas une infection.",
          ),
          T(
      ...
      qcm(
        ...
        [
          T(
            "Dose calculée sur le poids réel.",
            "La vancomycine fait partie des molécules toujours adaptées au poids réel.",
          ),
          T(
      ...
      qcm(
        ...
        [
          T(
            "Arrêt de la prophylaxie après le geste.",
            "La contamination opératoire est terminée.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Souche résistante à la mupirocine.",
            "Ces résistances rares peuvent provoquer un échec d’éradication.",
          ),
          T(
            "Écouvillonnage de contrôle encore positif.",
            "Il objective la persistance du réservoir.",
          ),
          F(
  ...
  },
  {
    ...
    questions: [
      qcm(
        ...
        [
          T(
            "Réduction des complications maternelles.",
            "Le bénéfice est rapporté lorsque la prophylaxie précède l’incision.",
          ),
          T(
            "Absence de modification démontrée du devenir de l’enfant.",
            "Les études citées ne montrent pas de signal défavorable néonatal.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Avec heure de fin d’injection tracée.",
            "La conformité du timing doit être vérifiable.",
          ),
          F(
      ...
      qcm(
        ...
        [
          T(
            "Meilleure imputabilité d’une réaction.",
            "La chronologie distingue antibiotique et produits anesthésiques.",
          ),
          T(
            "Possibilité de traiter avant l’induction si réaction.",
            "Une réaction détectée chez une patiente éveillée est plus facilement caractérisée.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Poursuivre la perfusion pour finir avant l’incision.",
            "La sécurité maternelle prime sur le timing prophylactique.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Absence de prophylaxie par principe.",
            "La césarienne conserve son indication préventive.",
          ),
          T(
      ...
      qcm(
        ...
        [
          T(
            "Proportion de doses données avant incision.",
            "Elle mesure l’abandon effectif de l’ancien dogme.",
          ),
          T(
  ...
  },
  {
    ...
    questions: [
      qcm(
        ...
        [
          T(
            "Valve mécanique prothétique.",
            "Elle appartient aux cardiopathies à haut risque.",
          ),
          T(
      ...
      qcm(
        ...
        [
          T(
            ...
            "La dose et la voie correspondent au protocole décrit.",
          ),
          F(
          ...
          T(
            "Administration avant le geste.",
            "L’exposition doit précéder la bactériémie dentaire.",
          ),
          F(
      ...
      qcm(
        ...
        [
          T(
            ...
            "Elle ne provoque pas de bactériémie par effraction muqueuse.",
          ),
          T(
            "Empreinte dentaire atraumatique.",
            "Aucune manipulation des zones à risque n’est prévue.",
          ),
          F(
      ...
      qcm(
        ...
        [
          T(
            "Clindamycine 600 mg par voie orale.",
            "Cette voie est possible si la prise digestive est conservée.",
          ),
          T(
            "Clindamycine 600 mg intraveineuse.",
            "La voie IV est une alternative si l’oral est impossible.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          T(
            ...
            "Un signe cardiaque nouveau peut évoquer une endocardite.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Consigne de prendre des antibiotiques chaque jour.",
            "La prophylaxie est ponctuelle et liée au geste.",
          ),
        ],
    ...
    questions: [
      ...
      qcm(
        ...
        [
          T(
            ...
            "L’efficacité dépend du nombre d’applications.",
          ),
          T(
          ...
          T(
            "Début suffisamment précoce avant le geste.",
            "La cure complète doit être réalisable.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          T(
            "La chlorhexidine peut réduire la charge cutanée.",
            "Elle agit sur un autre réservoir pertinent pour l’incision.",
          ),
          F(
          ...
          T(
            "Le résultat global peut refléter une synergie.",
            "Les deux mesures peuvent contribuer ensemble.",
          ),
          F(
      ...
      qcm(
        ...
        [
          T(
            "Applications oubliées.",
            "Le taux d’éradication dépend du nombre de doses locales.",
          ),
          T(
            "Résistance de la souche à la mupirocine.",
            "Elle peut être responsable d’un échec microbiologique.",
          ),
          T(
      ...
      qcm(
        ...
        [
          T(
            "Vérifier l’antibiogramme et la sensibilité topique.",
            "Un échec peut traduire une résistance.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Supposer une rentabilité identique pour toute chirurgie.",
            "Les modèles ne la retrouvent que dans des indications sélectionnées.",
          ),
          T(
      ...
      qcm(
        ...
        [
          T(
            "Proportion de patients réellement dépistés.",
            "Le protocole ciblé dépend de l’identification préalable des porteurs.",
          ),
          T(
  ...
  },
  {
    ...
    questions: [
      qcm(
        ...
        [
          T(
            "Les drains ne prolongent pas l’indication.",
            "Leur présence ne justifie pas une couverture continue.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Durée moyenne la plus longue possible.",
            "Une durée accrue n’est pas un objectif de qualité.",
          ),
        ],
      ...
      qcm(
        ...
        [
          T(
            "Ordre prophylactique avec arrêt automatique.",
            "La durée minimale devient le comportement par défaut.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Objectif d’augmenter les durées curatives sans infection.",
            "La correction vise précisément l’inverse.",
          ),
          T(
...
const QCM_BALANCE_OVERRIDES = Object.freeze({
  "0B": {
    "is_correct": false,
    "enonce": "Elle traite seule une infection déjà collectée ; Elle doit être active dès l’incision.",
    "justification": "Une infection constituée relève d’une antibiothérapie curative. La contamination peut commencer avec l’ouverture du site."
  },
  "1A": {
    "is_correct": false,
    "enonce": "Péritonite par perforation digestive ; Chirurgie propre-contaminée.",
    "justification": "La contamination et l’infection dépassent le cadre préventif. L’ouverture contrôlée d’un appareil colonisé expose à un risque supérieur au seuil prophylactique."
  },
  "2A": {
    "is_correct": false,
    "enonce": "Âge civil pris isolément ; Classe ASA.",
    "justification": "L’âge n’est pas l’un des trois paramètres constitutifs du score. Elle résume la gravité du terrain préopératoire."
  },
  "3D": {
    "is_correct": true,
    "enonce": "Vascularisation locale perturbée ; Défenses immunitaires locales altérées.",
    "justification": "Une perfusion diminuée réduit les défenses et la diffusion antibiotique. Le traumatisme opératoire dérègle la réponse locale."
  },
  "4A": {
    "is_correct": false,
    "enonce": "Hyperglycémie peropératoire tolérée ; Préparation cutanée adaptée.",
    "justification": "Le contrôle glycémique fait partie des mesures de prévention. Elle réduit la charge microbienne au point d’incision."
  },
  "5D": {
    "is_correct": true,
    "enonce": "Staphylocoques à coagulase négative ; Corynébactéries.",
    "justification": "Ils font partie des commensaux cutanés usuels. Ces bacilles à Gram positif colonisent fréquemment la peau."
  },
  "6A": {
    "is_correct": false,
    "enonce": "Flore obligatoirement stérile ; Streptocoques.",
    "justification": "L’arbre aérodigestif supérieur est fortement colonisé. Ils sont abondants dans la flore orale."
  },
  "7A": {
    "is_correct": false,
    "enonce": "La flore rectale est moins dense que la flore gastrique ; L’estomac possède une flore relativement pauvre.",
    "justification": "La flore digestive distale est la plus abondante. Son acidité limite la densité bactérienne."
  },
  "7B": {
    "is_correct": false,
    "enonce": "Les anaérobies disparaissent dans le côlon ; Le grêle contient de nombreuses entérobactéries.",
    "justification": "Ils deviennent au contraire prépondérants au niveau colique et rectal. Elles y sont largement représentées avec streptocoques et entérocoques."
  },
  "9A": {
    "is_correct": false,
    "enonce": "Toutes les spécialités ont exactement le même profil ; Les entérobactéries occupent une part importante.",
    "justification": "Le graphique comparatif montre des distributions distinctes. Elles représentent une composante majeure de l’ensemble des ISO."
  },
  "10E": {
    "is_correct": true,
    "enonce": "Coût raisonnable ; Faible risque de sélection résistante.",
    "justification": "Le volume élevé de prescriptions rend le coût collectif pertinent. La prophylaxie doit préserver l’efficacité future des antibiotiques."
  },
  "14C": {
    "is_correct": false,
    "enonce": "Attendre l’incision pour choisir la molécule ; Documenter une allergie alléguée.",
    "justification": "La concentration doit déjà être efficace au début du geste. La nature de la réaction guide l’alternative."
  },
  "15A": {
    "is_correct": false,
    "enonce": "Injection systématique deux heures après l’incision ; Injection 30 à 60 minutes avant l’incision.",
    "justification": "Une administration tardive ne protège pas la contamination initiale. Cette fenêtre minimise le risque d’une concentration insuffisante au début du geste."
  },
  "17A": {
    "is_correct": false,
    "enonce": "Même intervalle pour toutes les molécules ; Échéance toutes les deux demi-vies.",
    "justification": "Le rythme dépend de la demi-vie propre à l’antibiotique. Ce délai anticipe la baisse de concentration tissulaire."
  },
  "17B": {
    "is_correct": false,
    "enonce": "Rappel uniquement après la fermeture ; Calcul depuis l’heure de première injection.",
    "justification": "Il doit intervenir pendant l’exposition opératoire si le seuil est atteint. L’incision ne constitue pas le point de départ pharmacocinétique."
  },
  "19E": {
    "is_correct": true,
    "enonce": "Le devenir de l’enfant n’est pas modifié dans les données citées ; La dose peut être donnée dans les 30 minutes avant l’incision.",
    "justification": "L’exposition pré-incision n’a pas montré de signal néonatal défavorable. Cette fenêtre assure la protection maternelle au début du geste."
  },
  "20E": {
    "is_correct": true,
    "enonce": "Implantation de matériel prothétique seule ; Présence d’un drain chirurgical.",
    "justification": "La gravité potentielle n’apporte aucun bénéfice démontré à une prolongation. Un drain ne constitue pas une indication de prophylaxie jusqu’à son retrait."
  },
  "22E": {
    "is_correct": true,
    "enonce": "Considérer la procédure réalisée ; Analyser le profil de résistance.",
    "justification": "L’ouverture cutanée ou digestive modifie la probabilité d’exposition au germe. L’activité de la molécule éventuelle dépend du phénotype précis."
  },
  "23A": {
    "is_correct": false,
    "enonce": "Aucune discussion multidisciplinaire nécessaire ; Vancomycine si SARM, ouverture cutanée et prothèse.",
    "justification": "L’incertitude impose au contraire une décision documentée. Le réservoir cutané est alors directement lié au risque de contamination du matériel."
  },
  "24A": {
    "is_correct": false,
    "enonce": "La prophylaxie doit durer jusqu’à cicatrisation complète ; Une dose unique suffit souvent pour un geste court.",
    "justification": "La fenêtre ciblée se termine avec la fermeture, pas avec la cicatrisation. La durée d’exposition reste couverte sans rappel inutile."
  },
  "25D": {
    "is_correct": true,
    "enonce": "Il concerne environ 20 à 30 % de la population ; Il multiplie par dix le risque d’ISO.",
    "justification": "Cette fréquence justifie un dépistage dans certaines chirurgies. Le portage constitue un déterminant majeur des infections staphylococciques."
  },
  "26B": {
    "is_correct": false,
    "enonce": "Garantie d’absence d’ISO digestive à Gram négatif ; Cure de cinq jours.",
    "justification": "La mupirocine ne couvre ni entérobactéries ni anaérobies. Ce schéma permet l’éradication décrite du portage."
  },
  "26D": {
    "is_correct": false,
    "enonce": "Garantie d’absence d’ISO digestive à Gram négatif ; Activité surtout sur les bactéries à Gram positif.",
    "justification": "La mupirocine ne couvre ni entérobactéries ni anaérobies. Son spectre correspond notamment au staphylocoque doré."
  },
  "27E": {
    "is_correct": true,
    "enonce": "Neurochirurgie ; Orthopédie avec prothèse.",
    "justification": "Elle figure parmi les spécialités non générales où l’impact est plus marqué. Une infection du matériel justifie une prévention ciblée chez le porteur."
  },
  "28E": {
    "is_correct": true,
    "enonce": "Impact des résistances encore incertain ; Association fréquente à une décontamination cutanée.",
    "justification": "L’exposition topique ou digestive peut sélectionner des souches résistantes. La chlorhexidine peut contribuer au résultat observé."
  },
  "29A": {
    "is_correct": false,
    "enonce": "L’impact écologique est parfaitement connu ; La préparation colique isolée n’a pas montré d’efficacité.",
    "justification": "L’émergence de résistances demeure une interrogation. Vider mécaniquement le côlon ne suffit pas à réduire les ISO."
  },
  "29E": {
    "is_correct": false,
    "enonce": "L’impact écologique est parfaitement connu ; La littérature reste controversée.",
    "justification": "L’émergence de résistances demeure une interrogation. Le poids des cointerventions et le faible nombre d’études isolées limitent la certitude."
  },
  "30B": {
    "is_correct": false,
    "enonce": "Communication interauriculaire réparée sans fuite depuis dix ans ; Antécédent d’endocardite infectieuse.",
    "justification": "Une réparation ancienne complète sans fuite ne correspond pas au groupe décrit. Une récidive serait particulièrement grave."
  },
  "30D": {
    "is_correct": false,
    "enonce": "Communication interauriculaire réparée sans fuite depuis dix ans ; Cardiopathie cyanogène non réparée.",
    "justification": "Une réparation ancienne complète sans fuite ne correspond pas au groupe décrit. Cette cardiopathie congénitale est incluse dans les indications."
  },
  "31E": {
    "is_correct": true,
    "enonce": "Perforation de la muqueuse orale ; Manipulation de la muqueuse gingivale.",
    "justification": "Elle expose directement à la flore buccale. Ce geste peut provoquer une bactériémie orale."
  },
  "32B": {
    "is_correct": false,
    "enonce": "Vancomycine systématique chez tous les patients ; Amoxicilline 2 g par voie intraveineuse.",
    "justification": "Le spectre large n’est pas le schéma standard de cette indication. Cette voie est une alternative si la prise orale est impossible."
  },
  "32E": {
    "is_correct": true,
    "enonce": "Amoxicilline 2 g par voie orale ; Amoxicilline 2 g par voie intraveineuse.",
    "justification": "La voie orale permet une exposition suffisante pour le geste dentaire. Cette voie est une alternative si la prise orale est impossible."
  },
  "34A": {
    "is_correct": false,
    "enonce": "Tout acte chirurgical relève de l’amoxicilline 2 g ; La cardiopathie à haut risque est un critère nécessaire.",
    "justification": "Les autres gestes obéissent à une prophylaxie adaptée à leur flore. Sans terrain concerné, le protocole d’endocardite ne s’applique pas."
  },
  "34D": {
    "is_correct": false,
    "enonce": "Un antécédent d’endocardite dispense de toute asepsie ; Une chirurgie non dentaire reprend le protocole opératoire usuel.",
    "justification": "L’antibiotique ne remplace jamais les mesures de prévention locales. La prévention d’ISO reste distincte de celle de l’endocardite."
  },
  "35E": {
    "is_correct": true,
    "enonce": "Réalisation des rappels nécessaires ; Adéquation de la molécule au geste.",
    "justification": "Une chirurgie longue doit rester couverte jusqu’à la fermeture. Le spectre doit correspondre à la flore exposée."
  },
  "36C": {
    "is_correct": false,
    "enonce": "Analyse de seulement 20 procédures ; Évaluation de 2 082 procédures.",
    "justification": "L’échantillon comptait 2 082 interventions. Le volume permettait une mesure nationale structurée."
  },
  "40E": {
    "is_correct": true,
    "enonce": "Implantation d’une prothèse articulaire ; Garrot pneumatique programmé.",
    "justification": "Une infection du matériel aurait des conséquences fonctionnelles majeures. L’injection doit être terminée avant l’interruption de la perfusion du membre."
  },
  "41A": {
    "is_correct": false,
    "enonce": "Attendre la fermeture pour administrer la première dose ; Achever la perfusion avant le garrot.",
    "justification": "La contamination survient dès l’incision. La diffusion tissulaire doit précéder l’ischémie du membre."
  },
  "43A": {
    "is_correct": false,
    "enonce": "Présence de la prothèse après fermeture ; Atteinte de quatre heures depuis la première dose.",
    "justification": "Le matériel n’impose pas de rappel postopératoire continu. Le tableau fixe le rappel de céfazoline à cet intervalle."
  },
  "45D": {
    "is_correct": true,
    "enonce": "Ancien poids conservé dans le dossier ; Heure du garrot proche de l’injection.",
    "justification": "La donnée obsolète aurait pu provoquer une sous-dose. La diffusion tissulaire pouvait être incomplète."
  },
  "46E": {
    "is_correct": true,
    "enonce": "Heure et demi-dose de réinjection ; Arrêt à la fermeture malgré le drain.",
    "justification": "La chirurgie longue a nécessité le maintien pharmacocinétique. Cette conduite respecte la durée minimale."
  },
  "47E": {
    "is_correct": true,
    "enonce": "Flore colique attendue ; Délai entre prise et éruption.",
    "justification": "La procédure expose aux entérobactéries et aux anaérobies. La temporalité aide à distinguer une hypersensibilité immédiate d’une réaction retardée."
  },
  "48A": {
    "is_correct": false,
    "enonce": "Une anaphylaxie certaine doit être inscrite ; L’allergie IgE immédiate devient peu probable.",
    "justification": "Aucune détresse respiratoire ou circulatoire n’a été rapportée. Le délai de plusieurs jours et l’absence de signes systémiques sont défavorables à ce mécanisme."
  },
  "48B": {
    "is_correct": false,
    "enonce": "Toute céphalosporine est définitivement interdite ; Une réaction virale est plausible.",
    "justification": "Les croisements modernes sont faibles et liés aux chaînes latérales. La mononucléose associée à l’amoxicilline peut produire une éruption non IgE."
  },
  "49A": {
    "is_correct": false,
    "enonce": "Aucune analyse de la molécule n’est utile ; La chaîne latérale R1 est déterminante.",
    "justification": "La structure de la chaîne latérale participe au choix. Des chaînes similaires peuvent partager des épitopes reconnus."
  },
  "49C": {
    "is_correct": false,
    "enonce": "Aucune analyse de la molécule n’est utile ; Les anciens taux étaient probablement surestimés.",
    "justification": "La structure de la chaîne latérale participe au choix. Les premières céphalosporines pouvaient être contaminées par des pénicillines."
  },
  "50B": {
    "is_correct": false,
    "enonce": "Stérilisation de toute la flore digestive ; Anaérobies coliques.",
    "justification": "Le but est d’empêcher la multiplication de l’inoculum opératoire. Ils prédominent dans le côlon et le rectum."
  },
  "51A": {
    "is_correct": false,
    "enonce": "Omettre la surveillance car la réaction ancienne était bénigne ; Finir l’injection avant l’incision.",
    "justification": "Toute administration IV impose une préparation aux réactions immédiates. La concentration protectrice doit être présente lors de l’ouverture colique."
  },
  "51B": {
    "is_correct": false,
    "enonce": "Administrer seulement après l’anastomose ; Respecter la fenêtre de 30 à 60 minutes.",
    "justification": "La contamination aurait déjà eu lieu. Elle correspond au délai associé au plus faible taux d’ISO."
  },
  "52D": {
    "is_correct": true,
    "enonce": "Choisir une alternative compatible avec la flore colique ; Interrompre l’antibiotique suspect.",
    "justification": "La protection doit rester microbiologiquement cohérente si le geste est maintenu. La poursuite pourrait aggraver une hypersensibilité."
  },
  "53B": {
    "is_correct": false,
    "enonce": "Mention vague « allergique à tous les antibiotiques » ; Chronologie de l’urticaire.",
    "justification": "Cette formulation empêcherait des choix ciblés et sûrs. Le délai par rapport à la perfusion soutient l’imputabilité."
  },
  "54B": {
    "is_correct": false,
    "enonce": "Concentration uniquement urinaire ; Maintien de l’exposition jusqu’à midi.",
    "justification": "Le site cible est le tissu opératoire. La fermeture marque la fin du besoin préventif."
  },
  "55C": {
    "is_correct": false,
    "enonce": "Seulement si une fièvre apparaît ; Avant que la concentration ne devienne insuffisante.",
    "justification": "La réinjection est pharmacocinétique, pas déclenchée par une infection. Le rappel préserve la couverture tissulaire."
  },
  "56D": {
    "is_correct": true,
    "enonce": "Une dose conforme au protocole local ; La moitié de la dose donnée à 7 h 30.",
    "justification": "Le tableau doit être traduit en prescription opérationnelle. Cette quantité restaure l’exposition attendue."
  },
  "57A": {
    "is_correct": false,
    "enonce": "Transformation automatique en allergie ; Sous-concentration au site opératoire.",
    "justification": "L’omission n’a aucun mécanisme hypersensible. Quatre heures dépassent largement les deux demi-vies prévues."
  },
  "57D": {
    "is_correct": false,
    "enonce": "Résistance évitée avec certitude par l’omission ; Écart de pratique à analyser.",
    "justification": "Ne pas couvrir le geste n’est pas une stratégie écologique sûre. L’absence de dose à l’échéance prescrite signale une défaillance du processus de rappel peropératoire."
  },
  "59D": {
    "is_correct": true,
    "enonce": "Responsabilité du rappel non attribuée ; Absence de contrôle dans la check-list.",
    "justification": "Une tâche sans responsable identifié est facilement omise. Un point de vérification aurait révélé l’échéance."
  },
  "60E": {
    "is_correct": true,
    "enonce": "Prescription horodatée des rappels ; Alerte calculée depuis la première dose.",
    "justification": "Elle transforme une règle abstraite en action planifiée. Le bon point de départ devient automatique."
  },
  "61D": {
    "is_correct": true,
    "enonce": "Portage d’un staphylocoque résistant ; Ouverture cutanée.",
    "justification": "Le germe peut contaminer une incision cutanée. Le réservoir cutané devient anatomiquement pertinent."
  },
  "62D": {
    "is_correct": true,
    "enonce": "Maintien du spectre le plus étroit possible ; Vancomycine adaptée au portage SARM.",
    "justification": "L’élargissement doit se limiter au risque identifié. La vancomycine couvre le SARM identifié lors d’une chirurgie cutanée avec implantation prothétique."
  },
  "64A": {
    "is_correct": false,
    "enonce": "Poursuite automatique au-delà de 48 heures ; Dose calculée sur le poids réel.",
    "justification": "Une vancomycine prolongée augmente le portage résistant. La vancomycine fait partie des molécules toujours adaptées au poids réel."
  },
  "65A": {
    "is_correct": false,
    "enonce": "Assimilation du portage à une endocardite ; Arrêt de la prophylaxie après le geste.",
    "justification": "Aucune infection valvulaire n’est diagnostiquée. La contamination opératoire est terminée."
  },
  "66B": {
    "is_correct": false,
    "enonce": "Dose IV correcte de vancomycine ; Souche résistante à la mupirocine.",
    "justification": "La prophylaxie systémique n’assure pas une décolonisation nasale durable. Ces résistances rares peuvent provoquer un échec d’éradication."
  },
  "66C": {
    "is_correct": false,
    "enonce": "Absence de fièvre postopératoire immédiate ; Écouvillonnage de contrôle encore positif.",
    "justification": "Elle ne prouve pas l’éradication microbiologique. Il objective la persistance du réservoir."
  },
  "68A": {
    "is_correct": false,
    "enonce": "Preuve d’une toxicité néonatale systématique ; Réduction des complications maternelles.",
    "justification": "Aucune dégradation du devenir de l’enfant n’est décrite. Le bénéfice est rapporté lorsque la prophylaxie précède l’incision."
  },
  "68B": {
    "is_correct": false,
    "enonce": "Absence totale de bénéfice maternel ; Absence de modification démontrée du devenir de l’enfant.",
    "justification": "L’amélioration maternelle est précisément l’argument du changement. Les études citées ne montrent pas de signal défavorable néonatal."
  },
  "69C": {
    "is_correct": false,
    "enonce": "La veille au soir sans nouvelle dose ; Avec heure de fin d’injection tracée.",
    "justification": "Une administration trop précoce ne couvrerait pas l’incision. La conformité du timing doit être vérifiable."
  },
  "70A": {
    "is_correct": false,
    "enonce": "Suppression de toute surveillance ; Meilleure imputabilité d’une réaction.",
    "justification": "Une réaction peut toujours survenir malgré la séparation. La chronologie distingue antibiotique et produits anesthésiques."
  },
  "70B": {
    "is_correct": false,
    "enonce": "Autorisation d’injecter après l’incision ; Possibilité de traiter avant l’induction si réaction.",
    "justification": "La séparation ne doit pas compromettre la fenêtre préopératoire. Une réaction détectée chez une patiente éveillée est plus facilement caractérisée."
  },
  "71D": {
    "is_correct": true,
    "enonce": "Tracer l’absence d’autre médicament injecté ; Reporter l’incision si l’état l’exige.",
    "justification": "Cette information renforce l’imputabilité de l’antibiotique. Une chirurgie programmée ne doit pas débuter chez une patiente instable."
  },
  "73D": {
    "is_correct": true,
    "enonce": "Activité sur les bactéries attendues ; Spectre le plus étroit efficace.",
    "justification": "Le changement pour allergie ne doit pas sacrifier l’efficacité microbiologique. Une allergie ne justifie pas un élargissement non ciblé."
  },
  "74A": {
    "is_correct": false,
    "enonce": "Nombre de prophylaxies prolongées jusqu’à sortie ; Proportion de doses données avant incision.",
    "justification": "La prolongation ne constitue pas un objectif de qualité. Elle mesure l’abandon effectif de l’ancien dogme."
  },
  "75A": {
    "is_correct": false,
    "enonce": "Capacité à prendre un médicament oral ; Valve mécanique prothétique.",
    "justification": "Elle guide la voie, pas la nécessité de prophylaxie. Elle appartient aux cardiopathies à haut risque."
  },
  "76A": {
    "is_correct": false,
    "enonce": "Amoxicilline 200 mg quotidienne pendant dix jours ; Amoxicilline 2 g per os.",
    "justification": "La prophylaxie repose sur une dose unique adaptée. La dose et la voie correspondent au protocole décrit."
  },
  "76C": {
    "is_correct": false,
    "enonce": "Amoxicilline 200 mg quotidienne pendant dix jours ; Administration avant le geste.",
    "justification": "La prophylaxie repose sur une dose unique adaptée. L’exposition doit précéder la bactériémie dentaire."
  },
  "77A": {
    "is_correct": false,
    "enonce": "Chirurgie périapicale ; Radiographie panoramique simple.",
    "justification": "La région périapicale fait partie des indications. Elle ne provoque pas de bactériémie par effraction muqueuse."
  },
  "77B": {
    "is_correct": false,
    "enonce": "Extraction avec manipulation gingivale ; Empreinte dentaire atraumatique.",
    "justification": "C’est précisément un geste concerné. Aucune manipulation des zones à risque n’est prévue."
  },
  "78A": {
    "is_correct": false,
    "enonce": "Clindamycine 60 mg pendant un mois ; Clindamycine 600 mg par voie orale.",
    "justification": "La dose prophylactique citée est dix fois plus élevée et ponctuelle. Cette voie est possible si la prise digestive est conservée."
  },
  "78B": {
    "is_correct": false,
    "enonce": "Rifampicine seule pour tout patient ; Clindamycine 600 mg intraveineuse.",
    "justification": "Son risque de résistance l’exclut d’un usage prophylactique routinier. La voie IV est une alternative si l’oral est impossible."
  },
  "80C": {
    "is_correct": false,
    "enonce": "Geste dentaire futur sans symptôme ; Nouvelle insuffisance valvulaire.",
    "justification": "Il s’agit encore d’un contexte préventif. Un signe cardiaque nouveau peut évoquer une endocardite."
  },
  "81E": {
    "is_correct": true,
    "enonce": "Liste des gestes oraux bactériémiants concernés ; Alternative clindamycine 600 mg validée.",
    "justification": "Elle évite prophylaxies inutiles et omissions dangereuses. Le schéma doit être immédiatement disponible."
  },
  "83A": {
    "is_correct": false,
    "enonce": "Remplacement de toute prophylaxie IV ; Deux applications quotidiennes.",
    "justification": "La décolonisation complète le protocole opératoire. L’efficacité dépend du nombre d’applications."
  },
  "83D": {
    "is_correct": false,
    "enonce": "Une application unique après l’incision ; Début suffisamment précoce avant le geste.",
    "justification": "Le réservoir doit être réduit avant la chirurgie. La cure complète doit être réalisable."
  },
  "84B": {
    "is_correct": false,
    "enonce": "Aucune infection staphylococcique n’est mesurable ; La chlorhexidine peut réduire la charge cutanée.",
    "justification": "Les études évaluent précisément ces infections. Elle agit sur un autre réservoir pertinent pour l’incision."
  },
  "84D": {
    "is_correct": false,
    "enonce": "Aucune infection staphylococcique n’est mesurable ; Le résultat global peut refléter une synergie.",
    "justification": "Les études évaluent précisément ces infections. Les deux mesures peuvent contribuer ensemble."
  },
  "85A": {
    "is_correct": false,
    "enonce": "Prophylaxie IV administrée au bon moment ; Applications oubliées.",
    "justification": "Elle ne détermine pas à elle seule l’éradication nasale. Le taux d’éradication dépend du nombre de doses locales."
  },
  "85B": {
    "is_correct": false,
    "enonce": "Culture initiale sensible correctement traitée ; Résistance de la souche à la mupirocine.",
    "justification": "Cette situation favorise plutôt le succès. Elle peut être responsable d’un échec microbiologique."
  },
  "86A": {
    "is_correct": false,
    "enonce": "Prescrire une mupirocine indéfiniment ; Vérifier l’antibiogramme et la sensibilité topique.",
    "justification": "Une exposition prolongée sélectionnerait davantage de résistances. Un échec peut traduire une résistance."
  },
  "87D": {
    "is_correct": true,
    "enonce": "Taux de résistance à la mupirocine ; Coût des infections de matériel évitées.",
    "justification": "Une résistance croissante réduit l’efficacité future. Ces complications lourdes déterminent la valeur de la stratégie."
  },
  "88A": {
    "is_correct": false,
    "enonce": "Nombre d’antibiotiques prolongés après fermeture ; Proportion de patients réellement dépistés.",
    "justification": "La prolongation n’est pas un objectif de la décolonisation. Le protocole ciblé dépend de l’identification préalable des porteurs."
  },
  "89A": {
    "is_correct": false,
    "enonce": "Le maintien transforme automatiquement la prescription en traitement curatif adapté ; Les drains ne prolongent pas l’indication.",
    "justification": "Une antibiothérapie curative nécessite une infection et un schéma propres. Leur présence ne justifie pas une couverture continue."
  },
  "91E": {
    "is_correct": true,
    "enonce": "Arrêt après fermeture en absence d’infection ; Molécule adaptée à la procédure.",
    "justification": "Ce critère cible précisément la dérive observée. Le spectre doit couvrir la flore exposée."
  },
  "93A": {
    "is_correct": false,
    "enonce": "Vancomycine ajoutée à toutes les prolongations ; Ordre prophylactique avec arrêt automatique.",
    "justification": "Cette molécule augmenterait encore la pression de résistance. La durée minimale devient le comportement par défaut."
  },
  "94D": {
    "is_correct": true,
    "enonce": "Journées d’antibiotiques évitées ; Évolution des portages résistants.",
    "justification": "Cet indicateur mesure la baisse d’exposition. La pression écologique devrait diminuer."
  }
});
