    ...
    questions: [
      ...
      qcm(
        ...
        [
          ...
          F(
            "La pression partielle disparaît lorsque le gaz est dissous.",
            "Les molécules dissoutes conservent une pression partielle à l’équilibre.",
          ),
        ],
      ),
      qcm(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Le ratio tend vers 1 après saturation des tissus.",
            "La fraction alvéolaire devient alors voisine de la fraction inspirée.",
          ),
          F(
      ...
      qcm(
        ...
        [
          T(
            "Une faible solubilité favorise une installation rapide.",
            "Le sang capte peu d’agent avant la montée cérébrale.",
          ),
          T(
            "Une CAM faible traduit une grande puissance.",
            "Une faible concentration suffit à bloquer la réponse motrice.",
          ),
          F(
...
const ISOLATED_QCM_FINAL = [
  {
    ...
    questions: [
      qcm(
        ...
        [
          T(
            "Son empreinte dépasse fortement celle du sévoflurane.",
            "L’écart est d’environ un facteur vingt dans la comparaison fournie.",
          ),
          F(
          ...
          T(
            "Son odeur âcre limite la tolérance respiratoire.",
            "Une exposition chez le patient éveillé favorise toux et spasme laryngé.",
          ),
          F(
      ...
      qcm(
        ...
        [
          T(
            "Remplacer une cartouche desséchée.",
            "La déshydratation augmente la dégradation des halogénés en monoxyde de carbone.",
          ),
          F(
    ...
    questions: [
      qcm(
        ...
        [
          ...
          F(
            "Sa faible puissance impose une concentration de 6 %.",
            "Cette valeur de CAM correspond au desflurane.",
          ),
        ],
      ),
      qcm(
        ...
        [
          ...
          T(
            "L’obésité renforce le signal de risque.",
            "Elle fait partie de l’association clinique historique.",
          ),
          F(
      ...
      qcm(
        ...
        [
          T(
            "Une réponse auto-immune est impliquée.",
            "Des anticorps dirigés contre des produits liés au métabolite sont décrits.",
          ),
          T(
      ...
      qcm(
        ...
        [
          T(
            ...
            "Elle appartient à la présentation classique.",
          ),
          T(
            "Une hyperéosinophilie.",
            "Elle soutient le mécanisme immunitaire.",
          ),
          T(
      ...
      qcm(
        ...
        [
          T(
            "Renoncer à une nouvelle administration d’halothane.",
            "L’exposition rapprochée expose au tableau redouté.",
          ),
          T(
          ...
          F(
            "Choisir le N2O seul pour garantir l’immobilité.",
            "Sa CAM de 104 % ne permet pas une anesthésie complète sûre.",
          ),
        ],
      ...
      qcm(
        ...
        [
          ...
          F(
            "Une vasodilatation isolée avec débit conservé.",
            "L’hypotension provient surtout de la baisse du débit cardiaque.",
          ),
        ],
    ...
    questions: [
      qcm(
        ...
        [
          ...
          T(
            "Elle ne garantit pas à elle seule l’amnésie.",
            "La définition porte sur la réaction motrice.",
          ),
          T(
            "Une cible fixe d’adulte jeune serait inadaptée.",
            "L’âge et les médicaments modifient le besoin.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Une alcoolisation chronique absente de ses antécédents.",
            "Elle augmente la CAM et n’est pas rapportée ici.",
          ),
        ],
      ...
      qcm(
        ...
        [
          ...
          F(
            "Une rigidité bronchique constante.",
            "Les halogénés ont un effet bronchodilatateur direct.",
          ),
        ],
      ...
      qcm(
        ...
        [
          ...
          T(
            ...
            "La correction de l’hypothermie stabilise la physiologie.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Une valeur inférieure à la CAM du jeune adulte peut suffire.",
            "Le repère doit être corrigé pour l’âge.",
          ),
          F(
          ...
          F(
            "Il faut rétablir la concentration précédente par principe.",
            "La dose antérieure a produit une instabilité.",
          ),
        ],
      ...
      qcm(
        ...
        ["b00057"],
        "Hyperthermie, alcoolisation chronique et stimulation centrale augmentent le besoin anesthésique.",
        [
          T(
          ...
          F(
            "Une intoxication alcoolique aiguë juste avant l’intervention.",
            "L’effet dépresseur aigu diminue au contraire la CAM requise.",
          ),
          F(
            "Une grossesse en cours chez une autre patiente.",
            "La grossesse réduit habituellement les besoins en agent inhalé.",
          ),
        ],
      ...
      qcm(
        ...
        [
          ...
          T(
            ...
            "Elle accélère le wash-out pulmonaire.",
          ),
          T(
          ...
          F(
            "Le faible coefficient annule tout risque respiratoire.",
            "Une cinétique rapide n’empêche pas la dépression résiduelle.",
          ),
        ],
  ...
  },
  {
    ...
    questions: [
      qcm(
        ...
        [
          T(
            "Il peut augmenter d’environ 10 % le débit sanguin cérébral.",
            "Cet effet est défavorable en hypertension intracrânienne sévère.",
          ),
          T(
          ...
          F(
            "Son métabolisme hépatique augmente la pression intracrânienne.",
            "L’absence de métabolisme significatif du N2O ne permet pas d’expliquer l’hypertension intracrânienne.",
          ),
          F(
            "Sa puissance excessive empêche toute oxygénation.",
            "Il est au contraire peu puissant, avec une CAM de 104 %.",
          ),
        ],
      ),
      qcm(
      ...
      qcm(
        ...
        [
          T(
            "Son coefficient sang/gaz est voisin de 0,115.",
            "Cette valeur donne un début et une fin très rapides.",
          ),
          T(
          ...
          T(
            ...
            "Le caractère inodore du xénon explique sa bonne tolérance respiratoire.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Une CAM élevée signifie une faible puissance.",
            "Il faut une grande concentration pour bloquer le mouvement.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Il partage l’expansion des cavités propre au N2O.",
            "Ce risque est lié à la diffusion rapide du protoxyde d’azote.",
          ),
        ],
      ...
      qcm(
        ...
        [
          ...
          T(
            "Le débit cardiaque devenu faible pendant l’hypotension.",
            "Cette baisse de flux sanguin accélère la montée alvéolaire du sévoflurane.",
          ),
          T(
          ...
          F(
            "Une valeur identique quelle que soit la pression artérielle.",
            "L’hypotension profonde diminue le besoin et impose la prudence.",
          ),
        ],
      ...
      qcm(
        ...
        [
          ...
          T(
            "Assurer une ventilation alvéolaire suffisante.",
            "Elle accélère l’élimination pulmonaire.",
          ),
          T(
            "Surveiller la réponse au CO2.",
            "Les halogénés la diminuent de façon dose-dépendante.",
          ),
          F(
          ...
          F(
            "Attendre une clairance rénale complète.",
            "L’agent est principalement expiré inchangé.",
          ),
        ],
  ...
  },
  {
    ...
    questions: [
      qcm(
        ...
        [
          T(
            "La solubilité sanguine.",
            "Elle influence les vitesses d’installation et d’élimination.",
          ),
          T(
            "La puissance mesurée par la CAM.",
            "Elle détermine la concentration nécessaire.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Le sévoflurane a une CAM proche de 6 %.",
            "Cette valeur appartient au desflurane ; celle du sévoflurane est proche de 2 %.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Son empreinte est environ quinze fois celle de l’isoflurane.",
            "L’écart demeure majeur avec cet autre halogéné.",
          ),
          T(
            "Le propofol a une empreinte environ quatre fois moindre que les agents inhalés.",
            "La technique intraveineuse est plus favorable dans cette estimation.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Prolonger le haut débit après équilibre.",
            "Une consommation inutile augmente les rejets sans bénéfice.",
          ),
        ],
      ...
      qcm(
        ...
        "La concentration expirée est interprétée avec la CAM ajustée et les coagents.",
        [
          T(
            "La concentration expirée de sévoflurane affichée pendant l’arthroscopie.",
            "Cette valeur alvéolaire approche la pression partielle cérébrale à l’équilibre.",
          ),
          T("L’âge du patient.", "Il modifie la valeur de CAM attendue."),
          T("La dose d’opioïde.", "Elle réduit les besoins en halogéné."),
          F(
            "Une cible de 1,3 CAM chez tous les patients.",
            "Le repère à 95 % ne remplace pas la titration clinique.",
          ),
          T(
      ...
      qcm(
        ...
        [
          T(
            "Anticiper l’arrêt de la vapeur.",
            "La pression alvéolaire commence alors à décroître.",
          ),
          T(
            "Maintenir le renouvellement alvéolaire.",
            "La ventilation élimine l’agent expiré.",
          ),
          T(
          ...
          F(
            "Administrer du N2O pendant la phase d’éveil.",
            "Cela maintiendrait un effet anesthésique et créerait un risque d’hypoxie de diffusion.",
          ),
        ],
      ...
      qcm(
        ...
        [
          ...
          F(
            "Une concentration maximale maintenue jusqu’à l’extubation.",
            "Elle retarderait le réveil et augmenterait les rejets.",
          ),
        ],
...
const ISOLATED_QCM_REST = [
  {
    ...
    questions: [
      qcm(
        ...
        [
          T(
            "Un coefficient sang/gaz élevé ralentit l’équilibre.",
            "Une grande quantité doit d’abord se dissoudre dans le sang.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Le débit n’agit que sur l’élimination rénale.",
            "Les agents inhalés sont surtout concernés par les échanges pulmonaires.",
          ),
        ],
      ),
      qcm(
        ...
        [
          T(
            "Il est élevé lorsque le sang veineux ne contient pas encore d’agent.",
            "Le retour veineux initial accepte une grande quantité de vapeur.",
          ),
          T(
            "Il entretient un captage important pendant l’induction.",
            "La différence de pression pousse l’agent vers les tissus.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Une ventilation efficace accélère le wash-out.",
            "Elle renouvelle le gaz alvéolaire pauvre en agent.",
          ),
          T(
      ...
      qcm(
        ...
        "Xénon, desflurane et sévoflurane ont les coefficients sang/gaz les plus faibles du groupe.",
        [
          T(
            "Le xénon.",
            "Son coefficient voisin de 0,115 est extrêmement faible.",
          ),
          T(
            "Le desflurane.",
          ...
          T(
            "Le sévoflurane.",
            "Avec 0,65, il reste nettement moins soluble que l’isoflurane.",
          ),
          F(
            "L’halothane.",
  ...
  },
  {
    ...
    questions: [
      qcm(
        ...
        [
          T(
            "Elle correspond à une absence de mouvement chez 50 % des sujets.",
            "La moitié ne répond pas à une incision standardisée.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          T(
            ...
            "La tolérance déplace la CAM vers le haut.",
          ),
          T(
          ...
          F(
            ...
            "La grossesse diminue les besoins et abaisse donc la valeur de CAM.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Les opioïdes.",
            "Leur association exerce un effet d’épargne sur la concentration inhalée requise.",
          ),
          T(
            "L’âge avancé.",
          ...
          F(
            ...
            "Elle ne figure pas parmi les modificateurs retenus.",
          ),
        ],
      ),
      qcm(
        ...
        [
          T(
            "L’halothane à 0,77 % est très puissant.",
            "Une faible concentration suffit à prévenir le mouvement.",
          ),
          T(
    ...
    questions: [
      qcm(
        ...
        [
          ...
          F(
            "Sa CAM faible permet une monothérapie.",
            "Sa CAM de 104 % révèle au contraire une très faible puissance.",
          ),
          T(
          ...
          F(
            "Il est très irritant pour les voies aériennes.",
            "Il est décrit comme agréable à inhaler.",
          ),
        ],
      ),
      qcm(
        ...
        [
          ...
          T(
            "La fraction alvéolaire du second agent peut augmenter plus vite.",
            "Le volume restant contient proportionnellement plus de vapeur.",
          ),
          T(
      ...
      qcm(
        ...
        [
          T(
            "Administrer de l’oxygène pendant 5 à 10 minutes.",
            "Cette fenêtre couvre la diffusion initiale la plus importante.",
          ),
          T(
            "Maintenir une ventilation alvéolaire suffisante.",
            "Elle élimine le N2O et renouvelle l’oxygène.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Une embolie gazeuse potentielle.",
            "Les bulles peuvent augmenter de volume.",
          ),
          T(
          ...
          F(
            "Une analgésie dentaire sans espace clos pathologique.",
            "Le N2O peut justement être utilisé dans ce contexte.",
          ),
        ],
      ),
      qcm(
        ...
        "La dépression ventilatoire est faible, l’inotropisme est négatif mais compensé, et le débit cérébral augmente.",
        [
          T(
            "Une légère diminution de la ventilation alvéolaire.",
            "L’effet respiratoire reste modéré comparé aux halogénés.",
          ),
          T(
          ...
          F(
            "Un métabolisme hépatique majeur.",
            "Le N2O n’est pas métabolisé de façon significative.",
          ),
        ],
      ),
    ],
    ...
    questions: [
      qcm(
        ...
        [
          ...
          F(
            "Il est le halogéné le plus rapide.",
            "Des agents moins solubles modifient la profondeur plus vite.",
          ),
          F(
            "Il est réservé à l’induction intraveineuse.",
            "Son profil non irritant a historiquement permis l’induction au masque.",
          ),
        ],
      ),
      qcm(
        ...
        [
          T(
            ...
            "La dépression respiratoire réduit l’amplitude des cycles.",
          ),
          T(
            "La fréquence respiratoire augmente souvent.",
          ...
          F(
            "La réponse hypoxique reste intacte à 0,1 CAM.",
            "Elle est déjà très fortement réduite à cette faible concentration.",
          ),
        ],
      ),
      qcm(
      ...
      qcm(
        ...
        [
          T(
            "Des extrasystoles ventriculaires peuvent apparaître.",
            "L’adrénaline augmente l’automatisme sous halothane.",
          ),
          T(
  ...
  },
  {
    ...
    questions: [
      qcm(
        ...
        ["b00084"],
        "Sa forte pression de vapeur et son point d’ébullition bas imposent un vaporisateur dédié.",
        [
          T(
          ...
          F(
            "Il peut être versé dans tout vaporisateur au sévoflurane.",
            "Les caractéristiques imposent un appareil spécifique.",
          ),
          F(
            "Sa CAM de 0,77 % explique cette contrainte.",
            "Sa CAM est autour de 6 % et ne détermine pas le vaporisateur.",
          ),
        ],
      ),
      qcm(
        ...
        [
          T(
            "Il augmente l’incidence du laryngospasme.",
            "L’irritation réflexe peut fermer la glotte.",
          ),
          T(
          ...
          T(
            "Une poussée hypertensive peut accompagner l’augmentation.",
            "Le système autonome est fortement activé.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Le sévoflurane produit toujours plus de CO que le desflurane.",
            "L’ordre décrit place le desflurane au premier rang.",
          ),
        ],
      ),
      qcm(
        ...
        [
          T(
            "Son coefficient sang/gaz est proche de 0,65.",
            "La montée cérébrale est assez rapide.",
          ),
          T(
          ...
          F(
            "Sa grande solubilité impose une heure d’induction.",
            "Il fait partie des agents modernes peu solubles.",
          ),
        ],
      ),
      qcm(
        ...
        [
          T(
            "Environ 3 % sont métabolisés.",
            "Cette fraction reste minoritaire mais dépasse celle du desflurane.",
          ),
          T(
          ...
          F(
            "Un débit de gaz frais élevé reste obligatoirement imposé.",
            "Les restrictions de débit ne sont plus retenues.",
          ),
        ],
      ),
    ],
    ...
    questions: [
      qcm(
        ...
        [
          ...
          T(
            "Ses effets respiratoires ressemblent à ceux de l’halothane.",
            "La dépression ventilatoire est commune aux halogénés.",
          ),
          T(
            "À 1 CAM, le débit cardiaque est peu modifié.",
            "La contractilité est mieux préservée que sous halothane.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Il antagonise le bloc neuromusculaire.",
            "Il renforce au contraire son effet.",
          ),
          F(
            "Il impose toujours une dose double de curare.",
            "L’ajustement va habituellement dans le sens inverse.",
          ),
        ],
      ),
      qcm(
        ...
        [
          ...
          F(
            "Un absorbeur neuf correctement hydraté.",
            "Ce contexte réduit nettement le risque.",
          ),
        ],
      ),
      qcm(
        ...
        [
          T(
            "Réserver le desflurane à une indication précise.",
            "Son empreinte est très supérieure à celle du sévoflurane.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Le desflurane est environ vingt fois plus impactant que le sévoflurane.",
            "L’écart justifie de limiter son emploi.",
          ),
          T(
...
const DP_QCM = [
  {
    ...
    questions: [
      qcm(
        ...
        "Le sévoflurane associe faible irritation, odeur acceptable et faible solubilité, qualités adaptées à l’enfant sans voie veineuse.",
        [
          T(
            "Une induction au masque peut être réalisée sans voie veineuse préalable.",
            "La vapeur permet l’endormissement avant la ponction.",
          ),
          T(
            "L’absence d’irritation facilite la respiration spontanée.",
            "La patiente tolère mieux les concentrations croissantes.",
          ),
          T(
            "Le coefficient sang/gaz bas accélère l’installation.",
            "Le compartiment sanguin absorbe peu avant la montée cérébrale.",
          ),
          F(
          ...
          F(
            "Le sévoflurane impose un vaporisateur chauffé sous pression.",
            "Cette contrainte technique concerne le desflurane.",
          ),
        ],
      ),
      qcm(
        ...
        [
          ...
          F(
            "Provoquer une hypoventilation volontaire.",
            "Elle ralentirait l’apport alvéolaire.",
          ),
          F(
            "Réduire la fraction inspirée dès les premières secondes.",
            "Cette manœuvre diminuerait la vitesse d’induction.",
          ),
        ],
      ...
      qcm(
        ...
        [
          ...
          F(
            "Le coefficient mesure la puissance motrice.",
            "La CAM mesure la puissance ; le coefficient décrit la cinétique.",
          ),
        ],
      ...
      qcm(
        ...
        [
          ...
          T(
            "Une bronchodilatation directe.",
            "Cet effet peut améliorer le calibre bronchique.",
          ),
          F(
          ...
          F(
            "Une augmentation constante de la ventilation minute.",
            "La fréquence peut monter sans compenser le volume courant réduit.",
          ),
        ],
      ...
      qcm(
        ...
        ["b00057"],
        "Opioïdes, hypothermie et hypotension diminuent la CAM et imposent une réduction adaptée.",
        [
          T(
            "L’administration d’un opioïde.",
            "Son effet analgésique épargne l’halogéné.",
          ),
          T(
            "Une baisse importante de température.",
            "L’hypothermie diminue l’activité du système nerveux central.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          T(
            "L’élévation du fluorure est habituellement brève.",
            "La faible solubilité facilite son élimination.",
          ),
          F(
      ...
      qcm(
        ...
        [
          T(
            "Couper l’administration à la fin de la chirurgie.",
            "Le gradient s’inverse alors vers l’alvéole.",
          ),
          T(
          ...
          T(
            "Profiter du faible réservoir sanguin.",
            "Peu d’agent accumulé doit être éliminé.",
          ),
          F(
  ...
  },
  {
    ...
    questions: [
      qcm(
        ...
        [
          T(
            "La fraction inspirée délivrée.",
            "Elle fixe la concentration arrivant dans les alvéoles.",
          ),
          T(
          ...
          F(
            "La diurèse minute comme déterminant principal.",
            "L’élimination rénale n’est pas la voie cinétique dominante.",
          ),
        ],
      ),
      qcm(
        ...
        [
          T(
            "La fraction alvéolaire peut s’élever.",
            "Le captage pulmonaire par le sang diminue.",
          ),
          T(
            "La profondeur peut augmenter sans modifier le vaporisateur.",
            "La pression cérébrale suit la hausse alvéolaire.",
          ),
          F(
      ...
      qcm(
        ...
        [
          T(
            "Une hypotension plus profonde.",
            "Le sévoflurane réduit les résistances et la contractilité.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Augmenter brutalement la concentration pour stabiliser la pression.",
            "Cela accentuerait la dépression hémodynamique.",
          ),
          F(
            "Ignorer la concentration expirée.",
            "Elle reflète la pression alvéolaire utile à la titration.",
          ),
        ],
      ...
      qcm(
        ...
        [
          T(
            "Le captage depuis l’alvéole peut augmenter.",
            "Un débit plus élevé transporte davantage d’agent.",
          ),
          T(
          ...
          T(
            "La titration doit suivre les mesures expirées.",
            "Les changements de physiologie modifient le besoin réel.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Une insuffisance hépatique comme moteur du réveil.",
            "Le métabolisme ne représente qu’une petite fraction.",
          ),
          F(
            "Une hypoventilation persistante.",
            "Elle ralentit l’élimination pulmonaire.",
          ),
        ],
      ...
      qcm(
        ...
        "Le relais doit signaler l’épisode de bas débit, la profondeur accrue et les risques respiratoires et circulatoires résiduels.",
        [
          T(
            "La chute du débit cardiaque et sa durée.",
            "Elle explique une exposition cérébrale transitoirement élevée.",
          ),
          T(
            "La concentration expirée avant l’arrêt.",
            "Elle estime la charge alvéolaire résiduelle.",
          ),
          T(
  ...
  },
  {
    ...
    questions: [
      qcm(
        ...
        "Le N2O est rapide et analgésique, avec un effet d’épargne sur les halogénés.",
        [
          T(
            "Une réduction de la concentration de sévoflurane.",
            "Sa contribution en CAM s’additionne à celle de l’halogéné.",
          ),
          T(
            "Une analgésie complémentaire.",
            "Il possède des propriétés antalgiques propres.",
          ),
          T(
      ...
      qcm(
        ...
        [
          ...
          F(
            "Le N2O provoque une vasoconstriction intestinale sélective.",
            "Le risque décrit est essentiellement une expansion gazeuse.",
          ),
          F(
            "Son métabolisme hépatique obstrue l’intestin.",
            "Il n’est pas métabolisé de façon significative.",
          ),
        ],
      ...
      qcm(
        ...
        [
          ...
          F(
            "Une plaie cutanée ouverte.",
            "Elle ne forme pas un espace gazeux clos susceptible de se distendre.",
          ),
        ],
      ...
      qcm(
        ...
        [
          ...
          F(
            "Ignorer les effets hémodynamiques de l’halogéné.",
            "La vasodilatation peut imposer une réduction.",
          ),
        ],
      ...
      qcm(
        ...
        [
          T(
            "Une hypoxie de diffusion.",
            "Le N2O expiré occupe une partie du volume alvéolaire.",
          ),
          T(
          ...
          F(
            "Une hyperoxie spontanée en air ambiant.",
            "La FiO2 alvéolaire diminue au contraire.",
          ),
          F(
      ...
      qcm(
        ...
        [
          T(
            "Une légère diminution de ventilation alvéolaire.",
            "L’effet respiratoire existe malgré sa modération.",
          ),
          T(
            "Un inotropisme négatif direct.",
            "La contractilité baisse mais est compensée chez le sujet sain.",
          ),
          T(
      ...
      qcm(
        ...
        [
          T(
            "Il augmente significativement l’empreinte de l’anesthésie.",
            "Sa persistance atmosphérique contribue au réchauffement.",
          ),
          T(
            "Son omission est cohérente avec la contre-indication clinique.",
            "Sécurité et environnement vont ici dans le même sens.",
          ),
          F(
    ...
    questions: [
      qcm(
        ...
        [
          ...
          T(
            "Un absorbeur potentiellement déshydraté.",
            "La sécheresse accélère la dégradation chimique.",
          ),
          T(
          ...
          F(
            "Une saturation normale exclut le diagnostic.",
            "L’oxymètre conventionnel ne distingue pas oxyhémoglobine et carboxyhémoglobine.",
          ),
          F(
            "Le métabolisme hépatique du desflurane produit le CO.",
            "Le mécanisme se situe dans l’absorbeur du circuit.",
          ),
        ],
      ),
      qcm(
        ...
        [
          ...
          F(
            "La couleur du vaporisateur comme seul test.",
            "Elle n’évalue ni hydratation ni production de CO.",
          ),
        ],
      ...
      qcm(
        ...
        [
          ...
          F(
            "Poursuivre l’agent pour accélérer le réveil.",
            "Cela maintiendrait la production de toxique.",
          ),
          F(
            "Se fier uniquement à la SpO2.",
            "Elle peut rester faussement rassurante.",
          ),
        ],
      ...
      qcm(
        ...
        [
          ...
          T(
            "Un dosage de carboxyhémoglobine.",
            "La fraction de carboxyhémoglobine quantifie directement l’exposition au monoxyde de carbone.",
          ),
          F(
      ...
      qcm(
        ...
        [
          ...
          T(
            "Sa fin d’action est rapide.",
            "Le wash-out suit rapidement l’arrêt.",
          ),
          F(
          ...
          F(
            "Il ne nécessite aucun équipement particulier.",
            "Un vaporisateur chauffé et pressurisé est requis.",
          ),
        ],
      ...
      qcm(
        ...
        [
          ...
          T(
            "Une augmentation brusque peut provoquer une HTA.",
            "La stimulation sympathique est transitoirement importante.",
          ),
          T(
            "Une tachycardie peut accompagner la hausse de concentration.",
            "Le système autonome accélère le cœur.",
          ),
          F(
