...
// « Toutes les annales » : fusion des deux banques (Alexis = physio/sémio/andro
// + Autres annales = histo/anat/pharmaco/méd. nucléaire), toutes matières mélangées.
// Les <img> des schémas sont déjà intégrés dans les énoncés des deux sources.
...
const merged = [...alexis.annales, ...autresAnnales.annales];
