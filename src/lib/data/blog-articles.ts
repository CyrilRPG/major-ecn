...
export const BLOG_ARTICLES: BlogArticleMeta[] = [
  {
    slug: 'calendrier-inscription-concours-pae-2026-cng',
    title: 'Calendrier et inscription au concours PAE 2026 sur le site du CNG',
    ...
    readingMinutes: 11,
    image: '/blog/blog2026/calendrier-inscription-concours-pae-2026-cng-w1.jpeg',
    readers: 0,
    publishedAt: '2026-07-06',
    featured: true,
  },
  {
    slug: 'comment-major-ecn-accompagne-candidats-evc',
    title: 'Comment Major ECN accompagne ses candidats aux EVC',
    ...
    readingMinutes: 11,
    image: '/blog/blog2026/comment-major-ecn-accompagne-candidats-evc-w1.jpeg',
    readers: 0,
    publishedAt: '2026-07-06',
    featured: true,
  },
  {
    slug: 'evc-edn-difference-a-ne-pas-confondre',
    title: 'EVC et EDN : pourquoi confondre les deux peut vous coûter votre concours',
    excerpt: "EVC ou EDN ? Deux concours à ne pas confondre. Programme, format, public visé et enjeux : ce que tout candidat PADHUE doit comprendre pour ne pas se tromper de préparation.",
    category: 'epreuves-evc',
    readingMinutes: 12,
    image: '/blog/blog2026/evc-edn-difference-a-ne-pas-confondre-w1.jpeg',
    readers: 0,
    publishedAt: '2026-07-06',
    featured: true,
  },
  {
    slug: 'voie-interne-evc-logique-qcm',
    title: 'Voie interne des EVC : comprendre la logique des QCM',
    excerpt: "Voie interne des EVC : comment sont construits les QCM, la logique de notation, les pièges classiques et la méthode Major ECN pour les aborder efficacement en 2026.",
    category: 'epreuves-evc',
    readingMinutes: 27,
    image: '/blog/blog2026/voie-interne-evc-logique-qcm-w1.jpeg',
    readers: 0,
    publishedAt: '2026-07-07',
    featured: true,
  },
  {
    slug: 'evc-voie-externe-comprendre',
    title: 'EVC voie externe : tout comprendre avant de vous lancer',
    excerpt: "Voie externe des EVC PAE 2026 : qui peut s'inscrire, format des épreuves, spécialités ouvertes, taux de réussite et ce qu'il faut savoir avant de déposer votre dossier au CNG.",
    category: 'epreuves-evc',
    readingMinutes: 10,
    image: '/blog/blog2026/evc-voie-externe-comprendre-w1.png',
    readers: 0,
    publishedAt: '2026-07-07',
    featured: true,
  },
  {
    slug: 'comment-rediger-qroc-evc',
    title: 'Comment rédiger une QROC aux EVC',
    excerpt: "Comment rédiger une QROC aux EVC : structure de la réponse, mots-clés attendus, gestion du temps et erreurs à éviter. La méthode Major ECN pour maximiser vos points.",
    category: 'epreuves-evc',
    readingMinutes: 21,
    image: '/blog/blog2026/comment-rediger-qroc-evc-w1.jpeg',
    readers: 0,
    publishedAt: '2026-07-07',
    featured: true,
  },
  {
    slug: 'comment-choisir-specialite-evc',
    title: 'Comment choisir sa spécialité aux EVC',
    excerpt: "Comment choisir sa spécialité aux EVC : critères de décision, format des épreuves, débouchés et méthode pour faire le bon choix en tant que médecin PADHUE en 2026.",
    category: 'specialites',
    readingMinutes: 12,
    image: '/blog/blog2026/comment-choisir-specialite-evc-w1.jpeg',
    readers: 0,
  ...
  },
  {
    ...
    category: 'candidature-dossier',
    readingMinutes: 5,
    image: '/blog/sinscrire-evc-hero.webp',
    readers: 2232,
  ...
  },
  {
    ...
    readingMinutes: 9,
    image: '/blog/remuneration-hero.webp',
    readers: 4016,
