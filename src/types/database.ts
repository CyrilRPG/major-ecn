...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      videos: {
        Row: { cours_id: string; created_at: string; duration_seconds: number | null; id: string; storage_path: string | null; titre: string; bunny_video_id: string | null; type: string; rubrique: string | null; voies: string[]; offers: string[]; denied_user_ids: string[]; allowed_user_ids: string[]; serie_id: string | null; unlock_direct: boolean; order_index: number; support_path: string | null; support_pages: number | null; support_updated_at: string | null; updated_at: string };
