...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      videos: {
        Row: { cours_id: string; created_at: string; duration_seconds: number | null; id: string; storage_path: string | null; titre: string; bunny_video_id: string | null; type: string; rubrique: string | null; voies: string[]; offers: string[]; denied_user_ids: string[]; allowed_user_ids: string[]; serie_id: string | null; unlock_direct: boolean; order_index: number; support_path: string | null; support_pages: number | null; support_updated_at: string | null; updated_at: string; status: string; publish_at: string | null; created_by: string | null; published_by: string | null; published_at: string | null };
      ...
      blog_posts: {
        Row: { id: string; slug: string; title: string; excerpt: string; category: string; reading_minutes: number; hero_image: string | null; content: Json; status: string; featured: boolean; published_at: string | null; author_id: string | null; created_at: string; updated_at: string; submitted_at: string | null; submitted_by: string | null; updated_by: string | null; published_by: string | null };
        Insert: { id?: string; slug: string; title: string; excerpt?: string; category?: string; reading_minutes?: number; hero_image?: string | null; content?: Json; status?: string; featured?: boolean; published_at?: string | null; author_id?: string | null; created_at?: string; updated_at?: string; submitted_at?: string | null; submitted_by?: string | null; updated_by?: string | null; published_by?: string | null };
        Update: { id?: string; slug?: string; title?: string; excerpt?: string; category?: string; reading_minutes?: number; hero_image?: string | null; content?: Json; status?: string; featured?: boolean; published_at?: string | null; author_id?: string | null; created_at?: string; updated_at?: string; submitted_at?: string | null; submitted_by?: string | null; updated_by?: string | null; published_by?: string | null };
