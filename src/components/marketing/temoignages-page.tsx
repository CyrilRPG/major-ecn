...
const WRITTEN: WrittenTesti[] = [
  ...
  { name: 'Mme Lilia Ould Benahmed', spec: 'Odontologie',            initials: 'LO',
    photo: '/temoignages/dr-lilia-ouled-ben-ahmed.jpg', slug: 'mme-lilia-ould-benahmed',
    short: "Je recommande vivement cette formation pour son sérieux, sa réactivité et la pertinence de ses supports." },
  ...
  { name: 'Dr Mohammed Nour NACHED', spec: 'Odontologie',              initials: 'MN',
    short: "Les cours clairs et la disponibilité de l'équipe m'ont permis d'arriver serein et mieux préparé le jour du concours." },
  { name: 'Dr Koivogui Diarra',  spec: 'Cardiologie',                 initials: 'KD',
    photo: '/specialites/cardiologie/temoignage-laureat-evc-cardiologie-koivogui.webp',
    short: "Un accompagnement rigoureux et structuré, une dynamique de groupe et un soutien constant jusqu'aux épreuves." },
