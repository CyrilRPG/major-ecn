...
const REAL_VIDEOS = [
  ...
  { name: 'Dr Karim KHIAREDDINE',  spec: 'Anesthésie réanimation',              year: 'Lauréat EVC 2025', videoSrc: '/temoignages/T2 FINAL V2.mp4#t=3', bgGrad: 'linear-gradient(135deg, #2A1A4A 0%, #6D28D9 55%, #A91D2C 100%)' },
  { name: 'Dr Ely Cheikh SY',      spec: 'Endocrinologie & métabolisme',        year: 'Lauréat EVC 2025', videoSrc: '/temoignages/T3 FINAL V2.mp4#t=3', bgGrad: 'linear-gradient(135deg, #0F4438 0%, #16793C 55%, #A91D2C 100%)' },
  { name: 'Dr Ahmed SIFAOUI',      spec: 'Gériatrie',                           year: 'Lauréat EVC 2025', videoSrc: '/temoignages/T4 Final V2.mp4#t=3', bgGrad: 'linear-gradient(135deg, #6B1A2A 0%, #B45309 55%, #E8742C 100%)' },
