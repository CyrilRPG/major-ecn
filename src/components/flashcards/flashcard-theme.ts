...
const THEMES: Record<string, FlashcardTheme> = {
  ...
  // Si pas d'image fournie → fallback SVG anatomique (Icon).
  ...
  'Néphrologie':               { bg: '#DCFCE7', accent: '#16A34A', Icon: KidneyArt },
  ...
  'Hématologie':               { bg: '#FFE4E6', accent: '#9F1239', Icon: BloodCellsArt },
  'ORL':                       { bg: '#E0F2FE', accent: '#0284C7', Icon: EarArt },
  ...
  'Réanimation':               { bg: '#FEE2E2', accent: '#DC2626', Icon: HeartbeatArt },
  'Reanimation':               { bg: '#FEE2E2', accent: '#DC2626', Icon: HeartbeatArt },
