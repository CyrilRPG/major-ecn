...
const THEMES: Record<string, FlashcardTheme> = {
  ...
  'Médecine Intensive Réanimation': { bg: '#D1E3FA', accent: '#0D3F81', Icon: HeartbeatArt, image: '/flashcards-decor/reanimation.png' },
  'Médecine intensive-réanimation': { bg: '#D1E3FA', accent: '#0D3F81', Icon: HeartbeatArt, image: '/flashcards-decor/reanimation.png' },
  // Collège top-level « Médecine intensive et réanimation »
  // (col-medecine-intensive-reanimation), copie physique de col-mir : même
  // ambiance réanimation.
  'Médecine intensive et réanimation': { bg: '#D1E3FA', accent: '#0D3F81', Icon: HeartbeatArt, image: '/flashcards-decor/reanimation.png' },
