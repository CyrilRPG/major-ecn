...
export async function generateMetadata({ params }: Props) {
  ...
  return arenaMetadata(ctx.snap, { title: 'Mes corrections détaillées', noindex: true });
}
/** Historique : une correction détaillée par manche, associée définitivement à la manche, consultable dans la visionneuse intégrée après clôture et publication. */
